<h4>EDEN <span style="color: red;">Dữ liệu được cập nhật vào lúc 9:00 mỗi ngày</span></h4>
<script>
    $(function () {        
        ...
        $('#topup_by_server').on('click', function (e) {
            window.location.href = "/?control=eden_reports&func=topup_byserver#topup_by_server";
        });
    });
</script>
