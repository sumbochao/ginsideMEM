...
<?php
	...
	$GMDate = GMText(array('label' => 'Date', 'class' => 'timepicker', 'name' => 'date_log', 'id' => 'date_log', 'value' => $d));
    ...
    $content = "<br>".$serverDropDown.$GMDate.$logDropDown.$charidText.$Button.$pageHidden;
    $xhtml = GMGenView(array('content' => $content, 'action' => base_url('?control=game&func=infolgtime'), 'method' => 'POST', 'legend' => 'FORM SEARCH LOG', 'id'=>'frmtop'));
    echo $xhtml;
