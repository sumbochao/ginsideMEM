...
<script type="text/javascript">
    function htmlItem(keyrule,y){
        ...
        subhtml += '    <div class="input">';
        subhtml += '        <input type="text" size="20" name="count[' + keyrule + '][' + y + ']" style="width:70px;" value="1" placeholder="Nhập Count" />';
        subhtml += '    </div>';
        subhtml += '</div>';
        subhtml += '<div class="rows">';
        subhtml += '    <div class="title">Rate</div>';
        subhtml += '    <div class="input">';
        subhtml += '        <input type="text" size="20" name="rate[' + keyrule + '][' + y + ']" style="width:70px;" value="1" placeholder="Nhập Rate" />';
        subhtml += '    </div>';
        subhtml += '</div>';
        subhtml += '<div class="rows">';
        subhtml += '    <div class="title">Type</div>';
        subhtml += '    <div class="input">';
        subhtml += '        <input type="text" size="20" name="type[' + keyrule + '][' + y + ']" style="width:70px;" value="1" placeholder="Nhập Type" />';
        subhtml += '    </div>';
        subhtml += '</div>';
            ...
            ?>
                <div class="sub_item_rule" id="sub_item_rule">
                    ...
                    <div class="rows">
                        ...
                        <div class="input"><input type="text" placeholder="Nhập Item Name" value="<?php echo $v['item_name']; ?>" name="name[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
                    <div class="rows">
                        <div class="title">Count</div>
                        <div class="input"><input type="text" placeholder="Nhập Count" style="width:70px;" value="<?php echo $v['count']; ?>" name="count[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
                    <div class="rows">
                        <div class="title">Rate</div>
                        <div class="input"><input type="text" placeholder="Nhập Rate" style="width:70px;" value="<?php echo $v['rate']; ?>" name="rate[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
                    <div class="rows">
                        <div class="title">Type</div>
                        <div class="input"><input type="text" placeholder="Nhập Type" style="width:70px;" value="<?php echo $v['type']; ?>" name="type[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
