    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=taixiu&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">

                        <div class="control-group frmedit">
                            <label class="control-label">Server List:</label>
                            <div class="controls">
                                <input value="<?php echo $pack->server_list;?>" name="server_list" type="text" class="span3 validate[required]" />
                            </div>
                        </div>
                        ...
                        <div id="items">
                            ...
                            <div class = "panel panel-default">
                                ...
                                <div class="control-group frmedit">
                                    ...
                                    <div class="controls">
                                        <input value="<?php echo $pack->item_id;?>" name="item_id[]" type="text" class="span3 validate[required]" />
                                    </div>
                                </div>
                            ...
                            <?php else:?>
                            <?php $items = json_decode($pack->items) ;?>
                                    ...
                                    <div class = "panel panel-default">
                                        <div class = "panel-body">
                                            <div class="control-group frmedit">
                                                <label class="control-label">Name:</label>
                                                <div class="controls">
                                                    <input value="<?php echo $item->name;?>" name="name[]" type="text" class="span3 validate[required]" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group frmedit">
                                                <label class="control-label">Item ID:</label>
                                                <div class="controls">
                                                    <input value="<?php echo $item->item_id;?>" name="item_id[]" type="text" class="span3 validate[required]" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group frmedit">
                                                <label class="control-label">Price:</label>
                                                <div class="controls">
                                                    <input value="<?php echo $item->price;?>" name="price[]" type="text" class="span3 validate[required]" />
                                                </div>
                                            </div>
