...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=choilainhanqua_pt&func=index&view=event#event";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=choilainhanqua_pt&func=index&view=filters#filters";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=choilainhanqua_pt&func=history#history";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a id="filters" href="#filters" aria-controls="filters" role="tab" data-toggle="tab">XEM QUÀ</a></li>
