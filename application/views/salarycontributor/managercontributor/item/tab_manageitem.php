...
<link href='/libraries/jqueryEasyAutocomplete/easy-autocomplete.min.css' rel='stylesheet' type='text/css'>
...
<script type="text/javascript" src="/libraries/jqueryEasyAutocomplete/jquery.easy-autocomplete.min.js"></script>
<script>
    ...
    $(function () {
        ...
        $('#home').on('click', function (e) {
            ...
            window.location.href = "/?control=managercontributor&func=manageitem#home";
        });

        $('#duyetitem').on('click', function (e) {
            if (hash != "#duyetitem") {
                $(".loading").fadeIn("fast");
            }
            window.location.href = "/?control=managercontributor&func=manageitem&view=approvalitem#duyetitem";
        });
        ...
        $('#lichsu').on('click', function (e) {
            ...
            window.location.href = "/?control=managercontributor&func=manageitem&view=history_item#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ ITEM</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">DANH SÁCH ITEM</a></li>
    <li role="presentation"><a id="duyetitem" href="#duyetitem" aria-controls="duyetitem" role="tab" data-toggle="tab">DANH SÁCH DUYỆT</a></li>
