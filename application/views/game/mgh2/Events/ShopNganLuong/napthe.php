    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=shopnganluong_mgh2&func=napthe&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#napthe";
            });
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/mgh2/cms/toolshopnganluong/get_recharging_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
