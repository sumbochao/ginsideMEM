        ...
        $(document).ready(function () {
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    method: "POST",
                    dataType: 'json',
                    url: "/?control=gmtoolgopet&func=updateopri_itemid",
            ...
            <div class="widget infotest" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="" method="POST" enctype="multipart/form-data" onsubmit="return false;" autocomplete="off">
						...
						<div class="control-group col-xs-12 clearfix">
							<div class="control-group col-md-3">
								<label class="control-label">ITEMSID:</label>
								<div class="controls">
									<input type="text" id="itemid" name="itemid" value="" class="span3 validate[required,custom[onlyNumberSp]]" />
								</div>
							</div>
							<div class="control-group col-md-3">
