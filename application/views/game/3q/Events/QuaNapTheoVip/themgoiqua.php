    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=quanaptheovip_3q&func=quanlygoiqua?type=' + type;
                }
                else {
                    window.location.href = '/?control=quanaptheovip_3q&func=quanlygoiqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=quanaptheovip_3q&func=add_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
