        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/ToolchoiKOKnhanKNB/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            ...
                            <?php
                                ...
                                if($_GET['id']>0){
                                    $date = date_format(date_create($items['date']),"d-m-Y");
                                    $datetime = date_format(date_create($items['datetime']),"d-m-Y H:i:s");
                                }
                            ?>
                            ...
                            <div class="control-group">
                                <label class="control-label">Điều kiện X:</label>
                                <div class="controls">
                                    <input name="condition" id="condition" value="<?php echo $items['condition'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Ngày nhận thưởng liên tục:</label>
                                <div class="controls">
                                    <input type="text" class="date" name="date" value="<?php echo $date;?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Ngày tạo:</label>
                                <div class="controls">
                                    <input type="text" class="datetime" name="datetime" value="<?php echo $datetime;?>"/>
                                </div>
                            </div>
                            <div class="control-group">
