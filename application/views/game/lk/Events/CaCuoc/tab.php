...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=trandau#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=quanlyqua#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_covu&func=lichsu#lichsu";
        });
    });
</script>
<style>
