    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() { 
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                   window.location.href = '/?control=thangcap_koa&func=quanlyqua&type=' + type + "&module=all#quanlyqua"; 
                }
                else{
                window.location.href = '?control=thangcap_koa&func=quanlyqua&module=all#quanlyqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                    <form id="frmSendChest" action="/?control=thangcap_koa&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="item_id" id="item_id" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> 
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="item_id_2" id="item_id_2" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> 
                                    Số lượng <input name="gift_quantity_2" id="gift_quantity_2" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> 
                                    Type <input name="gift_send_type_2" id="gift_send_type_2" type="text" class="span3 validate[required]" /> 
                                </div>
                            </div>                            
                        </div>
                       ...
                       <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="item_id_3" id="item_id_3" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> 
                                    Số lượng <input name="gift_quantity_3" id="gift_quantity_3" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> 
                                    Type <input name="gift_send_type_3" id="gift_send_type_3" type="text" class="span3 validate[required]" /> 
                                </div>
                            </div>                            
                        </div>                        
