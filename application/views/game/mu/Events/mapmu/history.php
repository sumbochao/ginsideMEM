    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                window.location.href = '/?control=map_mu&func=excel&module=all&start=<?php echo $startHistory;?>&end=<?php echo $endHistory;?>';
            });
        });

        function getData() {
            $.ajax({
                url: "<?php echo $url_service; ?>/event/map/history?start=<?php echo $startHistory;?>&end=<?php echo $endHistory;?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
