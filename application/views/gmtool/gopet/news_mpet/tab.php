...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">USERDATA</a></li>
    <li role="presentation"><a id="updateresult" href="#" aria-controls="giaidau" role="tab" data-toggle="tab">CHARACTERDATA</a></li>
  </ul>
