...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=giaithuong#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=giaithuongtop#giaithuongtop";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=tuhoncac&func=lichsu#lichsu";
        });
    });
</script>
<style>
