    ...
    <div class="widget_content">
        <form id="appForm" action="" method="post" name="appForm">
            <div class="filter">
                ...
                <input type="text" name="vip" value="<?php echo $_POST['vip'];?>" class="textinput" placeholder="Vip" title="Vip"/>
                <input type="text" name="start" value="<?php echo $_POST['start'];?>" class="textinput" placeholder="Số trang" title="Số trang"/>
                <input type="text" name="length" value="<?php echo $_POST['length'];?>" class="textinput" placeholder="Độ dài mỗi trang" title="Độ dài mỗi trang"/>
