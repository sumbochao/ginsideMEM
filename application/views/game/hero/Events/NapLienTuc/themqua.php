    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=naplientuc_hero&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    Type <input name="type[0]" id="type" type="text" class="span3 validate[required]" /> 
                                </div>
                            </div>                            
                        </div>
