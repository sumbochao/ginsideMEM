    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=event_lato&func=logthamgia&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#logthamgia";
            });

            $('#export_excel').on('click', function () {
                window.location.href = "http://game.mobo.vn/hiepkhach/cms/promotion_lato/export_excel_logthamgia?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
            });
        ...
        function getData() {
            $(".loading").fadeIn("fast");
            $.ajax({
                url: "http://game.mobo.vn/hiepkhach/cms/promotion_lato/logthamgia?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
