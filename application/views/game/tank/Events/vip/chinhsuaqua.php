...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        function get_vip_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/tank/cms/toolvip/get_vip_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tank_event_goi_qua_vip&module=all&func=edit_vip_gift" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="activity" id="activity" type="text" class="span3 validate[required]" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="position" id="position" type="text" class="span3 validate[required]" />
                                        </div>
                                    </div>  
