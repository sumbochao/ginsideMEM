...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "?control=quachienluc&func=index&view=item";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "?control=quachienluc&func=index&view=wheel";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "?control=quachienluc&func=index&view=filter";
        });
		$('#history').on('click', function (e) {
            window.location.href = "?control=quachienluc&func=history&view=history";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT CHIẾN LỰC</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation" class="<?php  echo $_GET['view']=='history'?'active':'';?>"><a id="history" href="#history" aria-controls="history" role="tab" data-toggle="tab">HISTORY</a></li>
  </ul>
