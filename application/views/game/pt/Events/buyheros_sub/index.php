    ...
    <script type="text/javascript">
        $(function () {
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=event_covu&func=themgiaidau#giaidau';
            });
        ...
        $(document).ready(function() {
            ...
            $('#comeback').on('click',function(){
                window.location.href ='/cms/ep/buyheros/index?view=item';
            });
            ...
            $('#onSubmit').on('click',function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url; ?>/cms/buyheros/<?php echo ($_GET['ids']>0)?'edit_item?ids='.$_GET['ids']:'add_item';?>",
