...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#comeback').on('click',function(){
            window.location.href ='/?control=toolgettop&func=index&view=wheel';
        });
        ...
        $('#onSubmit').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/toolgettop/<?php echo ($_GET['ids']>0)?'edit_wheel?ids='.$_GET['ids']:'add_wheel';?>",
                    ...
                    <div class="widget row-fluid">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="server_id" id="boxname" type="text" value="<?php echo $server_id;?>" class="span3 validate[required]" /> Ví dụ: [1][2][3]...
                                </div>
                            </div>
                            <div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="topevent">
									 <?php
										foreach($listtop as $key=>$val){
											if($topevent == $key){
