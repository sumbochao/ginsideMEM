...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=onlinenhanqua_lg&func=index&view=event&module=<?php echo $_GET['module'];?>";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=onlinenhanqua_lg&func=index&view=filters&module=<?php echo $_GET['module'];?>";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=onlinenhanqua_lg&func=history&module=<?php echo $_GET['module'];?>";
        });
    });
</script>
<style>
