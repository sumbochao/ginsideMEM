            ...
            <div class="group_left">
                ...
                <div class="rows">	
                    ...
                    <select name="cbo_status" id="cbo_status">
                        ...
                        ?>
                        <option value="<?php echo $key;?>" <?php echo $_POST['cbo_status']==$key?"selected":""; ?> ><?php echo $value;?></option>
                        <?php
                                }
                            }
                        ?>
                   ...
                   <!-- <select name="cbo_type_app" id="cbo_type_app">
                    ...
                    <select name="cbo_type_app" id="cbo_type_app">
                        <option value="0">Chọn App</option>
                         ...
                         <option value="Appstore" <?php echo $_POST['cbo_type_app']=="Appstore"?"selected":""; ?> >Appstore</option>
                         <option value="Inhouse" <?php echo $_POST['cbo_type_app']=="Inhouse"?"selected":""; ?>>Inhouse</option>
                    </select>
                    <div class="option_error"></div>
                </div>
                <div class="rows">	
