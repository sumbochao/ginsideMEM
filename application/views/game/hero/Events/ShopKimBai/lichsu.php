    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=shopkimbai_hero&func=lichsu&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#lichsu";
            });

            //Load Total Point Exchage Gift
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/hero/cms/toolshopkimbai/get_total_point_gift_pakage_exchange_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/hero/cms/toolshopkimbai/get_gift_pakage_exchange_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
