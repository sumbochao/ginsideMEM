    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=shopnganluong_mgh2&func=quanlygoiqua?type=' + type;
                }
                else {
                    window.location.href = '/?control=shopnganluong_mgh2&func=quanlygoiqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=shopnganluong_mgh2&func=add_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
