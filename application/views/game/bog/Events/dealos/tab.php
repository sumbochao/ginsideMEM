...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=dealos_bog&func=index&view=event&module=all";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=dealos_bog&func=index&view=filters&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=dealos_bog&func=history&module=all";
        });
    });
</script>
<style>
