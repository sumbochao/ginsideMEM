...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#frmSendChest').ajaxForm(function (data) {
                ...
                if (data.result != "-1") {
                    ...
                    if (id !== null && id !== "") {
                        get_vongquayvatpham_gift_details(id);
                    }
        ...
        function get_vongquayvatpham_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mathan/cms/toolvongquayvatpham/get_vongquayvatpham_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=vongquayvatpham_mt&module=all&func=edit_vongquayvatpham_gift" method="POST" enctype="multipart/form-data">
                        <div class="widget row-fluid">
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Tỷ lệ quay thưởng (1% -> 1000)[Tổng tỉ lệ của các vật phẩm trong 1 sự kiện nên là 100%]:</label>
                                        <div class="controls">
                                            <input name="percentage" id="percentage" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>  
