                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function (data, arg1, arg2) {
                                    return "<a class='btn btn-success btn-xs' href=' /?control=<?php  echo $control;?>&func=themqua&game=<?php echo $game;?>&id=" + data + "&condition="+arg2.condition+"&items="+arg2.items + "&key="+arg2.key + "&config_id="+arg2.config_id + "&server_list="+arg2.server_list +"#quanlyqua '>Chỉnh Sửa</a>";
                                }
