    ...
    <script type="text/javascript">
        $(function () {
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=event_covu_pt&func=themgiaidau#giaidau';
            });
        ...
        function load_tournament_detail(id) {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/phongthan/cms/toolcacuoc/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=event_covu_pt&func=edit_tournament_details" method="POST" enctype="multipart/form-data">
