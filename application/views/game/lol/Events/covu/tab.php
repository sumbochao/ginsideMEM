...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=covu_lol&func=index&view=event&module=all#event";
        });
        $('#tournament').on('click', function (e) {
            window.location.href = "/?control=covu_lol&func=index&view=tournament&module=all#tournament";
        });
        $('#match').on('click', function (e) {
            window.location.href = "/?control=covu_lol&func=index&view=match&module=all#match";
        });
        $('#history_datcuoc').on('click', function (e) {
            window.location.href = "/?control=covu_lol&func=history_datcuoc&module=all#history_datcuoc";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo ($_GET['view']=='tournament')?'class="active"':'';?>><a id="tournament" href="#tournament" aria-controls="tournament" role="tab" data-toggle="tab">GIẢI ĐẤU</a></li>
    <li role="presentation" <?php echo ($_GET['view']=='match')?'class="active"':'';?>><a id="match" href="#match" aria-controls="match" role="tab" data-toggle="tab">TRẬN ĐẤU</a></li>
    <li role="presentation" <?php echo ($_GET['func']=='history_datcuoc')?'class="active"':'';?>><a id="history_datcuoc" href="#history_datcuoc" aria-controls="history_datcuoc" role="tab" data-toggle="tab">LỊCH SỬ ĐẶT CƯỢC</a></li>
</ul>
