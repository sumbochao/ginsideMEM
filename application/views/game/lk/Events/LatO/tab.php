...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=index#home";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=thongke#thongke";
        });

        $('#logdoiqua').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=logdoiqua#logdoiqua";
        });

        $('#logthamgia').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=logthamgia#logthamgia";
        });

        $('#logdoiluotbangtien').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=logdoiluotbangtien#logdoiluotbangtien";
        });

        $('#clearcached').on('click', function (e) {
            window.location.href = "/?control=event_lato&func=clearcached#clearcached";
        });
    });
</script>
<style>
