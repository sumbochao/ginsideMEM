...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=gmtoolgopet&func=backup_Userdata";
        });

        $('#updateresult').on('click', function (e) {
            window.location.href = "/?control=gmtoolgopet&func=backup_Characterdata";
        });
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php  echo $_GET['func']=='backup_Userdata'?'active':'';?>" ><a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">USERDATA</a></li>
    <li role="presentation" class="<?php  echo $_GET['func']=='backup_Characterdata'?'active':'';?>"><a id="updateresult" href="#" aria-controls="giaidau" role="tab" data-toggle="tab">CHARACTERDATA</a></li>
  </ul>
