    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=thangcapnhanthuong_hero&func=themqua&tournament_id=' + $("#tournament").val() + "&module=all#quanlyqua";
            });

            $("#tournament").change(function () {
                window.location.href = "/?control=thangcapnhanthuong_hero&module=all&func=quanlyqua&tournament_id=" + $(this).val() + "#quanlyqua";
            });
        ...
        function getData($tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/hero/cms/toolthangcapnhanthuong/gift_list?tournament_id=" + $tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            {
                                sTitle: "Đạt cấp 10 nhận",
                                mData: "count_rank_10"
                            },
                            {
                                sTitle: "Đạt cấp 20 nhận",
                                mData: "count_rank_20"
                            },
                            {
                                sTitle: "Đạt cấp 30 nhận",
                                mData: "count_rank_30"
                            },
                            {
                                sTitle: "Đạt cấp 35 nhận",
                                mData: "count_rank_35"
                            },
                            {
                                sTitle: "Đạt cấp 40 nhận",
                                mData: "count_rank_40"
                            },
                            {
                                sTitle: "Tùy Chọn",
                                ...
                                mRender: function (data) {
                                    return "<a href='/?control=thangcapnhanthuong_hero&func=chinhsuaqua&id=" + data + "&tournament_id=" + $("#tournament").val() + "&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                }
                            }
