    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            <div class="rows">
                ...
                <div class="input"><input type="text" placeholder="Nhập Key" class="date" value="<?php echo $vrule['key']; ?>" name="key[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '   <div class="input"><input type="text" class="date" size="20" name="key[' + x + ']" value="<?php echo date('d-m-Y');?>" placeholder="Nhập Key" /></div>';
            html += '</div>';
            html += '<div class="rows">';
