    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                window.location.href = '/?control=baodanh_dht&func=excel_baodanh&module=all&start=<?php echo $startHistory;?>&end=<?php echo $endHistory;?>';
            });
        });
                            ...
                            },
                           {
                            ...
                            },
                            {
                                ...
                                mRender: function (data) {
                                    return "<a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=baodanh_dht&func=delete&view=<?php echo $_GET['view'];?>&module=all&id=" + data + "'>Xóa</a>";
                                }
                             }
                        ],
                        bProcessing: true,
