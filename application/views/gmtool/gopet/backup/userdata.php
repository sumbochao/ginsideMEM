...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/gmtool/gopet/backup/tab.php'; ?>
            ...
            <div class="widget infotest" id="viewport">
                <div class="well form-horizontal">
					<div class="control-group col-xs-12 clearfix" style="color:red;font-weight:bold;">
						<?php 
							echo !empty($message) ? $message : "";
						?>
					</div>
                    <form id="frmSendChest" action="" method="POST" enctype="multipart/form-data" autocomplete="off">
