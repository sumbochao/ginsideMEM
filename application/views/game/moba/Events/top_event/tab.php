...
<script>
    ...
    $(function () {        
        $('#events').on('click', function (e) {
            window.location.href = "/?control=top_event_moba&func=index&view=events&module=all";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=top_event_moba&func=index&view=filters&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo $_GET['view']=='filters'?'class="active"':'';?>><a id="filters" href="#filters" aria-controls="filters" role="tab" data-toggle="tab">SERVER</a></li>
</ul>
