...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "?control=event_quaonline&func=index&view=item&module=all";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "?control=event_quaonline&func=index&view=wheel&module=all";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "?control=event_quaonline&func=index&view=filter&module=all";
        });
    });
</script>
<style>
