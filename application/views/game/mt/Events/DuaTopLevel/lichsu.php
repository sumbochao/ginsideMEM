    ...
    <script type="text/javascript">
        $(function () {
            $("#tournament_id").change(function () {
                //getData($(this).val());
                window.location.href = "/?control=duatoplevel_mt&module=all&func=lichsu&tournament_id=" + $(this).val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#lichsu";
            });
        });
        ...
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=duatoplevel_mt&module=all&func=lichsu&tournament_id=" + $("#tournament_id").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#lichsu";
            });

//            $('#export_excel').on('click', function () {
//                window.location.href = "http://game.mobo.vn/mathan/cms/toolduatoplevel/get_exchange_history_excel?tournament_id=" + $("#tournament_id").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
//            });
        ...
        function getData(tournament_id) {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/mathan/cms/toolduatoplevel/get_exchange_history?tournament_id=" + tournament_id + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
