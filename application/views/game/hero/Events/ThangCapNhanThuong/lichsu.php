    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=thangcapnhanthuong_hero&func=lichsu&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#lichsu";
            });
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/hero/cms/toolthangcapnhanthuong/get_gift_exchange_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function (data, type, full) {
                                    switch (data) {
                                        case 10:
                                            html = full.count_rank_10;
                                            break;
                                        case 20:
                                            html = full.count_rank_20;
                                            break;
                                        case 30:
                                            html = full.count_rank_30;
                                            break;
                                        case 40:
                                            html = full.count_rank_40;
                                            break;
                                        case 50:
                                            html = full.count_rank_50;
                                            break;
                                        default:
                                            html = "0";
                                    }
