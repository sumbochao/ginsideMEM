...
<script>
    ...
    $(function () {
        $('#events').on('click', function (e) {
            window.location.href = "/?control=cardgame&func=index&view=events&module=all#events";
        });
        $('#groups').on('click', function (e) {
            window.location.href = "/?control=cardgame&func=index&view=groups&module=all#groups";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=cardgame&func=history&module=all";
        });
    });
</script>
<style>
