    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#update_reward').on('click', function () {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/phongthan/cms/toolvongquayhuyenao/edit_reward_name/?id=" + $('#reward').val() + "&reward_name=" + $('#reward_name_edit').val(),
            ...
            $('#add_new_reward').on('click', function () {
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/phongthan/cms/toolvongquayhuyenao/add_reward",
        ...
        function load_reward(tournament_id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/phongthan/cms/toolvongquayhuyenao/load_reward?tournament_id=" + tournament_id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    var obj = data;
                    var rewardlist = "";
        ...
        function load_reward_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/phongthan/cms/toolvongquayhuyenao/load_reward_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=vongquayhuyenao_pt&func=edit_reward_details" method="POST" enctype="multipart/form-data">
