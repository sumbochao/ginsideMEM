...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=vip&func=index&view=event&module=<?php echo $_GET['module']; ?>&game=<?php echo $_GET['game']; ?>";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=vip&func=index&view=filters&module=<?php echo $_GET['module']; ?>&game=<?php echo $_GET['game']; ?>";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=vip&func=history&module=<?php echo $_GET['module']; ?>&game=<?php echo $_GET['game']; ?>";
        });
        $('#info').on('click', function (e) {
            window.location.href = "/?control=vip&func=info&module=<?php echo $_GET['module']; ?>&game=<?php echo $_GET['game']; ?>";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="<?php echo $_GET['func'] == 'info' ? 'active' : ''; ?>"><a id="info" href="" aria-controls="info" role="tab" data-toggle="tab">THÔNG TIN</a></li>
</ul>
