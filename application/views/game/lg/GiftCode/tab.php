...
<script>
    ...
    $(function () {
        $('#typecode').on('click', function (e) {
            window.location.href = "/?control=giftcode_lg&func=index&view=typecode&module=<?php echo $_GET['module']; ?>";
        });
        $('#giftcode').on('click', function (e) {
            window.location.href = "/?control=giftcode_lg&func=index&view=giftcode&module=<?php echo $_GET['module']; ?>";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php echo $_GET['view'] == 'typecode' ? 'active' : ''; ?>"><a id="typecode" href="" aria-controls="typecode" role="tab" data-toggle="tab">LOẠI CODE</a></li>
    <li role="presentation" class="<?php echo $_GET['view'] == 'giftcode' ? 'active' : ''; ?>"><a id="giftcode" href="" aria-controls="giftcode" role="tab" data-toggle="tab">GIFTCODE</a></li>
</ul>
