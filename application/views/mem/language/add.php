    ...
    $(document).ready(function () {
        ...
        $('#onSubmit').on('click', function () {
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url_service;?>/cms/mem/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        <?php
                            $defaultOff = 'checked';
                            if($_GET['id']>0){
                                $defaultOn =  $items['default']==1 ? 'checked="checked"':'';
                                $defaultOff =  $items['default']==0 ? 'checked="checked"':'';
                            }
                        ?>
                        ...
                        <div class="control-group">
                            <label class="control-label">Mã ngôn ngữ:</label>
                            <div class="controls">
                                <input name="code" id="code" value="<?php echo $items['code'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Mật định:</label>
                            <div class="controls">
                                Enable:<input type="radio" name="default" id="default" value="1" <?php echo $defaultOn;?>/>
                                &nbsp;&nbsp;
                                Disable:<input type="radio" name="default" id="default" value="0" <?php echo $defaultOff;?>/>
                            </div>
                        </div>
                        <div class="control-group">
