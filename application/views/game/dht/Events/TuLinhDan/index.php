    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=tulinhdan_dht&module=all&func=themgiaidau#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/edit_tournament_details",
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
                ...
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                      ...
                      <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="tournament_money" id="tournament_money" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> (Kim Cương/1 Lượt)
                            </div>
                        </div>
<!--  
                        <div class="control-group">
