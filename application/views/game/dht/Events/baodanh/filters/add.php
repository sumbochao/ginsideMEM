        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $(".item_rule").each(function(e, item) {
                    rules[e] = {
                        'key':$(item).children().find("input[name^=key]").val(),
                        'keymoney':$(item).children().find("input[name^=keymoney]").val(),
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "<?php echo $url_service;?>/cms/baodanh/<?php echo $_GET['id']>0?'edit_filters?id='.$_GET['id']:'add_filters';?>",
                    data:{
                        ...
                        money_user:$("input[name='money_user']").val(),
                        test_rule:$("input:radio[name='test_rule']:checked").val(),
                    },
                    beforeSend: function () {
                        $(".loading").fadeIn("fast");
                    }
                    ...
                    <div class="well form-horizontal">
                        ...
                        <?php
                            ...
                            if($_GET['id']>0){
                                ...
                                $test_ruleOn =  $items['test_rule']==1 ? 'checked="checked"':'';
                                $test_ruleOff =  $items['test_rule']==0 ? 'checked="checked"':'';
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="type" class="validate[required,custom[onlyNumberSp]]">
                                    <option value="1" <?php echo $items['type']==1?'selected="selected"':'';?>>Liên tục</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                Enable:<input type="radio" name="test_rule" id="test_rule" value="1" <?php echo $test_ruleOn;?>/>
                                &nbsp;&nbsp;
                                Disable:<input type="radio" name="test_rule" id="test_rule" value="0" <?php echo $test_ruleOff;?>/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Vàng user:</label>
                            <div class="controls">
                                <input type="text" name="money_user" value="<?php echo $items['money_user'];?>"/>
                            </div>
                        </div>
                        <div class="control-group">
