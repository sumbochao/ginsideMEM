...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            //Set DateTime Format
            $("#start_date").jqxDateTimeInput({ width: '150px', height: '28px', formatString: 'yyyy-MM-dd' });
            var start_date = '<?php echo $start_date; ?>';
            $('#start_date').jqxDateTimeInput('setDate', start_date);
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=event_dot_pha_tuong_5sao&func=addConfig" method="POST" enctype="multipart/form-data">
