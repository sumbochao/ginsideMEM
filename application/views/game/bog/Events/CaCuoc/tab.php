...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=trandau#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=quanlyqua#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=lichsu#lichsu";
        });
        
        $('#lichsudoiqua').on('click', function (e) {
            window.location.href = "/?control=event_covu_bog&func=lichsudoiqua#lichsudoiqua";
        });
    });
</script>
<style>
