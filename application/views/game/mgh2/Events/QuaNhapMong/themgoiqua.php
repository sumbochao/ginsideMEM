    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=quanhapmong_mgh2&func=quanlygoiqua?type=' + type;
                }
                else {
                    window.location.href = '/?control=quanhapmong_mgh2&func=quanlygoiqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=quanhapmong_mgh2&func=add_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">  
                        ...
                        <div class="control-group" style="display: none;">                            
                            ...
                            <div class="controls">
                            <input name="gift_number_request" id="gift_number_request" type="text" class="span3 validate[required,custom[onlyNumberSp]]" value="0" />
                            </div>
                        </div>
