<div class="rows">	
    <div class="input_fields_wrap">
        ...
        <?php
            $json_rule = json_decode($items['promotion'],true);
            if(count($json_rule)>0){
                $i=0;
                foreach($json_rule as $krule=>$rule){
                    $i++;
                    ?>
        <div class="control-group listItem">
            <div class="group1">
                <div class="form-group">
                    ...
                    <input id="alias" name="alias[<?php echo $i;?>]" type="text" value="<?php echo $krule;?>">
                </div>
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if(x < max_fields){ //max input box allowed
                ...
                xhtml += '<div class="control-group listItem">';
                    xhtml +='<div class="group1">';
                         xhtml +='<div class="form-group">';
                             xhtml +='<label class="control-label">Mốc:</label>';
