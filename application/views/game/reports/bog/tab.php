<script>
    $(function () {        
        $('#user_active_by_server').on('click', function (e) {
            window.location.href = "/?control=reports&func=user_active_byserver&game=<?php echo $_GET['game'];?>#user_active_by_server";
        });
		$('#user_active_by_date').on('click', function (e) {
            window.location.href = "/?control=reports&func=user_active_bydate&game=<?php echo $_GET['game'];?>#user_active_by_date";
        });
		$('#role_active_by_server').on('click', function (e) {
            window.location.href = "/?control=reports&func=role_active_byserver&game=<?php echo $_GET['game'];?>#role_active_by_server";
        });
        $('#role_active_by_date').on('click', function (e) {
            window.location.href = "/?control=reports&func=role_active_bydate&game=<?php echo $_GET['game'];?>#role_active_by_date";
        });
        $('#money_bydate').on('click', function (e) {
            window.location.href = "/?control=reports&func=money_bydate&game=<?php echo $_GET['game'];?>#money_bydate";
        });
		$('#money_byserver').on('click', function (e) {
            window.location.href = "/?control=reports&func=money_byserver&game=<?php echo $_GET['game'];?>#money_byserver";
        });
		$('#bluegem_statistics_bydate').on('click', function (e) {
            window.location.href = "/?control=reports&func=bluegem_statistics_bydate&game=<?php echo $_GET['game'];?>#bluegem_statistics_bydate";
        });
        $('#bluegem_statistics_byserver').on('click', function (e) {
            window.location.href = "/?control=reports&func=bluegem_statistics_byserver&game=<?php echo $_GET['game'];?>#bluegem_statistics_byserver";
        });
        $('#money_statistics_activeuser_all').on('click', function (e) {
            window.location.href = "/?control=reports&func=money_statistics_activeuser_all&game=<?php echo $_GET['game'];?>#money_statistics_activeuser_all";
        });
        $('#money_statistics_activeuser_details').on('click', function (e) {
            window.location.href = "/?control=reports&func=money_statistics_activeuser_details&game=<?php echo $_GET['game'];?>#money_statistics_activeuser_details";
        });
    });
</script>
