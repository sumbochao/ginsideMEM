    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            ...
            <div class="rows">
                ...
                <div class="input"><input type="text" placeholder="Rate" value="<?php echo $v['rate']; ?>" name="rate[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="rate[' + x + ']" value="1" placeholder="Rate" /></div>';
            html += '</div>';
            html += '<div class="rows">';
