    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                ...
                window.location.href = '/?control=accumulation&func=excel&game=<?php echo $_GET['game'];?>&module=<?php echo $_GET['module'];?>&start='+start+'&end='+end;
            });
        });
        function getData() {
            $.ajax({
                        ...
                        aoColumns: [
                            ...
                            },
							{
                               ...
                               mRender: function (data) {
                                   return "<a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=accumulation&func=delete&view=history&module=all&id=" + data + "&game=<?php echo $_GET['game'];?>'>Xóa</a>";
                               }
                            }
                        ],
                        bProcessing: true,
