...
<form action="" method="post" name="frmindex">
    <div class="rows">
        ...
        <a href="/?control=reportsocial&func=configmenuadd" class="game-button">THÊM GAME</a>
        <?php echo $error; ?>
    </div>
<table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover">
 <!--<table width="100%" border="0" class="table table-hover table-striped table-vcenter">-->
	...
	?>
        ...
        <?php
            $edit = "<a href='".base_url()."?control=reportsocial&func=configmenuadd&id=".$val['idx']."'><img src='".base_url()."assets/img/icon/icon_edit.png'></a>";
        ?>
        <tr>
            <td><?php echo $key + 1?></td>
            <td><?php echo $val['idx']?></td>
            <td><?php echo $val['fanpage']?></td>
            <td><?php echo $val['description']?></td>
            <td><?php echo $val['insertdate']?></td>
