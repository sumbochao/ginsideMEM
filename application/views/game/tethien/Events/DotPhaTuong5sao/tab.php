...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_dot_pha_tuong_5sao&func=index#home";
        });
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_dot_pha_tuong_5sao&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐỘT PHÁ TƯỚNG 5*</h4>
<!-- Nav tabs -->
