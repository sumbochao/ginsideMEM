    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() { 
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                   window.location.href = '/?control=shopnganluong_mgh2&func=quanlyqua&type=' + type + "&module=all#quanlyqua"; 
                }
                else{
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                    <form id="frmSendChest" action="/?control=shopnganluong_mgh2&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
