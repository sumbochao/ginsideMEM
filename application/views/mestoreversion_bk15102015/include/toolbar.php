<div class="header_toolbar">
    ...
    <div class="toolbar">
        <?php
            ...
            $lnkAdd = base_url()."?control=".$_GET['control']."&func=add&service_id=".$_POST['cbo_app'];
            ...
            $lnkCancel = base_url()."?control=".$_GET['control']."&func=index&service_id=".$_GET['service_id']."&platform=".$_GET['platform'];
