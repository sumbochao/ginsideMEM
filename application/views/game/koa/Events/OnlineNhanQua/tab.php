...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=<?php echo $control;?>&func=index&module=all#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=<?php echo $control;?>&func=quanlyqua&module=all#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=<?php echo $control;?>&func=lichsu&module=all#lichsu";
        });
