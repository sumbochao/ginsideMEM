...
<script>
    function loadIframecontentServer() {
        var game = $("input[name=game_id]").val();
        var lid = "";
        ...
        jQuery("#ifmserver").html('<iframe style="width:100%;height:350px;border:0px;" id="ifmservercontent" src="<?php echo APPLICATION_URL;?>?control=purchase&func=listserver&iframe=1&game='+game+'&lid='+lid+'"></iframe>');
    } 
