...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=tienbao_gm&func=index&view=event&module=all#event";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=tienbao_gm&func=index&view=item&module=all#item";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=tienbao_gm&func=history&module=all#history";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation"><a id="event" href="#event" aria-controls="event" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
    <li role="presentation" class="active"><a id="item" href="#item" aria-controls="item" role="tab" data-toggle="tab">DANH SÁCH QUÀ</a></li>
