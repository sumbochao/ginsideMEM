    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=event_covu&func=themqua#quanlyqua';
            });
        });

        function getData() {
            $.ajax({
                url: "http://game.mobo.vn/hiepkhach/cms/toolcacuoc/gift_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_covu&func=chinhsuaqua&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                    }
