    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=trianbanghuu&module=all&func=themsukien#sukien';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/volam/cms/tooltrianbanghuu/edit_tournament_details",
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/volam/cms/tooltrianbanghuu/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
                    ...
                    if (data[0]["start"] != "" && data[0]["start"] != null ) {
                        tournament_date_start = new Date(data[0]["start"]);
                    } 
                    var tournament_date_end = null;;
                    if (data[0]["end"] != "" && data[0]["end"] != null) {
                        tournament_date_end = new Date(data[0]["end"]);
                    }                   
                    ...
                    $("#server_list").val(data[0]["server_ids"]);
                ...
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="server_list" id="server_list" type="text" class="span3" style="margin: 0px; width: 295px; height: 60px;"></textarea>
                                (ID Server cần điền theo dạng như sau "[1],[2],[3],[4],[5],[6]")
                            </div>
                        </div>
