    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=vongquaymayman_pt&func=themgiaidau#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/phongthan/cms/toolvongquaymayman/edit_tournament_details",
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                      ...
                      <div class="control-group">
                            <label class="control-label">Tỷ lệ đổi lượt:</label>
                            <div class="controls">
                                <input name="tournament_money" id="tournament_money" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> (VNĐ/1 Lượt)
                            </div>
                        </div>
<!--  
                        <div class="control-group">
