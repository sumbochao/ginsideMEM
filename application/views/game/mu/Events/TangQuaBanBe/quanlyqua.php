    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=tangquabanbe_mu&&module=all&func=themqua&tournament_id=' + $("#tournament").val() + '#quanlyqua';
            });
            
            $("#tournament").change(function () {             
                window.location.href = "/?control=tangquabanbe_mu&module=all&func=quanlyqua&tournament_id=" + $("#tournament").val() + "#quanlyqua";                
            });
        ...
        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/mu/cms/tooltangquabanbe/get_all_tangquabanbe_gift?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            }, 
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a class='btn btn-success btn-xs' href='/?control=tangquabanbe_mu&module=all&func=chinhsuaqua&tournament_id=" + $("#tournament").val() + "&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                }
                            }
