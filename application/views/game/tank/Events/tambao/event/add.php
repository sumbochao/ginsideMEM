            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        turn:$("input[name=turn]").val(),                        
                        content_server:$("input[name=content_server]").val(),
                        start:$("input[name=start]").val(),
                        end:$("input[name=end]").val(),
                        closedate:$("input[name=closedate]").val(),
                        num_item:$("input[name=num_item]").val(),
                        test:$("input:radio[name='test']:checked").val(),                    
                    },
                    beforeSend: function () {
                        $(".loading").fadeIn("fast");
                    }
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            <label class="control-label">Lượt miễn phí:</label>
                            <div class="controls">
                                <input name="turn" id="turn" value="<?php echo $turn;?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <label class="control-label">Đóng sự kiện:</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="num_item" id="num_item" value="<?php echo $num_item;?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tester:</label>
                            <div class="controls">
                                Enable:<input type="radio" name="test" id="test" value="1" <?php echo $testOn;?>/>
                                &nbsp;&nbsp;
                                Disable:<input type="radio" name="test" id="test" value="0" <?php echo $testOff;?>/>
                            </div>
                        </div>
                        <div class="control-group">
