...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    <style>
		...
		.w25 .control-group{width: 20%;}
		.group1 .control-group {float: left;}
		...
		.form-horizontal .controls {position: relative;margin-left: 0%;}.control-group input[type="text"] {border-radius: 0;box-shadow: none;width: 90%;}
		   ...
		   ?>
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=gmtool&func=submiteventitems" method="POST" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <select id="game" name="game" class="span4 " />
                                    ...
                                    if($listgame) {
                                        ...
                                        foreach ($listgame as $key => $val) {
											if((@in_array($val['app_name'], $_SESSION['permission']) && $_SESSION['account']['id_group']==2)|| $_SESSION['account']['id_group']==1){
												if ($val['service_id'] == $detail['game']) {
													echo '<option value="' . $val['service_id'] . '" selected>' . $val['app_fullname'] . '</option>';
												} else {
													echo '<option value="' . $val['service_id'] . '">' . $val['app_fullname'] . '</option>';
												}
											}	
                                        }
                                    }
                        ...
                        <div class="control-group">
                            <label class="control-label">[SEND]Public All:</label>
                            <div class="controls">
						...
						<br/>
						<div class="control-group">
                            <label class="control-label">[SEND] REAL:</label>
                            <div class="controls">
                                Enable:<input type="radio" name="sendreal" class=""  value="1">
                                    &nbsp;&nbsp;
                                Disable:<input type="radio" name="sendreal" class="" checked="true" value="0">
                            </div>
                        </div>
						<br/>
						<?php } ?>
