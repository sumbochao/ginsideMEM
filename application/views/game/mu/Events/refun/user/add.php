        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/refun/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="mobo_id" id="mobo_id" value="<?php echo $items['mobo_id'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="amount" id="amount" value="<?php echo $items['amount'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">VNĐ:</label>
                                <div class="controls">
                                    <input name="vnd" id="vnd" value="<?php echo $items['vnd'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Số lượng kim cương:</label>
                                <div class="controls">
                                    <input name="count_kimcuong" id="count_kimcuong" value="<?php echo $items['count_kimcuong'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Số lượng VIP:</label>
                                <div class="controls">
                                    <input name="count_vip" id="count_vip" value="<?php echo $items['count_vip'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
