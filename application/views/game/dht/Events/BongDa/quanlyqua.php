    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=event_bongda_dht&func=themqua&module=all#quanlyqua';
            });
        });
                        ...
                        aoColumns: [
                            {
                               ...
                               },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_bongda_dht&func=chinhsuaqua&module=all&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                    }
