    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" name="frmSendChest" action="/?control=consomayman_lvl&func=<?php echo $_GET['func']=='edit'?'edit_item':'add_item';?>&module=all" method="POST" enctype="multipart/form-data">
