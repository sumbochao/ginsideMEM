...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        function get_tangquabanbe_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mu/cms/tooltangquabanbe/get_tangquabanbe_gift_send_details?id=" + id,
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tangquabanbe_mu&module=all&func=edit_tangquabanbe_gift_send" method="POST" enctype="multipart/form-data">
