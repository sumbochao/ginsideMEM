        ...
        $(document).ready(function () {
            ...
            $('#addItem').click(function(){
                var html = '<div class="control-group">'
                            ...
                            +'<div class="controls">'
                            +'<input value="" name="type[]" id="type" type="text" class="span3 validate[required]" />'
                            +'</div>'
                            +'</div>';
                $('#items').append(html);
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_gio_vang&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input value="<?php echo $start;?>" name="start" id="start" type="text" class="span3 validate[required]" />
                                (Format: hh:mm:ss)
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input value="<?php echo $end;?>" name="end" id="end" type="text" class="span3 validate[required]" />
                                (Format: hh:mm:ss)
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div id="items">
                            <?php if($id == ''): ?>
                                <div class="control-group">
                                    ...
                                    <label class="control-label">Type:</label>
                                    <div class="controls">
                                        <input value="<?php echo $item->type; ?>" name="type[]" id="type" type="text" class="span3 validate[required]" />
                                    </div>
                                </div>
                            <?php else: ?>
