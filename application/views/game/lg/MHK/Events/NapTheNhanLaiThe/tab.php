...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=napthe_nhanlaithe_mhk&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=napthe_nhanlaithe_mhk&func=giaidau&module=all#giaidau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=napthe_nhanlaithe_mhk&func=quanlyqua&module=all#quanlyqua";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=napthe_nhanlaithe_mhk&func=lichsu&module=all#lichsu";
        });

        $('#lichsunhanlaithe').on('click', function (e) {
            window.location.href = "/?control=napthe_nhanlaithe_mhk&func=lichsunhanlaithe&module=all#lichsunhanlaithe";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT NẠP THẺ NHẬN LẠI THẺ</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="lichsunhanlaithe" href="#lichsunhanlaithe" aria-controls="lichsunhanlaithe" role="tab" data-toggle="tab">LỊCH SỬ NHẬN THẺ</a></li>
</ul>
