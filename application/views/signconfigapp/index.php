    ...
    <form id="appForm" action="" method="post" name="appForm">
        ...
        <div class="filter">
            ...
            <select name="cert_id">
                ...
                ?>
                <option value="<?php echo $v['id'];?>" <?php echo $arrFilter['cert_id']==$v['id']?'selected="selected"':'';?>><?php echo $v['cert_type']." - ".$slbPartner[$v['idpartner']]['partner'];?></option>
                <?php
                        }
                    }
                ?>
        ...
        <table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            <thead>
                <tr>
                    ...
                    <th align="center" width="100px">Holder</th>
                    <th align="center">Game</th>
                    <th align="center">Platform</th>
                    <th align="center" width="150px">Bảng Cert</th>
                    <th align="center" width="150px">BundleID</th>
                     <th align="center" width="100px">Provision file</th>
                      <th align="center" width="100px">Entitlement file</th>
                    <!--<th align="center" width="100px">Duyệt</th>-->
                    <!--<th align="center" width="100px">Sắp xếp</th>-->
                    <th align="center" width="60px">Chức năng</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $slbPartner[$v['idpartner']]['partner'];?></td>
                    <td style="text-align:left"><?php echo $slbGame[$v['id_game']]['app_fullname'];?></td>
                    <td><?php echo $v['platform'];?></td>
                    <td><?php 
					if($v['platform']=="ios"){
						echo $slbTable[$v['cert_id']]['cert_type'];
					}elseif($v['platform']=="android"){
						echo $v['cert_id']==1?"GooglePlay":"Inhouse";
					}elseif($v['platform']=="wp"){
						echo $v['cert_id']==1?"WinStore":"Inhouse";
					}
                    ...
                    <td>
                    <?php if($v['provision']!=""){ ?>
                    <a href="<?php echo base_url('?control=signconfigapp&func=download&id='.$v['id'].'&file='.$v['provision']) ?>">Tải</a>
                    <?php } ?>
                    </td>
                    <td>
                    <?php if($v['entitlements']!=""){ ?>
                    <a href="<?php echo base_url('?control=signconfigapp&func=download&id='.$v['id'].'&file='.$v['entitlements']) ?>">Tải</a>
                    <?php } ?>
                    </td>
                    <!--<td>
                        <?php
