...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=accumulation&func=index&view=event&module=<?php echo $_GET['module'];?>&game=<?php echo $_GET['game'];?>";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=accumulation&func=index&view=filters&module=<?php echo $_GET['module'];?>&game=<?php echo $_GET['game'];?>";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=accumulation&func=history&module=<?php echo $_GET['module'];?>&game=<?php echo $_GET['game'];?>";
        });
    });
</script>
<style>
