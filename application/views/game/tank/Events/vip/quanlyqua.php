    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=tank_event_goi_qua_vip&&module=all&func=themqua&tournament_id=' + $("#tournament").val() + '&pakage_id=' + $("#vip_gift_pakage").val() + '#quanlyqua';
            });
            
            $("#tournament").change(function () {             
                window.location.href = "/?control=tank_event_goi_qua_vip&module=all&func=quanlyqua&tournament_id=" + $("#tournament").val() + "#quanlyqua";                
            });
            
            $("#vip_gift_pakage").change(function () {             
                window.location.href = "/?control=tank_event_goi_qua_vip&module=all&func=quanlyqua&tournament_id=" + $("#tournament").val() + "&id=" + $("#vip_gift_pakage").val() + "#quanlyqua";              
            });
        ...
        function getData(pakage_id) {
            $.ajax({
                url: "http://game.mobo.vn/tank/cms/toolvip/get_vip_gift?pakage_id=" + pakage_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a class='btn btn-success btn-xs' href='/?control=tank_event_goi_qua_vip&module=all&func=chinhsuaqua&tournament_id=" + $("#tournament").val() + "&pakage_id=" + $("#vip_gift_pakage").val() + "&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                }
