...
class Cimongo_base {
	...
	private $options = array('replicaSet' => "TTKTMONGO",'readPreference' => MongoClient::RP_SECONDARY_PREFERRED);
	...
	public function __construct(){
		...
		//$this->options= array('replicaSet' => "TTKTMONGO");
	 ...
	 * @since v1.0.0
	 */
	private function connect($options = array()){
		try{
	...
	private function connection_string(){
		...
		$connection_string	= trim($this->CI->config->item('link'));
		...
		*/
		...
		//echo $this->connection_string;die;
	}
