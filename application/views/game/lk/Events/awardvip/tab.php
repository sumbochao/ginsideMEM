...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index&view=event#event";
        });
        $('#config').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index&view=config#config";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index&view=item#item";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=history#history";
        });
    });
</script>
<style>
