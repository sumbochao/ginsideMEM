...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_goi_qua_vip&func=index#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_goi_qua_vip&func=quanlyqua#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_goi_qua_vip&func=lichsu#lichsu";
        });


        $('#log_nap_tien').on('click', function (e) {
            window.location.href = "/?control=event_goi_qua_vip&func=log_nap_tien#log_nap_tien";
        });
    });
</script>
<style>
