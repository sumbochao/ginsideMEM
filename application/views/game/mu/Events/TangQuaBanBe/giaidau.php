    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=tangquabanbe_mu&module=all&func=themgiaidau#giaidau';
            });
        });
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=tangquabanbe_mu&module=all&func=chinhsuagiaidau&id=" + data + "#giaidau'>Chỉnh Sửa</a>";
                                    }
