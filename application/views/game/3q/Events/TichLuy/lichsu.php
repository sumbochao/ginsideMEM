    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=tichluy_3q&func=lichsu&type=" + $("#history_type").val()  + "&tournament=" + $("#tournament").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#lichsu";
            });
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/tooltichluy/get_exchange_history?type=" + $("#history_type").val()  + "&tournament=" + $("#tournament").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
