...
<script type="text/javascript">
    function htmlItem(keyrule,y){
        ...
        subhtml += '    <div class="input">';
        subhtml += '        <input type="text" size="20" name="count[' + keyrule + '][' + y + ']" value="1" placeholder="Nhập Count" />';
        subhtml += '    </div>';
        subhtml += '</div>';
        subhtml += '<div class="rows">';
        subhtml += '    <div class="title">Rate</div>';
        subhtml += '    <div class="input">';
        subhtml += '        <input type="text" size="20" name="rate[' + keyrule + '][' + y + ']" value="1" placeholder="Nhập Rate" />';
        subhtml += '    </div>';
        subhtml += '</div>';
            ...
            ?>
                <div class="sub_item_rule" id="sub_item_rule">
                    ...
                    <div class="rows">
                        ...
                        <div class="input"><input type="text" placeholder="Nhập Count" value="<?php echo $v['count']; ?>" name="count[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
                    <div class="rows">
                        <div class="title">Rate</div>
                        <div class="input"><input type="text" placeholder="Nhập Rate" value="<?php echo $v['rate']; ?>" name="rate[<?php echo $i; ?>][<?php echo $j; ?>]" size="20"/></div>
                    </div>
