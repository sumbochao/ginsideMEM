...
<div id="content-t" style="min-height:500px; padding-top:10px">
    ...
    ?>
    <div class="success_signios">Đã SignApk thành công <a href="<?php echo base_url().'?control=signapk&func=index';?>">Quay về danh sách</a></div>
    <?php
	include('success.php');
        }
    ?>
        ...
        <table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            ...
            <tbody>
                ...
                <tr id="rows_<?php echo $i?>" class="rows_class">
                    ...
                    <td style="text-align:left" title="<?php echo $v['games'];?>"><?php echo $v['games'];	?><br/> 
					<a href="<?php echo $v['links_signed'];?>">Tải file apk</a> <br/>
                    ...
                    <td><strong style="color:<?php echo $v['type_app']=="Appstore"?"#036":"#903"; ?>" ><?php echo $v['type_app'];?></strong></td>
                    <td><?php echo $v['filenames_signed'];?></td>
                    <td><?php echo $v['channels'];?></td>
                    <td><strong style="color:#900"><a href="<?php echo base_url()."?control=mestoreversion&func=index&typeone=filter_one&service_id=".$v['id_game']."&platform=android&msv_id=msv_".$rrr[1].""; ?>" style="text-decoration:none;color:inherit;" target="_blank">
					<?php echo "msv_".$rrr[1];?>
                    </a></strong></td>
