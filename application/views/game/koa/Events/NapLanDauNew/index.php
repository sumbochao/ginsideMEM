    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=naplandau_new_koa&func=themgiaidau&module=all#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/edit_tournament_details",
        ...
        $(document).ready(function () {
            ...
            $("#chargingdate").jqxDateTimeInput({ width: '150px', height: '28px', formatString: 'yyyy-MM-dd HH:mm:ss' });            
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
                    ...
                    $("#chargingdate").jqxDateTimeInput('setDate', date_calcula_gold);
                ...
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div id="chargingdate" name="chargingdate"></div>
                            </div>
                        </div>
