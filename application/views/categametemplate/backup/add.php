        ...
        <div id="adminfieldset">
            ...
            <div class="group_left">
            	<div class="rows">	
                    ...
                    <select name="cbo_template" id="cbo_template" onchange="showcategories(this.value,'cbo_categories');">
                        <option value="0"> -- Template -- </option>
						<?php
                            if(count($slbtemplate)>0){
                                foreach($slbtemplate as $item){
                        ?>
                        <option value="<?php echo $item['id'];?>" <?php echo (intval($_GET['idtemplate'])==$item['id']) || ($_POST['cbo_template']==$item['id'])?"selected":""; ?>><?php echo $item['template_name'];?></option>
                        <?php
                                }
                            }
                        ?>
