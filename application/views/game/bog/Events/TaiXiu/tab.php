...
<script>
    ...
    $(function () {        
        ...
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=taixiu&func=quanlyqua&&module=all#quanlyqua";
        });


        $('#logdoiqua').on('click', function (e) {
            window.location.href = "/?control=taixiu&func=get_log_doiqua&&module=all#logdoiqua";
        });
        
        $('#logdatcuoc').on('click', function (e) {
            window.location.href = "/?control=taixiu&func=get_log_datcuoc&&module=all#logdatcuoc";
        });

        $('#quanlytiencuoc').on('click', function (e) {
            window.location.href = "/?control=taixiu&func=quanlytiencuoc&&module=all#quanlytiencuoc";
        });
...
<h4 class="widget-name">QUẢN LÝ EVENT TÀI XỈU</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="logdatcuoc" href="#logdatcuoc" aria-controls="logdatcuoc" role="tab" data-toggle="tab">LOG ĐẶT CƯỢC</a></li>
    <li role="presentation"><a id="quanlytiencuoc" href="#quanlytiencuoc" aria-controls="quanlytiencuoc" role="tab" data-toggle="tab">QUẢN LÝ TIỀN CƯỢC</a></li>
  </ul>
