...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=index#home";
        });
        ...
        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=trandau#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=quanlyqua#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_covu_pt&func=lichsu#lichsu";
        });
    });
</script>
<style>
