...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=giaidau&module=all#giaidau";
        });        

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=giaithuong&module=all#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=giaithuongtop&module=all#giaithuongtop";
        });

        $('#giaithuongpremiership').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=giaithuongpremiership&module=all#giaithuongpremiership";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=lichsu&module=all#lichsu";
        });
        
        $('#cacheconfig').on('click', function (e) {
            window.location.href = "/?control=toptyvo_hero&func=cacheconfig&module=all#cacheconfig";
        });
    });
</script>
<style>
