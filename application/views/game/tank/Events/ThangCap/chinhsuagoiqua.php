    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=thangcap_tank&func=quanlygoiqua&type=' + type + "&module=all#quanlygoiqua";
                }
                else {
                    window.location.href = '/?control=thangcap_tank&func=quanlygoiqua&module=all#quanlygoiqua';
                }
            });
        ...
        function load_gift_pakage_details(id){
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/tank/cms/toolthangcap/load_gift_pakage_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#id").val(data[0]["id"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=thangcap_tank&func=edit_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
