...
<form action="" method="post" name="frmadd">
	<fieldset>
		...
		<input type="text" name="message" id="message" value="<?php echo $message?>" class="textinput">
		<br><br>
		
		<label for="type">Type(number)</label>
		<input type="text" name="type" id="type" value="<?php echo $type?>" class="textinput">
		<br><br>
		<label for="relative_url">Photo</label>
		<input type="text" name="photo" id="photo" value="<?php echo $photo?>" class="textinput">
		<br><br>
		<label for="order">Link</label>
		<input type="text" name="link" id="link" value="<?php echo $link?>" class="textinput">
		<br><br>
		<label for="order">Startdate</label>
		<input type="text" name="startdate" id="startdate" value="<?php echo $startdate?>" class="textinput">
		<br><br>
		<label for="order">Enddate</label>
		<input type="text" name="enddate" id="enddate" value="<?php echo $enddate?>" class="textinput">
		<br><br>
		<label for="order">Status(1:0)</label>
		<input type="text" name="status" id="status" value="<?php echo $status?>" class="textinput">
		<br><br>
