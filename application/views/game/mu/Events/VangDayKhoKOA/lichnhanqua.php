    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#export_excel').on('click', function () {               
                window.location.href = '/?control=vangdaykhokoa_mu&func=excel_lichnhanqua&mobo_service_id=' + mobo_service_id + "&module=all";
            });
        ...
        function getData(mobo_service_id) {          
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/mu/cms/toolvangdaykho_koa/get_calendar_bonus?mobo_service_id=" + mobo_service_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
