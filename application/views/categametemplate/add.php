...
<div id="content-t" class="content_form" style="min-height:500px; padding-top:10px">
    <form id="appForm" action="" method="post" name="appForm" enctype="multipart/form-data">
        ...
        <div id="adminfieldset">
            <div class="adminheader">Nhập thông tin hạng mục GAME :<strong style="color:#906;"><?php echo $loadgame[intval($_GET['id_game'])]['app_fullname'] ?></strong></div>
               ...
               <div class="rows">	
                    ...
                    <select name="cbo_categories" id="cbo_categories">
                       <option value="na"> Hạng mục chính </option>
                        ...
                        <option value="<?php echo $cate['id'];?>" <?php echo $_GET['id_categories']==$cate['id']?"selected":""; ?> ><?php echo $cate['names'];?></option>
                        <?php
                                }//end for
                                echo " </optgroup>";
                            } //end if
