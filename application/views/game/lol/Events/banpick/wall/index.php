                        ...
                        aoColumns: [
                            ...
                            },
                            {
                               ...
                               mRender: function (data) {
                                    var img = '';
                                    if(data!=null){
                                        img = '<img height="71px" src="'+data+'">';
                                    }
                                   return img;
                               }
                            },
                            {
                               sTitle: "Hình ảnh đã chọn",
                               mData: "picture",
                               mRender: function (data) {
                                    var img = '';
                                    if(data!=null){
                                        var resPicture = data.replace("icon_mau", "den_trang");
                                        img = '<img height="71px" src="'+resPicture+'">';
                                    }
                                   return img;
                               }
                            },
                            {
                               ...
                               mRender: function (data) {
                                   return "<a class='btn btn-success btn-xs' href='/?control=banpick_lol&func=edit&view=<?php echo $_GET['view'];?>&module=<?php echo $_GET['module'];?>&id=" + data + "#<?php echo $_GET['view'];?>'>Sửa</a>\n\
                                           <a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=banpick_lol&func=delete&view=<?php echo $_GET['view'];?>&module=<?php echo $_GET['module'];?>&id=" + data + "#<?php echo $_GET['view'];?>'>Xóa</a>";
                               }
                            }
                        ],
                        bProcessing: true,
