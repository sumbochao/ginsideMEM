    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=shopkimbai_hero&func=quanlygoiqua?type=' + type;
                }
                else {
                    window.location.href = '/?control=shopkimbai_hero&func=quanlygoiqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=shopkimbai_hero&func=add_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
