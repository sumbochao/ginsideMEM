...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=giaidau#giaidau";
        });
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#quanlygoiqua').on('click', function (e) {
            window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=quanlygoiqua#quanlygoiqua";
        });       

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
