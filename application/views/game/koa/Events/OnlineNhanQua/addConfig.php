        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=<?php echo $control;?>&func=addConfig" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input onchange="this.value = (Number(this.checked));" type="checkbox" name="is_tester" value="<?php echo $is_tester; ?>" />
                            </div>
                        </div>
