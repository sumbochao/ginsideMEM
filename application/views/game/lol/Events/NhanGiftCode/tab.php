...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_nhan_giftcode&func=index&module=all#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_nhan_giftcode&func=quanlyqua&&module=all#quanlyqua";
        });


        $('#lognhanqua').on('click', function (e) {
            window.location.href = "/?control=event_nhan_giftcode&func=get_log_nhanqua&&module=all#lognhanqua";
        });
...
<h4 class="widget-name">QUẢN LÝ EVENT NHẬN GIFT CODE</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="quanlyqua" href="#quanlyqua" aria-controls="quanlyqua" role="tab" data-toggle="tab">QUẢN LÝ GIFT CODE</a></li>
    <li role="presentation"><a id="lognhanqua" href="#lognhanqua" aria-controls="lognhanqua" role="tab" data-toggle="tab">LOG NHẬN GIFT CODE</a></li>
  </ul>
