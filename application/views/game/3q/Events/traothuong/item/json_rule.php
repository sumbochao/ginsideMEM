...
<div class="rule_item">
    <div id="addScnt" class="btn btn-success">Thêm item</div>
    <div id="p_scents">
        <?php
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            <div class="rows">
                ...
                <div class="input"><input type="text" placeholder="Nhập Item ID" value="<?php echo $v['item_id']; ?>" name="item_id[[<?php echo $i; ?>]" size="20" id="p_scnt"></div>
            </div>
            <div class="rows">
                <div class="title">Name:</div>
                <div class="input"><input type="text" placeholder="Nhập Tên" value="<?php echo $v['name']; ?>" name="name[<?php echo $i; ?>]" size="20" id="p_scnt"></div>
            </div>
            <div class="rows">
                <div class="title">Count:</div>
                <div class="input"><input type="text" placeholder="Nhập Count" value="<?php echo $v['count']; ?>" name="count[<?php echo $i; ?>]" size="20" id="p_scnt" style="width:70px;"></div>
            </div>
            <div class="rows">
                <div class="title">Rate:</div>
                <div class="input"><input type="text" placeholder="Nhập Rate" value="<?php echo $v['rate']; ?>" name="rate[<?php echo $i; ?>]" size="20" id="p_scnt" style="width:70px;"></div>
            </div>
            <div class="rows">
                <div class="title">Type:</div>
                <div class="input"><input type="text" placeholder="Nhập Type" value="<?php echo $v['type']; ?>" name="type[<?php echo $i; ?>]" size="20" id="p_scnt" style="width:70px;"></div>
            </div>
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="item_id[' + x + ']" value="1" placeholder="Nhập Item ID" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Name:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="name[' + x + ']" value="1" placeholder="Nhập Tên" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Count:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="count[' + x + ']" value="1" placeholder="Nhập Count" style="width:70px;"/></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Rate:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="rate[' + x + ']" value="1" placeholder="Nhập Rate" style="width:70px;"/></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Type:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="type[' + x + ']" value="1" placeholder="Nhập Type" style="width:70px;"/></div>';
            html += '</div>';
