    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                window.location.href = '/?control=wallet&func=add&view=<?php echo $_GET['view'];?>&module=all';
            });
        });
        function getData() {
            $.ajax({
                url: "<?php echo $url_service; ?>/cms/wallet/index_<?php echo $_GET['view'];?>?game_id=<?php echo $gameid;?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                               ...
                               mData: "id",
                               mRender: function (data) {
                                   return "<a class='btn btn-success btn-xs' href='/?control=wallet&func=edit&view=<?php echo $_GET['view'];?>&module=all&id=" + data + "'>Sửa</a>\n\
                                           <a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=wallet&func=delete&view=<?php echo $_GET['view'];?>&module=all&id=" + data + "'>Xóa</a>";
                               }
                            }
                        ],
                        bProcessing: true,
