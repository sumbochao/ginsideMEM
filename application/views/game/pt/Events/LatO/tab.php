...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=index#home";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=thongke#thongke";
        });

        $('#logdoiqua').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=logdoiqua#logdoiqua";
        });

        $('#logthamgia').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=logthamgia#logthamgia";
        });

        $('#logdoiluotbangtien').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=logdoiluotbangtien#logdoiluotbangtien";
        });

        $('#clearcached').on('click', function (e) {
            window.location.href = "/?control=event_lato_pt&func=clearcached#clearcached";
        });
    });
</script>
<style>
