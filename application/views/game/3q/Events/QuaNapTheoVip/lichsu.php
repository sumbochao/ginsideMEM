    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=quanaptheovip_3q&func=lichsu&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#lichsu";
            });
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/toolquanaptheovip/get_gift_exchange_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
