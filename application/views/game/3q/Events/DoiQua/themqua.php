    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=doiqua_3q&func=quanlyqua&type=' + type + "&module=all#quanlyqua";
                } else {
...
<?php include APPPATH . 'views/game/3q/Events/DoiQua/tab.php'; ?>
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=doiqua_3q&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
