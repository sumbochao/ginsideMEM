<div class="header_toolbar">
    ...
    <div class="toolbar">
        <?php
            ...
            $lnkCancel = base_url()."?control=".$_GET['control']."&func=index&id=".$_GET['id'];
			...
			$btnDeleteCache = '<div class="toolbar-button">
                            <a href="'.base_url().'?control='.$_GET['control'].'&func=del_cache&id='.$_GET['id'].'">
                                <img src="'.base_url().'assets/img/icon-32-delete.png"/>
                                <div>Xóa cache</div>
                            </a>
                        </div>';
        ...
        <?php
            switch ($_GET['func']){
                ...
                case 'edit':
                    ...
                    break;
                case 'permission':
                    $strButton = $btnDeleteCache.' '.$btnCancel;
                    break;
