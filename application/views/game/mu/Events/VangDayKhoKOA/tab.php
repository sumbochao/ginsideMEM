...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vangdaykhokoa_mu&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vangdaykhokoa_mu&func=giaidau&module=all#giaidau";
        });  
        
        $('#nhanvatthamgia').on('click', function (e) {
            window.location.href = "/?control=vangdaykhokoa_mu&func=nhanvatthamgia&module=all#nhanvatthamgia";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vangdaykhokoa_mu&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT HỖ TRỢ GAMER LỤC GIỚI</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="nhanvatthamgia" href="#nhanvatthamgia" aria-controls="nhanvatthamgia" role="tab" data-toggle="tab">NHÂN VẬT THAM GIA</a></li>
