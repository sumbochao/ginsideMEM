    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                ...
                window.location.href = '/?control=uocnguyen_bog&func=excel_history_item&module=all&server_id='+server_id+'&start='+start+'&end='+end;
            });
            $("#search").on('click', function () {
                var start = $("input[name=start]").val();
                var end = $("input[name=end]").val();
                var server_id = $("select[name=server_id]").val();
                window.location.href = '/?control=uocnguyen_bog&func=history_item&module=all&server_id='+server_id+'&start='+start+'&end='+end;
            });
        });
        function getData() {
            $.ajax({
