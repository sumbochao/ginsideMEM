...
<div id="content-t" class="content_form" style="min-height:500px; padding-top:10px">
        ...
        <div id="adminfieldset" class="groupsignios" style="width:100% !important">
            ...
            <div class="group_left">
				...
				<div class="rows">	
                    ...
                    <input type="text" name="source_type" id="source_type" class="textinput"/>             
                </div>
           </div> <!--group_left-->
       </div> <!--groupsignios-->
    ...
    <div class="group_left">  
				<div class="rows">	
                    ...
                    <input type="text" name="pixel_app" id="pixel_app" class="textinput" />             
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Pixel Key</label>
                    <input type="text" name="pixel_key" id="pixel_key" class="textinput" />             
                </div>    
                <div class="rows">	
				...
				<div class="rows">	
                    ...
                    <input type="text" name="tune" id="tune" class="textinput" />             
                </div>
                <div class="rows">	
                    <label for="menu_group_id">TuneConversionKey</label>
                    <input type="text" name="TuneConversionKey" id="TuneConversionKey" class="textinput" />             
                </div>
                <div class="rows">	
                    <label for="menu_group_id">TunePackageName</label>
                    <input type="text" name="TunePackageName" id="TunePackageName" class="textinput" />             
                </div>
    ...
    <div id="adminfieldset" class="groupsignios">
        ...
        <div class="group_left">
            <div class="rows">	
                ...
                <input type="text" name="link_android" id="link_android" class="textinput" value="" />             
            </div>
        </div>
        <div class="group_left">
            <div class="rows">	
                <label for="menu_group_id">IOS</label>
                <input type="text" name="link_ios" id="link_ios" class="textinput" value="" />             
            </div>
        </div>
        <div class="group_left">
            <div class="rows">	
                <label for="menu_group_id">WP</label>
                <input type="text" name="link_wp" id="link_wp" class="textinput" value="" />             
            </div>
        </div>
    </div>   
   <div id="adminfieldset" class="groupsignios" style="width:100% !important">
    ...
    <div class="group_left">  
				...
				<div class="rows">	
                    ...
                    <input type="text" name="onesignal" id="onesignal" class="textinput" value="" />             
                </div>
    </div> <!--group_left-->
       </div> <!--groupsignios-->
...
function isNumber(evt) {
	...
	function addstep1(){
		...
		$.ajax({
                ...
                type:"GET",
                data:{code:_code,names:_names,namesetup:_namesetup,servicekeyapp:_servicekeyapp,servicekey:_servicekey,facebookapp:_facebookapp,facebookappid:_facebookappid,facebookappsecret:_facebookappsecret,itunesconnect:_itunesconnect,appleid:_appleid,gacode:_gacode,appsflyerid:_appsflyerid,googleproductapi:_googleproductapi,urlschemes:_urlschemes,facebookurlschemes:_facebookurlschemes,googlesenderid:_googlesenderid,googleapikey:_googleapikey,onesignal:_onesignal,facebookfanpagelink:_facebookfanpagelink,request_per:_request_per,accept_per:_accept_per,notes:notes,screens:screens,config_logout:config_logout,language_sdk:language_sdk,folder:folder,tune:_tune,sourcetype:_sourcetype,TuneConversionKey:_TuneConversionKey,TunePackageName:_TunePackageName,link_android:_link_android,link_ios:_link_ios,link_wp:_link_wp,pixel_app:_pixel_app,pixel_key:_pixel_key},
                async:false,
                dataType:"json",
                beforeSend:function(){
    ...
    function addstep2(){
		...
		$.ajax({
                ...
                type:"GET",
                data:{id_projects:0,cbo_platform:_cbo_platform,app_id:_app_id,store_id:_store_id,park_id:_park_id,package_name:_package_name,version_type:_version_type,public_key:_public_key,inapp_product:_inapp_product,appstore_inapp_items:_appstore_inapp_items,gp_inapp_items:_gp_inapp_items,notes_p:notes_p},
                async:false,
                dataType:"json",
                beforeSend:function(){
                    $('.loading_warning').show();
