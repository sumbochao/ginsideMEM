        ...
        function getData() {
            $('#data_table').DataTable({
                ...
                aoColumns: [
                    ...
                    {
                        sTitle: "Vật phẩm đính kèm gói quà",
                        mData: "items_1"
                    },
                    {
                        sTitle: "Vật phẩm nhận hàng ngày",
                        mData: "items_2"
                    },
                    {
                        sTitle: "Giá",
                    ...
                    },
                    {
                        ...
                        mRender: function (data, arg1, arg2) {
                            return "<a class='btn btn-success btn-xs' href=' /?control=<?php  echo $control;?>&func=themqua&game=<?php echo $game;?>&id=" + data +"&config_id=" + arg2.config_id +"#quanlyqua '>Chỉnh Sửa</a>";
                        }
