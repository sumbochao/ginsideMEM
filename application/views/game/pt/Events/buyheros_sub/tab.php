...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "?control=buyheros_sub&func=index&view=item";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "?control=buyheros_sub&func=index&view=wheel";
        });
		$('#history').on('click', function (e) {
            window.location.href = "?control=buyheros_sub&func=history&view=history";
        });
    });
</script>
<style>
