    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=toptyvo_mgh2&func=themgiaidau&module=all#giaidau';
            });
        });
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=toptyvo_mgh2&func=chinhsuagiaidau&id=" + data + "&module=all#giaidau'>Chỉnh Sửa</a>";
                                    }
