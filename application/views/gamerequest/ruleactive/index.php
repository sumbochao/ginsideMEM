                ...
                <tr>
                    ...
                    <td>
                        <?php
                            ...
                            $btnDelete ='
                                <a onclick="if(!window.confirm(\'Bạn có muốn xóa '.$slbConfig[$v['configID']]['name'].' và '.$slbGame[$v['gameID']]['name'] .' này không ?\')) return false;" href="'.base_url()."?control=".$_GET['control']."&func=delete&id=".$v['idx'].'" title="Xóa">
