...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#frmSendChest').ajaxForm(function (data) {
                ...
                if (data.result != "-1") {
                    ...
                    if (id !== null && id !== "") {
                        get_tangquabanbe_gift_details(id);
                    }
        ...
        function get_tangquabanbe_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mu/cms/tooltangquabanbe/get_tangquabanbe_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tangquabanbe_mu&module=all&func=edit_tangquabanbe_gift" method="POST" enctype="multipart/form-data">
