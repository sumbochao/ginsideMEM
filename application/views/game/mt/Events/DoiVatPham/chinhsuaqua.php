...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mathan/cms/tooldoivatpham/tournament_list",
        ...
        function get_doivatpham_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mathan/cms/tooldoivatpham/get_doivatpham_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
                        ...
                        $("#gold_consumption").val(data[0]["gold_consumption"]);
                        $("#times_per_day").val(data[0]["times_per_day"]);
                        $("#gem_consumption").val(data[0]["gem_consumption"]);
                    }                   
                },
                error: function (data) {
                    var obj = $.parseJSON(data);
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/mt/Events/DoiVatPham/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=doivatpham_mt&module=all&func=edit_doivatpham_gift" method="POST" enctype="multipart/form-data">
                        <div class="widget row-fluid">
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Số Vàng để đổi:</label>
                                    <div class="controls">
                                        <input name="gold_consumption" id="gold_consumption" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label class="control-label">Số Ngọc để đổi:</label>
                                    <div class="controls">
                                        <input name="gem_consumption" id="gem_consumption" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                    </div>
                                </div>
                                
                                <div class="control-group">
                                    <label class="control-label">Số lần đổi trong 1 ngày:</label>
                                    <div class="controls">
                                        <input name="times_per_day" id="times_per_day" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                    </div>
                                </div>
