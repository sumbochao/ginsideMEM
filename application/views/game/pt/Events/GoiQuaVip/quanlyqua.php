    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=event_goi_qua_vip&func=themqua#quanlyqua';
            });
        });
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function(data){
                                    ...
                                    json.forEach(function(entry) {
                                        items = items + entry.item_name + ' * ' + entry.count + '<br>';
                                    });
                                    return items;
                                }
                            },
                            ...
                            },
                            {
                                ...
                                mRender: function (data, arg1, arg2) {
                                    return "<a class='btn btn-success btn-xs' href=' /?control=event_goi_qua_vip&func=themqua&id=" + data + "&name="+arg2.name+"&items="+arg2.items + "&money="+arg2.money + "&vip="+arg2.vip + "#quanlyqua '>Chỉnh Sửa</a>";
                                }
