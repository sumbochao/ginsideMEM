...
function check_button(){
	 ...
	 function actionAjax(id,mebutton,mechat,megame,meevent,melogin,megm,_linktext,_mess,status,state){
        ...
        $.ajax({
            ...
            type:"POST",
            data:{service_id:service_id,id:id,mebutton:me_b,mechat:me_c,megame:me_g,meevent:me_e,melogin:me_l,megm:me_gm,linktext:_lnk,mess:_msg,status:status,state:_state},
            async:false,
            dataType:"json",
            beforeSend:function(){
