...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=khongdoitroichung_mt&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=khongdoitroichung_mt&module=all&func=giaidau#giaidau";
        });
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=khongdoitroichung_mt&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT KHÔNG ĐỘI TRỜI CHUNG</h4>   
<!-- Nav tabs -->
