    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=lol_event_goi_qua_vip&&module=all&func=themgoiqua&tournament_id=' + $("#tournament").val() + '#quanlygoiqua';
            });
            
             $("#tournament").change(function () {             
                window.location.href = "/?control=lol_event_goi_qua_vip&module=all&func=quanlygoiqua&tournament_id=" + $(this).val() + "#quanlygoiqua";
            });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a class='btn btn-success btn-xs' href='/?control=lol_event_goi_qua_vip&module=all&func=chinhsuagoiqua&tournament_id=" + $("#tournament").val() + "&id=" + data + "#quanlygoiqua'>Chỉnh Sửa</a>"
                                    + " <a class='btn btn-success btn-xs' href='/?control=lol_event_goi_qua_vip&module=all&func=quanlyqua&tournament_id=" + $("#tournament").val() + "&id=" + data + "#quanlyqua'>Quản Lý Quà</a>";
                                }
