    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=duatopdautruong_mt&module=all&func=themgiaidau#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/mathan/cms/toolduatopdautruong/edit_tournament_details",
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mathan/cms/toolduatopdautruong/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="control-group">
                            <label class="control-label">Bắt đầu nhận quà:</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <label class="control-label">Kết thúc nhận quà:</label>
                            <div class="controls">
