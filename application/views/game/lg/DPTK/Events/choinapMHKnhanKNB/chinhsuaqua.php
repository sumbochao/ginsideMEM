...
//set_create_DPTK
        ...
        function get_doivatpham_gift_details(id) {
            $.ajax({
                method: "GET",
                dataType: 'jsonp',
                url: "https://sev-dptk.addgold.net/ToolchoinapMHKnhanKNB/get_doivatpham_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
                        ...
                        var set_create_DPTK = null;
                        if (data[0]["set_create_DPTK"] != "" && data[0]["set_create_DPTK"] != null) {
                            set_create_DPTK = new Date(data[0]["set_create_DPTK"]);
                        }
                        ...
                        $("#set_create_DPTK").jqxDateTimeInput('setDate', set_create_DPTK);
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=choinapmhknhanknb_dptk&module=all&func=edit_doivatpham_gift" method="POST" enctype="multipart/form-data">
                        <div class="widget row-fluid">
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Điều kiện - Thời gian tạo nhân vật trong game DPTK:</label>
                                    <div class="controls">
                                        <div id="set_create_DPTK" name="set_create_DPTK"></div>
                                    </div>
                                </div>
