    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                window.location.href = '/?control=refun_mu&func=excel_level&module=all&start=<?php echo $startHistory;?>&end=<?php echo $endHistory;?>';
            });
        });

        function getData() {
            $.ajax({
                url: "<?php echo $url_service; ?>/cms/refun/history_level?start=<?php echo $startHistory;?>&end=<?php echo $endHistory;?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                                ...
                                },
                               {
                                ...
                                },
                                {
                                    ...
                                    mRender: function (data) {
                                        return "<a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=refun_mu&func=delete&view=history_level&module=all&id=" + data + "'>Xóa</a>";
                                    }
                                }
                        ],
                        bProcessing: true,
