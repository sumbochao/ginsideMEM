...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=ifish_iwin&func=index#home";
        });        

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=ifish_iwin&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT IWIN</h4>   
<!-- Nav tabs -->
