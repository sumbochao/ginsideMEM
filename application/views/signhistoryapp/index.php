...
<div id="content-t" style="min-height:500px; padding-top:10px">
    ...
    <table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            <thead>
                <tr>
                    ...
                    <th align="center" width="150px">BunldeID</th>
    ...
    ?>
    <div class="unsuccess_signios">Signios thất bại <a href="<?php echo base_url().'?control=signhistoryapp&func=add';?>">Làm lại</a>
	<br />
    	<?php if(isset($_GET['info'])){ echo base64_decode($_GET['info']); } ?>
	</div>
    <?php
        }
    ?>
