...
<link rel="stylesheet" type="text/css" href="/events/game_mu_support_old_user/multi-select.css">
...
<script type="text/javascript" src="/events/game_mu_support_old_user/jquery.multi-select.js"></script>
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=support_old_user_mu&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=support_old_user_mu&module=all&func=giaidau#giaidau";
        });
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=support_old_user_mu&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=support_old_user_mu&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT HỖ TRỢ USER CŨ</h4>   
<!-- Nav tabs -->
