...
<table class="table1">
    ...
    <tr class="cls_l">
        ...
        <td colspan="4"><input type="text" name="link" id="link" style="width:500px;" maxlength="125" readonly="readonly" value="<?php echo $_POST['link'] ?>" placeholder="Nhập Link" /></td>
    </tr>
    <tr class="cls_l">
    	<td class="td_mobile">Message:</td>
        <td colspan="4"><input type="text" name="message" id="message" style="width:500px;" maxlength="125" readonly="readonly" value="<?php echo $_POST['message'] ?>" placeholder="Nhập Message" /></td>
    </tr>
</table>
</div>
...
function check_button(){
	 ...
	 function actionAjax(id,mebutton,mechat,megame,meevent,melogin,megm,linktext,mess){
        ...
        $.ajax({
            ...
            type:"POST",
            data:{id:id,mebutton:me_b,mechat:me_c,megame:me_g,meevent:me_e,melogin:me_l,megm:me_gm,linktext:_lnk,mess:_msg},
            async:false,
            dataType:"json",
            beforeSend:function(){
