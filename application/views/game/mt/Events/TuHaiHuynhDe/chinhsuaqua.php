...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#frmSendChest').ajaxForm(function (data) {
                ...
                if (data.result != "-1") {
                    ...
                    if (id !== null && id !== "") {
                        get_tuhaihuynhde_gift_details(id);
                    }
        ...
        function get_tuhaihuynhde_gift_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mathan/cms/tooltuhaihuynhde/get_tuhaihuynhde_gift_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    console.log(data);
                    //Load Reward Details  
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tuhaihuynhde_mt&module=all&func=edit_tuhaihuynhde_gift" method="POST" enctype="multipart/form-data">
