...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=naplandau_mt&module=all&func=index#home";
        });

        $('#sukien').on('click', function (e) {
            window.location.href = "/?control=naplandau_mt&module=all&func=sukien#sukien";
        });
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=naplandau_mt&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=naplandau_mt&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐUA TOP ĐẤU TRƯỜNG</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="sukien" href="#sukien" aria-controls="sukien" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
