                    ...
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        ...
                        <div class="input_fields_wrap">
                            <div class="control-group">
                                <label class="control-label">Change Times:</label>
                                <div class="controls">
                                    <input name="change_times" id="change_times" type="text" value="<?php echo $change_times;?>" class="span3  validate[required,custom[onlyNumberSp]]" />
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label">Quota:</label>
                                <div class="controls">
                                    <input name="quota" id="quota" type="text" value="<?php echo $quota;?>" class="span3  validate[custom[onlyNumberSp]]" />
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label">Currency:</label>
                                <div class="controls">
                                    <input name="currency" id="currency" type="text" value="<?php echo $currency;?>" class="span3  validate[custom[onlyNumberSp]]" />
                                </div>
                            </div>
