    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#game_filter").change(function () {
                window.location.href = "/?control=managercontributor&func=managesalary&view=approvalsalary&game_id=" + $("#game_filter").val() + "#duyetluong";
            });
...
//                url: "http://mem.net.vn/cms/toolsalarycollaborator/games_list",
        ...
        function getData(game_id) {
            $.ajax({
                url: "http://mem.net.vn/cms/toolsalarycollaborator/get_approval_history?game_id="+ game_id +"&gamelistId=" +$gamelistId,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
...
<?php if ((@in_array('managercontributor-managesalary-approvalsalary', $_SESSION['permission']) && $_SESSION['account']['id_group'] == 2) || $_SESSION['account']['id_group'] == 1): ?>
                                        button += "<a class='btn btn-success btn-xs' href='/?control=managercontributor&func=managesalary&view=approvalsalary&id=" + data + "#duyetluong'>Duyệt chi tiết</a>";
<?php endif; ?>
                                    return button;
