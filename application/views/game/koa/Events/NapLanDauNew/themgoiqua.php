    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=naplandau_new_koa&func=quanlygoiqua?type=' + type;
                }
                else {
                    window.location.href = '/?control=naplandau_new_koa&func=quanlygoiqua';
                }
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=naplandau_new_koa&func=add_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
