...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=giaidau&module=all#giaidau";
        });        

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=quanlyqua&module=all#quanlyqua";
        });
        
         $('#quanlygoiqua').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=quanlygoiqua&module=all#quanlygoiqua";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_koa&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT SHOP KIM BÀI</h4>   
<!-- Nav tabs -->
