...
//                window.location.href = '/?control=choinapmhknhanknb_dptk&module=all&func=themqua&tournament_id=' + $("#tournament").val() + '&pakage_id=' + $("#vip_gift_pakage").val() + '#quanlyqua';
//            });

            $("#tournament").change(function () {
                window.location.href = "/?control=choinapmhknhanknb_dptk&module=all&func=quanlyqua&tournament_id=" + $("#tournament").val() + "#quanlyqua";
            });
        ...
        function getData(tournament_id) {
            $.ajax({
                url: "https://sev-dptk.addgold.net/ToolchoinapMHKnhanKNB/get_doivatpham_gift?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                ...
                success: function (data, textStatus, jqXHR) {
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            {
                                sTitle: "Date Start ĐPTK",
                                mData: "set_create_DPTK"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                mRender: function (data) {
                                    return "<a class='btn btn-success btn-xs' href='/?control=choinapmhknhanknb_dptk&module=all&func=chinhsuaqua&tournament_id=" + $("#tournament").val() + "&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                }
                            }
