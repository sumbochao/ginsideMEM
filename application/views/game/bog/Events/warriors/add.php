        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/warriors/<?php echo $_GET['id']>0?'edit?id='.$_GET['id']:'add';?>",
                        ...
                        <div class="well form-horizontal">
                            ...
                            <?php
                                ...
                                if($_GET['id']>0){
                                    ...
                                    if(!empty($items['FirstLoginDate'])){
                                        $FirstLoginDatec = DateTime::createFromFormat('Y-m-d G:i:s',trim($items['FirstLoginDate']));
                                        $FirstLoginDate = $FirstLoginDatec->format('d-m-Y G:i:s');
                                    }
                                    if(!empty($items['LastLoginDateStart'])){
                                        $LastLoginDateStartc = DateTime::createFromFormat('Y-m-d G:i:s',trim($items['LastLoginDateStart']));
                                        $LastLoginDateStart = $LastLoginDateStartc->format('d-m-Y G:i:s');
                                    }
                                    if(!empty($items['LastLoginDateEnd'])){
                                        $LastLoginDateEndc = DateTime::createFromFormat('Y-m-d G:i:s',trim($items['LastLoginDateEnd']));
                                        $LastLoginDateEnd = $LastLoginDateEndc->format('d-m-Y G:i:s');
                                    }
                                }
                            ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="nameitem" id="nameitem" value="<?php echo $items['name'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Điều kiện:</label>
                                <div class="controls">
                                    <textarea name="condition" class="span3 validate[required]" style="width:70%; height: 100px"><?php echo $items['condition'];?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="server_ids" id="server_ids" value="<?php echo $items['server_ids'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">First login:</label>
                                <div class="controls">
                                    <input type="text" class="datetime" name="FirstLoginDate" value="<?php echo $FirstLoginDate;?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Last login:</label>
                                <div class="controls">
                                    <input type="text" class="datetime" name="LastLoginDateStart" value="<?php echo $LastLoginDateStart;?>"/>
                                </div>
                            </div>
                                <div class="control-group" style="display:none">
                                <label class="control-label">Last login End:</label>
                                <div class="controls">
                                    <input type="text" class="datetime" name="LastLoginDateEnd" value="<?php echo $LastLoginDateEnd;?>"/>
                                </div>
                            </div>
