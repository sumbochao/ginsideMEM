...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=trianbanghuu&module=all&func=index#home";
        });

        $('#sukien').on('click', function (e) {
            window.location.href = "/?control=trianbanghuu&module=all&func=sukien#sukien";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=trianbanghuu&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT TRI ÂN BẰNG HỮU</h4>   
<!-- Nav tabs -->
