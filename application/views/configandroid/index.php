...
<div id="content-t" style="min-height:500px; padding-top:10px">
    <form id="appForm" action="" method="post" name="appForm">
        ...
        <div class="filter">
            <input type="text" name="keyword" id="keyword" value="<?php echo $arrFilter['keyword'];?>" class="textinput" placeholder="Nhập từ khóa ..." title="Nhập từ khóa ..."/>
            <?php 
        ...
        <table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            <thead>
                <tr>
                    ...
                    <th align="center">Holder</th>
                    <th align="center">KeyStore</th>
                    <th align="center" width="600px">StorePass</th>
                 	 <th align="center" width="200px">Alias</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $lblPartner[$v['id_partner']]['partner'];?></td>
                    <td style="text-align:left"><?php echo $v['keystore'];?></td>
                    <td><?php echo $v['storepass'];?></td>
                    ...
                    <td>
                        <?php
                            ...
                            $btnDelete ='
                                <a onclick="if(!window.confirm(\'Bạn có muốn xóa '.$v['keystore'].' này không ?\')) return false;" href="'.base_url()."?control=".$_GET['control']."&func=delete&id=".$v['id'].'" title="Xóa">
                    ...
                    <td><?php echo $lblUser[$v['userlog']]['username'];?></td>
                </tr>
                <?php
                        }
                    }else{
