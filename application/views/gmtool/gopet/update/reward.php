                    ...
                    <form id="frmSendChest" action="" method="POST" enctype="multipart/form-data" onsubmit="return false;" autocomplete="off">
						...
						<div class="control-group col-xs-12 clearfix">
							<div class="control-group col-md-3">
								...
								<div class="controls">
									<input type="text" id="name" name="name" value="" class="span3 validate[required]" />
								</div>
							</div>
						</div>	
						<div class="control-group col-xs-12 clearfix">
							<div class="control-group col-md-6">
								...
								<div class="controls">
									<textarea id="jsonreward" name="jsonreward" class="span6 validate[required]" cols="20" rows="10" ></textarea>
								</div>
							</div>
						</div>
