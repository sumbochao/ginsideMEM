...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=gmtoolgopet&func=updateopri_all";
        });

        $('#updateresult').on('click', function (e) {
            window.location.href = "/?control=gmtoolgopet&func=updateopri_itemid";
        });
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php  echo $_GET['func']=='updateopri_all'?'active':'';?>" ><a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">UPDATE ALL</a></li>
    <li role="presentation" class="<?php  echo $_GET['func']=='updateopri_itemid'?'active':'';?>" ><a id="updateresult" href="#" aria-controls="giaidau" role="tab" data-toggle="tab">UPDATE BY ITEMS</a></li>
