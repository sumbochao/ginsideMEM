...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=thangcap_koa&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=thangcap_koa&func=giaidau&module=all#giaidau";
        });        
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=thangcap_koa&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
