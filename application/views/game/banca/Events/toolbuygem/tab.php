...
<script>
    ...
    $(function () {        
        ...
        $('#item').on('click', function (e) {
            window.location.href = "?control=banca_buygem&func=index&view=item&module=all";
        });
		$('#history').on('click', function (e) {
            window.location.href = "?control=banca_buygem&func=history&module=all";
        });
		$('#historygroup').on('click', function (e) {
            window.location.href = "?control=banca_buygem&func=historygroup&module=all";
        });
