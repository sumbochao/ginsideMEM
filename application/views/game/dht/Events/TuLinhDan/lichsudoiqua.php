    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=tulinhdan_dht&module=all&func=lichsudoiqua&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#lichsudoiqua";
            });

            $('#export_excel').on('click', function () {
                window.location.href = "http://game.mobo.vn/onepiece/cms/tooltulinhdan/get_exchange_history_shop_excel?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
            }); 
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/get_exchange_history_shop?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
