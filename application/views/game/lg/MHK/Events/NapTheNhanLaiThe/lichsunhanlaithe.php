    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=napthe_nhanlaithe_mhk&func=lichsunhanlaithe&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&module=all#lichsunhanlaithe";
            });
        ...
        function getData() {
            $("#loading_img").show();
            $.ajax({
                url: "https://mong.langgame.net/cms/toolnapthenhanlaithe/get_card_return_history?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val(),
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
