<?php
class MeAPI_Controller_BANCA_Events_BuygemController implements MeAPI_Controller_BANCA_Events_BuygemInterface {
    protected $_response;
    private $CI;
    public $url;
	...
	public function index(MeAPI_RequestInterface $request){
        ...
        switch ($_GET['view']){
            case 'config':
                ...
                $this->CI->template->write_view('content', 'game/banca/Events/toolbuygem/config/index', $this->data);
                break;
            case 'item':
                $this->data['title'] = 'QUẢN LÝ ITEM';
                $this->CI->template->write_view('content', 'game/banca/Events/toolbuygem/item/index', $this->data);
                break;
        } 
	...
	public function add(MeAPI_RequestInterface $request) {
        ...
        switch ($_GET['view']){
            case 'config':
                ...
                $this->CI->template->write_view('content', 'game/banca/Events/toolbuygem/config/add', $this->data);
                break;
            case 'item':
                $this->data['title'] = 'THÊM ITEM';
                $this->CI->template->write_view('content', 'game/banca/Events/toolbuygem/item/add', $this->data);
                break;
        }
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
