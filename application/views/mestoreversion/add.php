            ...
            <div class="group_left">
                ...
                <div class="rows">	
                    ...
                    <select name="cbo_app" id="cbo_app" onchange="gettext();">
                            ...
                            ?>
                            <option value="<?php echo $v['service_id'].'-'.$v['type'];?>" <?php echo (isset($_GET['service_id']) && ($_GET['service_id']==$v['service_id'])) || ($_POST['cbo_app']==$v['service_id'])?"selected":"" ?> ><?php echo $v['app_fullname'];?></option>
                            <?php
                                    }
                                }
                            ?>
