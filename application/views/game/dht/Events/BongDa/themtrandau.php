    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_bongda_dht&func=add_match&module=all" method="POST" enctype="multipart/form-data">
                    <div class="widget row-fluid">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="match_team_hoa" id="match_team_hoa" type="text" class="span3 validate[required,custom[number]]" />
                                </div>
                            </div>
