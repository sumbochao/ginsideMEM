    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=dualvl30_3q&func=themqua&tournament_id=' + $("#tournament").val() + "&module=all#quanlyqua";
            });
            ...
            $("#tournament").change(function () {
                window.location.href = "/?control=dualvl30_3q&func=quanlyqua&tournament_id=" + $(this).val() + "&module=all#quanlyqua";
            });
        });

        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/tooldualvl30/gift_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                ...
                success: function (data, textStatus, jqXHR) {
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            {
                                sTitle: "Số lượng gói quà",
                                mData: "gift_quantity_send"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a href='/?control=dualvl30_3q&func=chinhsuaqua&id=" + data + "&tournament_id=" + $("#tournament").val() + "&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                }
