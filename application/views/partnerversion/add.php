        ...
        <div id="adminfieldset" class="groupsignios">
            ...
            <div class="group_left">
            	<div class="rows">	
                    ...
                    <input type="text" name="txt_msv" id="txt_msv" class="textinput" value="" maxlength="10" onkeypress="return isNumber(event);" onkeydown="return isNumber(event);" />
                ...
                <div class="rows">	
                    ...
                    <select name="cbo_app" id="cbo_app" onchange="gettext();">
                            ...
                            ?>
                            <option value="<?php echo $v['service_id'];?>" <?php echo (isset($_GET['service_id']) && $_GET['service_id']==$v['service_id'])?"selected":"" ?> ><?php echo $v['app_fullname'];?></option>
                            <?php
                                    }
                                }
                            ?>
        ...
        <div id="adminfieldset" class="groupsignios space">
            ...
            <div class="group_left">
                ...
                <div class="rows">	
                    ...
                    <textarea name="notes" maxlength="1000" id="notes" cols="30" rows="5" style="width:500px;height:150px;resize:none;"></textarea>
