...
<div id="content-t" style="min-height:500px; padding-top:10px">
    ...
    <script type="text/javascript">
        ...
        function getData() {
            $.ajax({
                url: "http://game.mobo.vn/tieuhiep/cms/toolcacuoc/tournament_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_covu&func=chinhsuagiaidau&id=" + data + "#giaidau'>Chỉnh Sửa</a>";
                                    }
