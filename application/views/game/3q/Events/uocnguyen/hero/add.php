                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="itemid" id="itemid" value="<?php echo $items['itemid'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label">Hình URL:</label>
                            <div class="controls">
                                <input name="imgurl" id="imgurl" value="<?php echo $items['imgurl'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Hình Item:</label>
                            <div class="controls">
                                <input name="imgitem" id="imgitem" value="<?php echo $items['imgitem'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
