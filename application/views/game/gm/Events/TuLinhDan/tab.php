...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=giaithuong#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=giaithuongtop#giaithuongtop";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=lichsu#lichsu";
        });
        
        $('#lichsutop').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_gm&func=lichsutop#lichsutop";
        });
    });
</script>
<style>
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="lichsutop" href="#lichsutop" aria-controls="lichsutop" role="tab" data-toggle="tab">LỊCH SỬ NHẬN QUÀ TOP</a></li>
  </ul>
