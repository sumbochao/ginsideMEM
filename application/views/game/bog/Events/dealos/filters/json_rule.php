    ...
    <div id="addScnt" class="btn btn-success">Thêm rule</div>
        ...
        <div class="item_rule" id="item_rule_<?php echo $i;?>">
            ...
            <div class="rows">
                ...
                <div class="input">
                    <select name="device">
                        <option value="wp" <?php echo $vrule['device']=='wp'?'selected="selected"':'';?>>Window phone</option>
                        <option value="android" <?php echo $vrule['device']=='android'?'selected="selected"':'';?>>Android</option>
                        <option value="ios" <?php echo $vrule['device']=='ios'?'selected="selected"':'';?>>IOS</option>
                    </select>
                </div>
            </div>
            <div class="rows">
   ...
   $(function() {
        ...
        $('#addScnt').live('click', function() {
            ...
            var html = '<div class="item_rule">';
                ...
                html +='</div>';
                html +='<div class="rows">';
                    html +='<div class="title">Thiết bị:</div>';
                    html +='<div class="input"><select name="device"><option value="wp">Window phone</option><option value="android">Android</option><option value="ios">IOS</option></select></div>';
                html +='</div>';
                html +='<div class="rows">';
