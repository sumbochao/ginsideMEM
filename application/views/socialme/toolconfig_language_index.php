...
<form action="" method="post" name="frmindex">
    <div class="rows">
        ...
        <a href="/?control=socialme&func=language" class="game-button">THÊM GAME</a>
        <?php echo $error; ?>
    </div>
<table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover">
 <!--<table width="100%" border="0" class="table table-hover table-striped table-vcenter">-->
	...
	?>
        ...
        <?php
            $edit = "<a href='".base_url()."?control=socialme&func=language&id=".$val['id']."'><img src='".base_url()."assets/img/icon/icon_edit.png'></a>";
        ?>
        <tr>
