...
class MeAPI_Controller_Events_OnlineNhanQuaController implements MeAPI_Controller_Events_OnlineNhanQuaInterface {
    ...
    public function __construct() {
        ...
        $this->url_process = "http://game.mobo.vn/bog/cms/tool_$control/";
    ...
    public function index(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'events/OnlineNhanQua/index', $this->data);
    ...
    public function showAddConfig(MeAPI_RequestInterface $request) {
        ...
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'events/OnlineNhanQua/addConfig', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function quanlyqua(MeAPI_RequestInterface $request) {
        ...
        $this->data['game'] = $game ;
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'events/OnlineNhanQua/quanlyqua', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function themqua(MeAPI_RequestInterface $request) {
        ...
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'events/OnlineNhanQua/themqua', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function lichsu(MeAPI_RequestInterface $request){
        ...
        $this->data['game'] = $game;
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'events/OnlineNhanQua/lichsu', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
