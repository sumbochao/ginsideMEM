...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                    window.location.href = '/?control=shopkimbai_hero&func=quanlygoiqua&type=' + type + "&module=all#quanlygoiqua";
                }
                else {
                    window.location.href = '/?control=shopkimbai_hero&func=quanlygoiqua&module=all#quanlygoiqua';
                }
            });
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/hero/cms/toolshopkimbai/gift_type_list_pakage",
        ...
        function load_gift_pakage_details(id){
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/hero/cms/toolshopkimbai/load_gift_pakage_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#id").val(data[0]["id"]);
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/hero/Events/ShopKimBai/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=shopkimbai_hero&func=edit_gift_pakage&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">  
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="reward_item1_code" id="reward_item1_code" type="text" class="span3 validate[required]" /> 
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="reward_item2_code" id="reward_item2_code" type="text" class="span3 validate[required]" /> 
                       ...
                       <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="reward_item3_code" id="reward_item3_code" type="text" class="span3 validate[required]" /> 
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="reward_item4_code" id="reward_item4_code" type="text" class="span3 validate[required]" /> 
                        ...
                        <div class="control-group frmedit">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ID <input name="reward_item5_code" id="reward_item5_code" type="text" class="span3 validate[required]" /> 
