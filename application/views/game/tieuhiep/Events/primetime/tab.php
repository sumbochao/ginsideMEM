...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_napgiovang&func=config&module=all#home";
        });
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_napgiovang&func=history&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT KHUYẾN MÃI NẠP GIỜ VÀNG</h4>   
<!-- Nav tabs -->
