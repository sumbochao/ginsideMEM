...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mt&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mt&func=giaidau&module=all#giaidau";
        });  
        
        $('#nhanvatthamgia').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mt&func=nhanvatthamgia&module=all#nhanvatthamgia";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mt&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT TRI ÂN VIP</h4>   
<!-- Nav tabs -->
