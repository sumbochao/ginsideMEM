    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=tank_event_goi_qua_vip&module=all&func=themgiaidau#giaidau';
            });
        });
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=tank_event_goi_qua_vip&module=all&func=chinhsuagiaidau&id=" + data + "#giaidau'>Chỉnh Sửa</a>";
                                    }
