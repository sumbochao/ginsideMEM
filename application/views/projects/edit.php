                ...
                <div id="adminfieldset" class="groupsignios">
                    ...
                    <div class="group_left">
                        ...
                        <div class="rows">
                            ...
                            (logout sdk thành công thì sẽ hiển thị form login của sdk)
                        </div>
                        <div class="rows">
                        ...
                        <div class="rows">	
                            <label for="menu_group_id">Source Type (MDK)</label>
                            <input type="text" name="source_type" id="source_type" class="textinput" value="<?php echo $getitem['source_type'] ?>"/>             
                        </div>
                    </div> <!--group_left-->
                </div> <!--groupsignios-->
...
<?php } else {
    echo "*****************";
                ...
                <div id="adminfieldset" class="groupsignios">
                    ...
                    <div class="group_left">
                        <div class="rows">	
                            <label for="menu_group_id">Pixel App</label>
                            <input type="text" name="pixel_app" id="pixel_app" class="textinput" value="<?php echo $getitem['pixel_app'] ?>" />             
                        </div>
                        <div class="rows">	
                            <label for="menu_group_id">Pixel Key</label>
                            <input type="text" name="pixel_key" id="pixel_key" class="textinput" value="<?php echo $getitem['pixel_key'] ?>" />             
                        </div>
                        <div class="rows">	
                        ...
                        <div class="rows" style="display:none">	
                            <label for="menu_group_id">TuneAdvertiserId</label>
                            <input type="text" name="tune" id="tune" class="textinput" value="<?php echo $getitem['tune'] ?>" style="width:415px;" />
                            <select name="tune_status" id="tune_status" style="width:80px;">
                                <option value="1" <?php echo $getitem['tune_status'] == "1" ? "selected" : ""; ?>>On</option>
                                <option value="0" <?php echo $getitem['tune_status'] == "0" ? "selected" : ""; ?>>Off</option>
                            </select>         
                        </div>
                        <div class="rows" style="display:none">	
                            <label for="menu_group_id">TuneConversionKey</label>
                            <input type="text" name="TuneConversionKey" id="TuneConversionKey" class="textinput" value="<?php echo $getitem['tuneconversionkey'] ?>" />             
                        </div>
                        <div class="rows" style="display:none">	
                            <label for="menu_group_id">TunePackageName</label>
                            <input type="text" name="TunePackageName" id="TunePackageName" class="textinput" value="<?php echo $getitem['tunepackagename'] ?>" />             
                        </div>
                        <div class="rows" style="padding-top:20px;padding-bottom:20px;display:none">	
...
?>
                ...
                <div id="adminfieldset" class="groupsignios">
                    <div class="adminheader">Tạo link</div>
                    <div class="group_left">
                        <div class="rows">	
                            <label for="menu_group_id">Android</label>
                            <input type="text" name="link_android" id="link_android" class="textinput" value="<?php echo $getitem['link_android'] ?>" />             
                        </div>
                    </div>
                    <div class="group_left">
                        <div class="rows">	
                            <label for="menu_group_id">IOS</label>
                            <input type="text" name="link_ios" id="link_ios" class="textinput" value="<?php echo $getitem['link_ios'] ?>" />             
                        </div>
                    </div>
                    <div class="group_left">
                        <div class="rows">	
                            <label for="menu_group_id">WP</label>
                            <input type="text" name="link_wp" id="link_wp" class="textinput" value="<?php echo $getitem['link_wp'] ?>" />             
                        </div>
                    </div>
                </div>
                <div id="adminfieldset" class="groupsignios">
                    ...
                    <div class="group_left"> 
						...
						<div class="rows">	
                            <label for="menu_group_id">One signal</label>
                            <input type="text" name="onesignal" id="onesignal" class="textinput" value="<?php echo $getitem['onesignal'] ?>" />             
                        </div>
                    </div> <!--group_left-->
                </div> <!--groupsignios-->
                <div id="adminfieldset" class="groupsignios">
                    <div class="adminheader">Review app (hiển thị duy nhất inapp với ip nước ngoài)</div>
                    <div class="group_left"> 
                        <div class="rows">	
                            <label for="menu_group_id">Tình trạng</label>
                            <select name="status_app">
                                <option value="">Chọn tình trạng</option>
                                <option value="on" <?php echo $getitem['status_app'] == 'on' ? 'selected="selected"' : ''; ?>>On</option>
                                <option value="off" <?php echo $getitem['status_app'] == 'off' ? 'selected="selected"' : ''; ?>>Off</option>
                            </select>
                        </div>
                    </div> <!--group_left-->
                </div> <!--groupsignios-->
                <div id="adminfieldset" class="groupsignios">
                    <div class="adminheader">CDN Client</div>
                    <div class="group_left"> 
                        <div class="rows">	
                            <label for="menu_group_id">URL Landing Page</label>
                            <input type="text" name="url_landing_page" id="url_landing_page" class="textinput" value="<?php echo $getitem['url_landing_page'] ?>" />
                        </div>
                        <div class="rows">	
                            <label for="menu_group_id">Color</label>
                            <input type="text" name="color" id="color" class="textinput" value="<?php echo $getitem['color'] ?>" />
                        </div>
                    </div> <!--group_left-->
                </div> <!--groupsignios-->
                <div id="adminfieldset" class="groupsignios">
    ...
    <div id="adminfieldset" class="groupsignios space" style="margin-left:0 !important;width:inherit !important;">
        <div class="adminheader"><a href="javascript:void(0);" id="pbottom">BundleID PackageName PackageIdentity</a></div>
            ...
            <div class="group_left" id="div_proper" style="margin-left:22px;">
                <input type="checkbox" name="chk_ios" id="chk_ios" value="" onchange="if (this.checked) {
                $('#step2').css('display', 'block');
            } else {
                $('#step2').css('display', 'none');
            }" />IOS
                <input type="checkbox" name="chk_android" id="chk_android" value="" onchange="if (this.checked) {
                $('#step3').css('display', 'block');
            } else {
                $('#step3').css('display', 'none');
            }"/>Android
                <input type="checkbox" name="chk_wp" id="chk_wp" value="" onchange="if (this.checked) {
...
<?php } ?>
            ...
            <div id="adminfieldset" class="groupsignios space" style="width:70% !important;margin-left:1% !important;">
                ...
                <div class="group_left" id="div_proper">
                    ...
                    <div class="rows" style="padding-top:20px;padding-bottom:20px;">	
                        ...
                        <input type="hidden" name="googleproductapi_ios" id="googleproductapi_ios" />
                        <div class="rows_child" style="padding-left:205px;">
                            <table>
                                <tr>
                                    <td>ReportWithConversionID</td>
                                    <td><input type="text" name="ReportWithConversionID_ios" id="ReportWithConversionID_ios" class="textinput" style="width:336px;" value="961978347"  /></td>
                                </tr>
                                <tr>
                                    <td>Label</td>
                                    <td><input type="text" name="label_ios" id="label_ios" class="textinput" style="width:336px;" value="nRTlCOCp0FwQ67_aygM"  /></td>
                                </tr>
                                <tr>
                                    <td>Value</td>
                                    <td><input type="text" name="value_ios" id="value_ios" class="textinput" style="width:336px;" value="0.00"  /></td>
                                </tr>
                                <tr>
                                    <td>IsRepeatable</td>
                                    <td><input type="text" name="isRepeatable_ios" id="isRepeatable_ios" class="textinput" style="width:336px;" value="NO"  /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
        ...
        <div id="step3" style="display:none;">
            <div id="adminfieldset" class="groupsignios space" style="width:70% !important;margin-left:1% !important;">
                ...
                <div class="group_left" id="div_proper">
                    ...
                    <!--Goodle Adwords-->
                    <div class="rows" style="padding-top:20px;padding-bottom:20px;">	
                        <label for="menu_group_id" style="width:330px;">Google AdWords Conversion Tracking Code Android</label>
                             <!--<textarea name="googleproductapi" id="googleproductapi" role="5" cols="30" style="height:150px;width:500px"></textarea>-->
                        <input type="hidden" name="googleproductapi_android" id="googleproductapi_android" />
                        <div class="rows_child" style="padding-left:205px;">
                            <table>
                                <tr>
                                    <td>ReportWithConversionID</td>
                                    <td><input type="text" name="ReportWithConversionID_android" id="ReportWithConversionID_android" class="textinput" style="width:336px;" value="961978347"  /></td>
                                </tr>
                                <tr>
                                    <td>Label</td>
                                    <td><input type="text" name="label_android" id="label_android" class="textinput" style="width:336px;" value="nRTlCOCp0FwQ67_aygM"  /></td>
                                </tr>
                                <tr>
                                    <td>Value</td>
                                    <td><input type="text" name="value_android" id="value_android" class="textinput" style="width:336px;" value="0.00"  /></td>
                                </tr>
                                <tr>
                                    <td>IsRepeatable</td>
                                    <td><input type="text" name="isRepeatable_android" id="isRepeatable_android" class="textinput" style="width:336px;" value="false"  /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="rows">	
                        <label for="menu_group_id">Link CDN client (downloader)</label>
                        <input type="text" name="link_cnd_client_android" id="link_cnd_client_android" class="textinput" />             
                    </div>
                    <!--endfacebook-->
                    <div class="rows">	
                        <label for="menu_group_id">Ghi chú</label>
        ...
        <div id="step4" style="display:none;">
            <div id="adminfieldset" class="groupsignios space" style="width:70% !important;margin-left:1% !important;">
                ...
                <div class="group_left" id="div_proper">
                    ...
                    <div class="rows">	
                        <label for="menu_group_id" id="label_package_name">Protocol</label>
                        <input type="text" name="protocol" id="protocol" class="textinput" value="" maxlength="200" />             
                    </div>
                    <div class="rows">	
                        <label for="menu_group_id" id="label_package_name">Package Name</label>
                    ...
                    <div class="rows">	
                        <label for="menu_group_id">App ID - 8.0</label>
                    ...
                    <div class="rows">	
                        <label for="menu_group_id">Store ID</label>
                        <input type="text" name="store_id" id="store_id" class="textinput" value="" maxlength="200" />
                    </div>
                    <div class="rows">	
                        <label for="menu_group_id">Parkage SID</label>
                        <input type="text" name="park_id" id="park_id" class="textinput" value="" maxlength="200" />
                    </div>
                    <div class="rows">	
                    ...
                    <!--Goodle Adwords-->
                    <div class="rows" style="padding-top:20px;padding-bottom:20px;">	
                        <label for="menu_group_id" style="width:330px;">Google AdWords Conversion Tracking Code WinPhone</label>
                             <!--<textarea name="googleproductapi" id="googleproductapi" role="5" cols="30" style="height:150px;width:500px"></textarea>-->
                        <input type="hidden" name="googleproductapi_wp" id="googleproductapi_wp" />
                        <div class="rows_child" style="padding-left:205px;">
                            <table>
                                <tr>
                                    <td>ReportWithConversionID</td>
                                    <td><input type="text" name="ReportWithConversionID_wp" id="ReportWithConversionID_wp" class="textinput" style="width:336px;" value="961978347"  /></td>
                                </tr>
                                <tr>
                                    <td>Label</td>
                                    <td><input type="text" name="label_wp" id="label_wp" class="textinput" style="width:336px;" value="nRTlCOCp0FwQ67_aygM"  /></td>
                                </tr>
                                <tr>
                                    <td>Value</td>
                                    <td><input type="text" name="value_wp" id="value_wp" class="textinput" style="width:336px;" value="0.00"  /></td>
                                </tr>
                                <tr>
                                    <td>IsRepeatable</td>
                                    <td><input type="text" name="isRepeatable_wp" id="isRepeatable_wp" class="textinput" style="width:336px;" value="false"  /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
		...
		<?php
			//echo "<pre>";print_r($_SESSION['permission']);die();
			if((@in_array($_GET['control'].'-'.$_GET['func'].'_save', $_SESSION['permission']) && $_SESSION['account']['id_group']==2) || $_SESSION['account']['id_group']==1){
		?>
...
<script type="text/javascript" language="javascript">
    ...
    function callfunc() {
        ...
        try {
            ...
            if (_wp) {
                ...
                // wp cho phep trung package Identity
    ...
    function addstep1() {
        ...
        var _tune = $('#tune').val();
        var _sourcetype = $('#source_type').val();
        var _tune_status = $('#tune_status').val();
        var _TuneConversionKey = $('#TuneConversionKey').val();
        var _TunePackageName = $('#TunePackageName').val();

        var _pixel_app = $('#pixel_app').val();
        var _pixel_key = $('#pixel_key').val();
        var _link_android = $('#link_android').val();
        var _link_ios = $('#link_ios').val();
        var _link_wp = $('#link_wp').val();
        ...
        var status_app = $("select[name=status_app]").val();
        var url_landing_page = $("input[name=url_landing_page]").val();
        ...
        if (folder == '') {
            alert('Không bỏ trống tên Folder !');
            $('#folder').focus();
            isok = false;
        }
        //add 
        if (isok) {
            $.ajax({
                ...
                type: "GET",
                data: {id:<?php echo $_GET['id']; ?>, code: _code, names: _names, namesetup: _namesetup, servicekeyapp: _servicekeyapp, servicekey: _servicekey, facebookapp: _facebookapp, facebookappid: _facebookappid, facebookappsecret: _facebookappsecret, itunesconnect: _itunesconnect, appleid: _appleid, gacode: _gacode, appsflyerid: _appsflyerid, googleproductapi: _googleproductapi, urlschemes: _urlschemes, facebookurlschemes: _facebookurlschemes, googlesenderid: _googlesenderid, googleapikey: _googleapikey,onesignal:_onesignal, facebookfanpagelink: _facebookfanpagelink, request_per: _request_per, accept_per: _accept_per, notes: notes, screens: screens, servicekey_second: servicekey_second, config_logout: config_logout, language_sdk: language_sdk, folder: folder, tune: _tune, sourcetype: _sourcetype, tune_status: _tune_status, TuneConversionKey: _TuneConversionKey, TunePackageName: _TunePackageName,link_android:_link_android,link_ios:_link_ios,link_wp:_link_wp, pixel_app: _pixel_app, pixel_key: _pixel_key, status_app: status_app,color:color,url_landing_page:url_landing_page},
                async: false,
                dataType: "json",
                beforeSend: function () {
                                ...
                                function addstep2new(_type) {
                                    switch (_type) {
                                        case 1:
                                            ...
                                            //ghep googleproductapi
                                            _gReportWithConversionID = $('#ReportWithConversionID_ios').val();
                                            _gLabel = $('#label_ios').val();
                                            _gValue = $('#value_ios').val();
                                            _gIsRepeatable = $('#isRepeatable_ios').val();
                                            _gGoogleProductApi = _gReportWithConversionID + ';' + _gLabel + ';' + _gValue + ';' + _gIsRepeatable;
                                            document.getElementById('googleproductapi_ios').value = _gGoogleProductApi;

                                            var _googleproductapi = $('#googleproductapi_ios').val();
                                            var _protocol = '';
                                            break;
                                        case 2:
                                            ...
                                            var _link_cnd_client = $('#link_cnd_client_android').val();

                                            //ghep googleproductapi
                                            _gReportWithConversionID = $('#ReportWithConversionID_android').val();
                                            _gLabel = $('#label_android').val();
                                            _gValue = $('#value_android').val();
                                            _gIsRepeatable = $('#isRepeatable_android').val();
                                            _gGoogleProductApi = _gReportWithConversionID + ';' + _gLabel + ';' + _gValue + ';' + _gIsRepeatable;
                                            document.getElementById('googleproductapi_android').value = _gGoogleProductApi;

                                            var _googleproductapi = $('#googleproductapi_android').val();
                                            var _protocol = '';
                                            break;
                                        case 3:
                                            ...
                                            //ghep googleproductapi
                                            _gReportWithConversionID = $('#ReportWithConversionID_wp').val();
                                            _gLabel = $('#label_wp').val();
                                            _gValue = $('#value_wp').val();
                                            _gIsRepeatable = $('#isRepeatable_wp').val();
                                            _gGoogleProductApi = _gReportWithConversionID + ';' + _gLabel + ';' + _gValue + ';' + _gIsRepeatable;
                                            document.getElementById('googleproductapi_wp').value = _gGoogleProductApi;

                                            var _googleproductapi = $('#googleproductapi_wp').val();
                                            var _protocol = $('#protocol').val();
                                            break;
                                    }
                                    //add 
                                    $.ajax({
