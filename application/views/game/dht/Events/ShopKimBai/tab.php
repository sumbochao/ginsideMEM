...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_dht&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_dht&func=giaidau&module=all#giaidau";
        });        

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_dht&func=quanlyqua&module=all#quanlyqua";
        });
        ...
        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_dht&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_dht&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
