...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=giaidau&module=all#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=trandau&module=all#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=quanlyqua&module=all#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=quanlycode&module=all#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=lichsu&module=all#lichsu";
        });
        
        $('#lichsudoiqua').on('click', function (e) {
            window.location.href = "/?control=event_bongda_bog&func=lichsudoiqua&module=all#lichsudoiqua";
        });
    });
</script>
<style>
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="trandau" href="#trandau" aria-controls="trandau" role="tab" data-toggle="tab">TRẬN ĐẤU</a></li>
    <li role="presentation"><a id="quanlyqua" href="#quanlyqua" aria-controls="quanlyqua" role="tab" data-toggle="tab">QUẢN LÝ QUÀ</a></li>
    <li role="presentation"><a id="quanlycode" href="#quanlycode" aria-controls="quanlycode" role="tab" data-toggle="tab">QUẢN LÝ CODE</a></li>
    <li role="presentation"><a id="thongke" href="#thongke" aria-controls="thongke" role="tab" data-toggle="tab">THỐNG KÊ</a></li>
    <li role="presentation"><a id="lichsu" href="#lichsu" aria-controls="lichsu" role="tab" data-toggle="tab">LỊCH SỬ THAM GIA</a></li>
