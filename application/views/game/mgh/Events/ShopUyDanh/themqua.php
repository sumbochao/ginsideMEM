    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=shopuydanh&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
						...
						<div class="control-group frmedit">
						  ...
						  <div class="controls">
							<select name="parent_id" class="span3">
                                <?php foreach($dsQua as $qua):?>
								<option <?php if($parent_id == $qua->id) {echo 'selected="selected"';}?> value="<?php echo $qua->id;?>"><?php echo $qua->name;?></option>
                                <?php endforeach?>
							  </select>
						  </div>
                        ...
                        <div id="items">
                            ...
                            <div class = "panel panel-default">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
										<input value="<?php echo $pack->image;?>" name="image[]" type="text" class="span3 validate[required]" />
									</div>
                                </div>
								 ...
								 <div class="control-group frmedit">
									...
									<div class="controls">
                                        <textarea class="form-control" rows="3" name="server_list[]"></textarea>
										Cách nhau dấu ','
                                    </div>
                                ...
                                <div class = "panel panel-default">
                                    <div class = "panel-body">
                                        ...
                                        <div class="control-group frmedit">
                                            <label class="control-label">Server List:</label>
                                            <div class="controls">
                                                <textarea class="form-control" rows="3" name="server_list[]"><?php echo $pack->server_list;?></textarea>
                                            </div>
