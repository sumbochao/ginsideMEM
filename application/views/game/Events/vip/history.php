    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                ...
                window.location.href = '/?control=vip&func=excel&game=<?php echo $_GET['game'];?>&module=<?php echo $_GET['module'];?>&start='+start+'&end='+end;
            });
        });
        function getData() {
            $.ajax({
                url: "<?php echo $url_service; ?>/cms/vip/history?game=<?php echo $_GET['game'];?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
