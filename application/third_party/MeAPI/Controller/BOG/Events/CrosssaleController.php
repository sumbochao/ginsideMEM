<?php
class MeAPI_Controller_BOG_Events_CrosssaleController implements MeAPI_Controller_BOG_Events_CrosssaleInterface {
    protected $_response;
    private $CI;
    private $url_service;
    ...
    public function history(MeAPI_RequestInterface $request){
        ...
        $this->CI->template->write_view('content', 'game/bog/Events/crosssale/history', $this->data);
