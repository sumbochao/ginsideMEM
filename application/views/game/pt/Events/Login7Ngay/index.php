...
<div id="content-t" style="min-height:500px; padding-top:10px">
    <style>
		...
		#data_table td {word-break:break-word;}
    </style>
                ...
                aoColumns: [
                    ...
                    },
                    {
                        ...
                        mRender: function (id, arg1, arg2) {
                            return "<a class='btn btn-success btn-xs' href=' /?control=event_login_7ngay&func=showAddConfig&module=all&id=" + id + "&name="+arg2.name + "&server_list="+arg2.server_list + "&status="+arg2.status + "&article_id="+arg2.article_id + "&date_start="+arg2.date_start + "&date_end="+arg2.date_end + "&is_tester="+arg2.is_tester + "&day_number="+arg2.day_number + "#home '>Chỉnh Sửa</a>";
                        }
            ...
            <div class="widget" id="viewport">
                ...
                <div class="table-overflow">     
                     <div style="margin-top: 10px; margin-bottom: 10px;">
                        <a href="/?control=event_login_7ngay&func=showAddConfig&module=all#addconfig" class="btn btn-primary"><span>THÊM MỚI</span></a>
                    </div>
