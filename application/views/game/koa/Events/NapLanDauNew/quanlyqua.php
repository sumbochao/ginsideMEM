...
<div id="content-t" style="min-height:500px; padding-top:10px">
    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=naplandau_new_koa&func=themqua&tournament_id=' + $("#tournament").val() +  "&required_id=" + $("#requirement").val() + "&module=all#quanlyqua" ;
            });
            
            //Load Tournament List
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/tournament_list",
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/requirement_list",
                contentType: 'application/json; charset=utf-8',
                success: function (data) {                  
                    var obj = data["rows"];
                    var tourlist = "";
            ...
            $("#tournament").change(function () {             
                window.location.href = "/?control=naplandau_new_koa&func=quanlyqua&tournament_id=" + $(this).val() + "&required_id=" + $("#requirement").val() + "&module=all#quanlyqua";
            });
            
            $("#requirement").change(function () {             
                window.location.href = "/?control=naplandau_new_koa&func=quanlyqua&tournament_id=" + $("#tournament").val() + "&required_id=" + $(this).val() + "&module=all#quanlyqua";
            });
        });
        
        function getData(tournament_id, required_id) {
            $.ajax({
                url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/gift_list?tournament_id=" + tournament_id + "&required_id=" + required_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },   
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=naplandau_new_koa&func=chinhsuaqua&id=" + data + "&tournament_id="+ $("#tournament").val() +"&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                    }
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">                     
            <?php include APPPATH . 'views/game/koa/Events/NapLanDauNew/tab.php'; ?>
