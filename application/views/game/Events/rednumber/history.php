    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                ...
                window.location.href = '/?control=rednumber&func=excel&module=all&game=<?php echo $_SESSION['account']['id_group']==2?$game_id:'';?>&start='+start+'&end='+end;
            });
        });
        function getData() {
            $.ajax({
                url: "<?php echo $url_service; ?>/cms/rednumber/history?game=<?php echo $_SESSION['account']['id_group']==2?$game_id:'';?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
