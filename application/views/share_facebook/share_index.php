        ...
        <script>
            $(document).ready(function() {
                $("#select_domain").change(function() {
                    ...
                    if (id != null) {
                        window.location.href = "http://ginside.mobo.vn/?control=sharefacebook&func=index&id=" + id;
                    }
                });
...
//                $("#select_domain").val(id);
                ...
                //?control=sharefacebook&func=edit
                //function
                $(".btnadd").click(function() {
                    var game = $("#select_domain").val();
                    
                    if (game != "0") {
                        window.location.href = "?control=sharefacebook&func=edit&domain=" + game;
                    }
                    else{
                ...
                if (!empty($data)) {
                    foreach ($data as $value) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>?control=<?php echo $_GET['control'] ?>&func=edit&id=<?php echo $value["id"] ?>&domain=<?php echo $_GET["id"] ?>" title="Sửa">
