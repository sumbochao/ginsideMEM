        ...
        function load_gift_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    dataType: 'jsonp',
                    url: "https://mong.langgame.net/cms/toolnapthenhanlaithe/load_gift_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#id").val(data[0]["id"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=napthe_nhanlaithe_mhk&func=edit_gift&module=all" method="POST" enctype="multipart/form-data">
