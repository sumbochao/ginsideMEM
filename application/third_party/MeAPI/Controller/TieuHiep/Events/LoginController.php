...
class MeAPI_Controller_TieuHiep_Events_LoginController implements MeAPI_Controller_TieuHiep_Events_LoginInterface {
    ...
    public function index(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'game/tieuhiep/Events/qualogin/'.$layout.'/index', $this->data);
    ...
    public function add(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'game/tieuhiep/Events/qualogin/'.$layout.'/add', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
	function delete(MeAPI_RequestInterface $request){
        ...
        header('location: /?control=qualogin&func=index&view='.$layout.'&module=all');
    }
	function deleteconfig(MeAPI_RequestInterface $request){
        ...
        $infoDetail = file_get_contents($linkinfo);
        $datainfojson = json_decode($infoDetail,true);
        header('location: /?control=qualogin&func=edit&view=wheel&module=all&ids='.$request->input_get('wheel') );
    }
    ...
    public function clearcached(MeAPI_RequestInterface $request) {
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/tieuhiep/Events/qualogin/clearcached', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }    
