...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=doiqua_3q&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=doiqua_3q&func=giaidau&module=all#giaidau";
        });        
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=doiqua_3q&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐỔI QUÀ LẤY QUÀ</h4>   
<!-- Nav tabs -->
