...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_top&func=index#home";
        });
		$('#chienluc').on('click', function (e) {
            window.location.href = "/?control=event_top&func=chienluc#chienluc";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ CẤU HÌNH SỰ KIỆN LẤY TOP</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation"><a id="chienluc" href="#chienluc" aria-controls="chienluc" role="tab" data-toggle="tab">TOP Chiến Lực</a></li>
  </ul>
