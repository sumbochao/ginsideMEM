 ...
 <!--<table width="100%" border="0" class="table table-hover table-striped table-vcenter">-->
	...
	<tr>
			...
			<td>
                <?php
                    $permission ='';
                    if($val['id_group']==2 || $val['id_group']==3){
                        $permission = '<a href="'.base_url().'?control='.$_GET['control'].'&func=permission&id='.$val['id'].'" title="Phân quyền"><img src="'.base_url().'assets/img/exclamation.gif"/></a>'.'&nbsp;&nbsp;&nbsp;&nbsp;';
                    }
                    echo $permission.$edit . '&nbsp;&nbsp;&nbsp;&nbsp;' .$sts . '&nbsp;&nbsp;&nbsp;&nbsp;' . $delete;
                ?>
            </td>
