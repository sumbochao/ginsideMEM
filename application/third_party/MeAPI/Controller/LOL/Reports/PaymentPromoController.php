<?php
class MeAPI_Controller_LOL_Reports_PaymentPromoController implements MeAPI_Controller_LOL_Reports_PaymentPromoInterface {
    protected $_response;
    private $CI;
    ...
    public function __construct() {
        ...
        $this->CI->load->MeAPI_Model('Game/LOL/PaymentPromoModel');
    ...
    public function index(MeAPI_RequestInterface $request) {
        ...
        $config['base_url'] = base_url() . '?control=payment_promo_lol&func=index&module=all';
        ...
        $slbServer = $this->CI->PaymentPromoModel->listServerByGame('128');
        $this->data['slbServer'] = $slbServer;

        $this->CI->template->write_view('content', 'game/lol/reports/index', $this->data);
