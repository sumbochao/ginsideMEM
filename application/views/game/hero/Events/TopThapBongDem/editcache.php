...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/hero/cms/tooltopthapbongdem/SP_EventConfig_EditEvent",
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/hero/cms/tooltopthapbongdem/SP_EventConfig_GetEventID",
        ...
        function load_cache_detail(server_id, eventid, week) {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/hero/cms/tooltopthapbongdem/SP_EventConfig_GetByID?server_id=" + server_id + "&eventid=" + eventid + "&week=" + week,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
