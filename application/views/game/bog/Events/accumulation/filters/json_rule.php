    ...
    <div class="input_fields_wrap">
        ...
        <div class="control-group listItem">
            <div class="group1">
                ...
                <div class="form-group listcheckbox">
                    <input type="checkbox" name="type_rule[<?php echo $i;?>][]" value="card" <?php echo (@in_array('card', $rule['type']))?'checked="checked"':'';?>/> Card
                    <input type="checkbox" name="type_rule[<?php echo $i;?>][]" value="bank" <?php echo (@in_array('bank', $rule['type']))?'checked="checked"':'';?>/> Bank
                    <input type="checkbox" name="type_rule[<?php echo $i;?>][]" value="inapp" <?php echo (@in_array('inapp', $rule['type']))?'checked="checked"':'';?>/> Inapp
                    <input type="checkbox" name="type_rule[<?php echo $i;?>][]" value="sms" <?php echo (@in_array('sms', $rule['type']))?'checked="checked"':'';?>/> Sms
                    <input type="checkbox" name="type_rule[<?php echo $i;?>][]" value="wallet" <?php echo (@in_array('wallet', $rule['type']))?'checked="checked"':'';?>/> Wallet
                </div>
            ...
            if(x < max_fields){ //max input box allowed
                ...
                xhtml += '<div class="control-group listItem">';
                    xhtml +='<div class="group1">';
                         ...
                         xhtml +='</div>';
                         xhtml +='<div class="form-group listcheckbox">';
                            xhtml +='<input type="checkbox" name="type_rule['+xsub+'][]" value="card"/> Card ';
                            xhtml +='<input type="checkbox" name="type_rule['+xsub+'][]" value="bank"/> Bank ';
                            xhtml +='<input type="checkbox" name="type_rule['+xsub+'][]" value="inapp"/> Inapp ';
                            xhtml +='<input type="checkbox" name="type_rule['+xsub+'][]" value="sms"/> Sms ';
                            xhtml +='<input type="checkbox" name="type_rule['+xsub+'][]" value="wallet"/> Wallet ';
                        xhtml +='</div>';
