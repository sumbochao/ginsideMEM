    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=shopkimbai_bog&func=themgoiqua&type=' + $("#gifttype").val() + "&module=all#quanlygoiqua";
            });
            ...
            $.ajax({
             ...
             $("#gifttype").change(function () {             
                window.location.href = "/?control=shopkimbai_bog&func=quanlygoiqua&type=" + $(this).val() + "&module=all#quanlygoiqua";
            });
        });
        
        function getData(type_id) {
            $.ajax({
                url: "http://game.mobo.vn/bog/cms/toolshopkimbai/gift_list_pakage?id=" + type_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },    
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=shopkimbai_bog&func=chinhsuagoiqua&id=" + data + "&type="+ $("#gifttype").val() +"&module=all#quanlygoiqua'>Chỉnh Sửa</a>";
                                    }
