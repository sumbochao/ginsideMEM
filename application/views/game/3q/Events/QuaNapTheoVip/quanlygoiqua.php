    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=quanaptheovip_3q&func=themgoiqua&type=' + $("#gifttype").val() + "&module=all#quanlygoiqua";
            });
            
            //Load Gift Type
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/3q/cms/toolquanaptheovip/gift_type_list_pakage",
             ...
             $("#gifttype").change(function () {             
                window.location.href = "/?control=quanaptheovip_3q&func=quanlygoiqua&type=" + $(this).val() + "&module=all#quanlygoiqua";
            });
        });
        
        function getData(type_id) {
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/toolquanaptheovip/gift_list_pakage?id=" + type_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },    
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=quanaptheovip_3q&func=chinhsuagoiqua&id=" + data + "&type="+ $("#gifttype").val() +"&module=all#quanlygoiqua'>Chỉnh Sửa</a>";
                                    }
