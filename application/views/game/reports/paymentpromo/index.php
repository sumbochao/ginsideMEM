...
<div id="content-t" style="min-height:500px; padding-top:10px">
    <form id="appForm" action="" method="post" name="appForm">
        <div class="filter">
            ...
            <input type="button" onclick="onSubmitFormAjax('appForm','<?php echo base_url().'?control=payment_promo&func=index&module=all&type=filter';?>')" value="Tìm" class="btn btn-primary"/>
        </div>
...
<script type="text/javascript">
    function getServerIndex(game){
        var url =baseUrl +'?control=payment_promo&func=getserver';
        jQuery.ajax({
            url:url,
            type:"POST",
            data:{game:game},
