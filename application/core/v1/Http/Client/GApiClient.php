...
class GApiClient extends Client implements ClientInterface {
     ...
     * @return array
     */
    public function getListPurchase(array $params) {

        $response = $this->getApi()->call(array("control" => "report", "func" => "get_list_purchase","is_sandbox"=>"coor_team"), "POST", $params);
        //Object response form request by class http Response
        $contents = $response->getContent();
		//return false;
        if (is_array($contents) === true) {
     ...
     * @throws \Exception
     */
    public function getUserInfo($service_name, $account_id, $server_id) {
