...
<div class="content_form" id="content-t">
    <form action="" method="post" name="frmadd">
        <div class="group_left">
            ...
            <div class="rows">
                <label for="menu_group_id">Mobo ID</label>
                <input type="number" name="mobo_id" value="<?php echo $Item['mobo_id'];?>" class="mobo_id textinput" placeholder="Mobo Id"/>
                <?php echo $errors['mobo_id'];?>
            </div>
            <div class="rows">
                <label for="menu_group_id">Mobo Service ID</label>
                <input type="number" name="mobo_service_id" value="<?php echo $Item['mobo_service_id'];?>" class="mobo_service_id textinput" placeholder="Mobo Service Id"/>
                <?php echo $errors['mobo_service_id'];?>
            </div>
            <div class="rows">
            ...
            <div class="rows">
                <label for="menu_group_id">Giá trị GD mcoin</label>
                <input type="number" name="mcoin" value="<?php echo $Item['mcoin'];?>" class="mcoin textinput" placeholder="Mcoin"/>
                <?php echo $errors['mcoin'];?>
            </div>
            <div class="rows">
                <label for="menu_group_id">Số tiền ingame</label>
                <input type="number" name="credit" value="<?php echo $Item['credit'];?>" class="credit txtcredit textinput" placeholder="Credit"/>
                <?php echo $errors['credit'];?>
            </div>
            <div class="rows">
                <label for="menu_group_id">Số tiền ingame (Không bao gồm KM, quy đổi dựa mcoin hay VND)</label>
                <input type="number" name="credit_original" value="<?php echo $Item['credit_original'];?>" class="txtcredit_original textinput" placeholder="Credit Original"/>
                <?php echo $errors['credit_original'];?>
            </div>
        </div>
        <div class="group_right">
            <div class="rows">
                ...
                <select name="payment_type" id="menu_group_id" class="textinput">
                    ...
                    <option value="bank" <?php echo ($Item['payment_type']=='bank')?'selected="selected"':''; ?>>Bank</option>
                    ...
                    <option value="sms" <?php echo ($Item['payment_type']=='sms')?'selected="selected"':''; ?>>Sms</option>
					<option value="mopay" <?php echo ($Item['payment_type']=='mopay')?'selected="selected"':''; ?>>Mopay</option>
                </select>
            ...
            <div class="rows">
                ...
                <textarea cols="42" rows="6" name="description" placeholder="Description"></textarea>
            </div>
        </div>
        <div class="clr"></div>
		<div class="full_columns">
            <fieldset>
                <legend>Giá trị chưa quy đổi (VND)</legend>
                <div class="rows first">
                    <label for="menu_group_id">Giá trị GD VND</label>
                    <input type="number" name="source_value" value="<?php echo $Item['source_value'];?>" class="textinput"/>
                    <?php echo $errors['source_value'];?>
                </div>
                <div class="rows">
                    <label for="menu_group_id">Hình thức thanh toán</label>
                    <select name="source_type" id="menu_group_id" class="textinput">
                        <option value="">Chọn hình thức thanh toán</option>
                        <option value="bank" <?php echo ($Item['source_type']=='bank')?'selected="selected"':''; ?>>Bank</option>
                        <option value="card" <?php echo ($Item['source_type']=='card')?'selected="selected"':''; ?>>Card</option>
                        <option value="inapp" <?php echo ($Item['source_type']=='inapp')?'selected="selected"':''; ?>>Inapp</option>
                        <option value="sms" <?php echo ($Item['source_type']=='sms')?'selected="selected"':''; ?>>Sms</option>
                        <option value="mopay" <?php echo ($Item['source_type']=='mopay')?'selected="selected"':''; ?>>Mopay</option>
						<option value="wallet" <?php echo ($Item['source_type']=='wallet')?'selected="selected"':''; ?>>Wallet</option>
                    </select>
                    <?php echo $errors['source_type'];?>
                </div>
            </fieldset>
        </div>
		<div class="clr"></div>
        <div class="full_columns">
            <fieldset>
                ...
                <?php include_once 'json_user.php'; ?>
            </fieldset>
        </div>
...
<script type="text/javascript">
    ...
    jQuery(".txtcredit").keyup(function() {
        var alias = jQuery(".txtcredit").val();
        jQuery(".txtcredit_original").val(alias);
    });
