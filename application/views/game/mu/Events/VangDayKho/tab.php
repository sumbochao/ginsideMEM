...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mu&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mu&func=giaidau&module=all#giaidau";
        });  
        
        $('#nhanvatthamgia').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mu&func=nhanvatthamgia&module=all#nhanvatthamgia";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vangdaykho_mu&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT HỖ TRỢ GAMER LOẠN GIANG HỒ</h4>   
<!-- Nav tabs -->
