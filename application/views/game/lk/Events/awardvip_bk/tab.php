...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index_event#event";
        });
        $('#config').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index_config#config";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=award_vip&func=index_item#item";
        });
