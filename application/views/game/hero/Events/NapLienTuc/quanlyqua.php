    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=naplientuc_hero&func=themqua&tournament_id=' + $("#tournament").val() + "&module=all#quanlyqua";
            });
            ...
            $("#tournament").change(function () {
                window.location.href = "/?control=naplientuc_hero&func=quanlyqua&tournament_id=" + $(this).val() + "&module=all#quanlyqua";
            });
        });

        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/hero/cms/toolnaplientuc/gift_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function (data, type, full) {
                                    ...
                                    $.each(obj2, function (key2, value2) {
                                        html = html + "Item Id : " + value2["item_id"] + " - Số lượng : " + value2["count"] + " - Type : " + value2["type"] +"</br>";
                                    });
                                    return html;
                                }
                            },
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a href='/?control=naplientuc_hero&func=chinhsuaqua&id=" + data + "&tournament_id=" + $("#tournament").val() + "&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                }
                            }
