...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=baodanh_dht&func=index&view=event&module=all";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=baodanh_dht&func=index&view=filters&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=baodanh_dht&func=index&view=history&module=all";
        });
        $('#user').on('click', function (e) {
            window.location.href = "/?control=baodanh_dht&func=index&view=user&module=all";
        });
    });
</script>
<style>
