...
<script>
    ...
    $(function () {
        ...
        $('#home').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_gok&module=all&func=giaidau#giaidau";
        });
        ...
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_gok&module=all&func=quanlyqua#quanlyqua";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_gok&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
