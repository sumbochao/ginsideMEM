...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <form id="frmSendChest" action="/?control=event_lato&func=edit_item&module=all&ids=<?php echo $_GET['ids']?>" method="POST" enctype="multipart/form-data">
                <div class="widget row-fluid">
                    <div class="well form-horizontal">
                        <h5 class="widget-name">
                            <i class=" ico-th-large"></i>CHỈNH SỬA ITEM LẬT Ô
                        </h5>
