    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href ='?control=event_qualogin&func=add&view=item&module=all';
            });
        });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='?control=event_qualogin&func=edit&view=item&module=all&ids="+data+"'>Edit</a> <span style='padding-left:10px'><a href='?control=event_qualogin&func=delete&view=item&module=all&ids="+data+"'>Delete</a></span>";
                                }
