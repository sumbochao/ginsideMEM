            ...
            <div class="widget" id="viewport">
                <?php
                    ...
                    if($_GET['id']>0){
                        if(!empty($items['created'])){
                            $created = date_format(date_create($items['created']),"d-m-Y G:i:s");
                        }else{
                            $created = date('d-m-Y G:i:s',time());
                        }
                    }
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            <label class="control-label">Giả lập:</label>
                            <div class="controls">
                                <select name="enter_otp">
                                    <option value="1" <?php echo $items['enter_otp']==1?'selected="selected"':'';?>>Ngày hiện tại</option>
                                    <option value="2" <?php echo $items['enter_otp']==2?'selected="selected"':'';?>>Ngày hôm qua</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="datetime" name="created" value="<?php echo $created;?>"/>
                            </div>
                        </div>
