...
<script type="text/javascript">
        ...
        $('#onSubmitPopup').on('click',function(){
            ...
            $.ajax({
                ...
                beforeSend: function(  ) {
                    ...
                    window.location.href='?control=lol_event_goi_qua_vip&func=edit&view=wheel&&ids=<?php echo $_GET['ids'];?>';
                    //enable button
    ...
    function getData(){
        $.ajax({
                url: "<?php echo $url;?>index_config?iditems=<?php echo $_GET['ids']; ?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true, 
                bDestroy: true,
                            ...
                            },                            
                           {
                            ...
                            },
							{
                             ...
                             { 
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='javascript:;' onclick='editConfig("+data+")'>Edit</a> <span style='padding-left:10px'><a href='?control=lol_event_goi_qua_vip&func=deleteconfig&view=wheel&ids="+data+"&wheel=<?php echo $_GET['ids'];?>'>Delete</a></span>";
                                }
                        ...
                        <div class="control-group frmedit totalchest">
                            <div class="group1">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input name="wheel" type="hidden" value="<?php echo $_GET['ids'];?>"/>
											<input id="day" name="vip" type="text" value="" class="span3 validate[required]">
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="gold" name="money" type="text" value="" class="span3 validate[required]">
									</div>
								</div>
...
<script>
    function editConfig(ids){
        $.ajax({
            url: "<?php echo $urlConfig;?>?control=lol_event_goi_qua_vip&func=edit_config&view=wheel",
            type:"GET",
            data:{ids:ids},
            dataType:"json",
            success:function(f){
