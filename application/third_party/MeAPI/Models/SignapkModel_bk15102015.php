...
class SignapkModel extends CI_Model {
	...
	public function listMsvWp($id_game,$type_app){
		// tim msv_id da public
		$sql="select msv_id,SUBSTRING(msv_id,5) as MSVID from tbl_get_msv where service_id=".$id_game." and published in('yes','waiting') and type_app='".$type_app."' and platform='wp' ORDER BY SUBSTRING(msv_id,5) desc limit 1";
