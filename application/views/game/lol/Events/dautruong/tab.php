...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=dautruong_lol&func=index&view=event&module=all";
        });
        $('#order_hero').on('click', function (e) {
            window.location.href = "/?control=dautruong_lol&func=history&view=order_hero&module=all";
        });
        $('#history_money').on('click', function (e) {
            window.location.href = "/?control=dautruong_lol&func=history&view=history_money&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo ($_GET['view']=='order_hero')?'class="active"':'';?>><a id="order_hero" href="#order_hero" aria-controls="order_hero" role="tab" data-toggle="tab">LỊCH SỬ NHẬN TƯỚNG</a></li>
    <li role="presentation" <?php echo ($_GET['view']=='history_money')?'class="active"':'';?>><a id="history_money" href="#history_money" aria-controls="history_money" role="tab" data-toggle="tab">LỊCH SỬ TRỪ TIỀN</a></li>
</ul>
