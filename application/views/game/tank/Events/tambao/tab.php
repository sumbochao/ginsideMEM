...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=tambao_tank&func=index&view=event&module=all";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=tambao_tank&func=index&view=filters&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=tambao_tank&func=index&view=history&module=all";
        });
        $('#user').on('click', function (e) {
            window.location.href = "/?control=tambao_tank&func=index&view=user&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo $_GET['view']=='user'?'class="active"':'';?>><a id="user" href="#user" aria-controls="user" role="tab" data-toggle="tab">USER</a></li>
</ul>
