    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=topthapbongdem_hero&func=themgiaidau&module=all#giaidau';
            });
        });
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=topthapbongdem_hero&func=chinhsuagiaidau&id=" + data + "&module=all#giaidau'>Chỉnh Sửa</a>";
                                    }
