...
<div class="rule_item">
    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            ...
            <div class="rows">
                <div class="title">Nhập Vàng:</div>
                <div class="input"><input type="text" placeholder="Nhập Vàng" value="<?php echo $vrule['keymoney']; ?>" name="keymoney[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Nhập Vàng:</div>';
            html += '   <div class="input"><input type="text" size="20" name="keymoney[' + x + ']" value="2500" placeholder="Nhập Vàng" /></div>';
            html += '</div>';
            html += '<div class="rows">';
