...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=giaidau&module=all#giaidau";
        });  
        
        $('#giaidau_totaldate').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=giaidau_totaldate&module=all#giaidau_totaldate";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=giaithuong&module=all#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=giaithuongtop&module=all#giaithuongtop";
        });

        $('#giaithuongpremiership').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=giaithuongpremiership&module=all#giaithuongpremiership";
        });

        $('#lichsu_sendnl').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=lichsu_sendnl&module=all#lichsu_sendnl";
        });
        
        $('#sendnl').on('click', function (e) {
            window.location.href = "/?control=tichluy_3q&func=sendnl&module=all#sendnl";
        });
