...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/3q/cms/tooldualvl30/tournament_list",
        ...
        function load_gift_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/3q/cms/tooldualvl30/load_gift_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        ...
                        $("#gift_lvl_send").val(data[0]["gift_lvl_send"]);
                        $("#gift_quantity_send").val(data[0]["gift_quantity_send"]);
...
Số lượng <input name="gift_quantity[' + k + ']" id="gift_quantity_' + k + '" type="text" class="span3 validate[required,custom[onlyNumberSp]]" /> \n\
Type <input name="gift_send_type[' + k + ']" id="gift_send_type_' + k + '" type="text" class="span3 validate[required]" />\n\
</div>\n\
</div>\n\
</div> ');
        });
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/3q/Events/Dualvl30/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=dualvl30_3q&func=edit_gift&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="gift_lvl_send" id="gift_lvl_send" type="text" class="span3 validate[required]" />
                            </div>
                        </div> 

                        <div class="control-group">
                            <label class="control-label">Số lượng quà giới hạn:</label>
                            <div class="controls">
                                <input name="gift_quantity_send" id="gift_quantity_send" type="text" class="span3 validate[required]" />
                            </div>
                        </div> 
