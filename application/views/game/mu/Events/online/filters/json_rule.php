...
<div class="rule_item">
    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            <div class="rows">
                <div class="title">Nhập Key:</div>
                <div class="input"><input type="text" placeholder="Nhập Key" value="<?php echo $vrule['key']; ?>" name="key[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
            ...
            <div class="rows">
                ...
                <div class="input"><input type="text" class="timepick" size="20" value="<?php echo date_format(date_create($vrule['start']),"H:i:s");?>" name="keystart[<?php echo $i;?>]" placeholder="Ngày bắt đầu" /></div>
            </div>
           <div class="rows">
                <div class="title">Kết thúc:</div>
                <div class="input"><input type="text" class="timepick" size="20" value="<?php echo date_format(date_create($vrule['end']),"H:i:s");?>" name="keyend[<?php echo $i;?>]" placeholder="Ngày Kết thúc" /></div>
            </div>
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '<div class="rows">';
            html += '   <div class="title">Nhập Key:</div>';
            html += '   <div class="input"><input type="text" size="20" name="key[' + x + ']" value="0" placeholder="Nhập Key" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            ...
            html +='<div class="input"><input type="text" class="timepick" size="20" name="keystart['+x+']" value="<?php echo date('H:i:s');?>" placeholder="Ngày bắt đầu" /></div>';
            html +='</div>';
            html +='<div class="rows">';
            html +='<div class="title">Kết thúc:</div>';
            html +='<div class="input"><input type="text" class="timepick" size="20" name="keyend['+x+']" value="<?php echo date('H:i:s');?>" placeholder="Ngày Kết thúc" /></div>';
            html +='</div>';
