    ...
    <script type="text/javascript">
        ...
        function load_gift_details(){
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "<?php echo $url_service;?>/cms/toolbongda/load_code_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#gift_code").val(data[0]["gift_code"]);
                        $("#id").val(data[0]["id"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_bongda_lol&func=edit_code_details&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group frmedit">
                            ...
                            <div class="controls">
                                <input name="gift_code" id="gift_code" type="text" class="span3 validate[required]" />
                            </div>
                        </div>
                        <div class="control-group">
