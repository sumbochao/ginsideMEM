        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/level/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            ...
                            <?php
                                ...
                                $from_day = gmdate('d-m-Y G:i:s',time()+7*3600);
                                if($_GET['id']>0){
                                    ...
                                    if(!empty($items['from_day'])){
                                        $from_dayc = DateTime::createFromFormat('Y-m-d G:i:s',trim($items['from_day']));
                                        $from_day = $from_dayc->format('d-m-Y G:i:s');
                                    }
                                }
                            ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" name="from_day" value="<?php echo $from_day;?>"/>
                                </div>
                            </div>
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="type">
                                        <option value="0" <?php echo $items['type']==0?'selected="selected"':'';?>>Thăng cấp nhận quà</option>
                                        <option value="1" <?php echo $items['type']==1?'selected="selected"':'';?>>Báo danh</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
