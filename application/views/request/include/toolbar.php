<div class="header_toolbar">
    <div class="header_title icon48-install"><?php echo $title. " : <strong style='color:#DA00FF'>".$sTemps[$_GET['id_template']]['template_name']."</strong>";?></div>
    <div class="toolbar">
        <?php
            ...
            $lnkCancel = base_url()."?control=".$_GET['control']."&func=index&id_categories=".$_GET['id_categories']."&id_template=".$_GET['id_template'];
			...
			$lnkBack = base_url()."?control=".$_GET['control']."&func=index&id_categories=".$_GET['id_categories']."&id_template=".$_GET['id_template'];
			...
			$lnkBackHome = base_url()."?control=categories&func=index&cbo_template=".$_GET['id_template']."&id_template=".$_GET['id_template'];
