    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                //window.location.href = '/?control=event_covu_dht&func=giaidau#giaidau';
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/toolbongda/edit_tournament",
        ...
        function load_tournament_detail(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#startdate").val(data[0]["tournament_date_start"]);
                    $("#enddate").val(data[0]["tournament_date_end"]);
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" id="startdate" name="startdate" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" id="enddate" name="enddate" value=""/>
                                </div>
                            </div>
