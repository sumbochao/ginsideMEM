    ...
    <script type="text/javascript">
        ...
        function load_gift_details(){
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/bog/cms/toolcacuoc/load_gift_details?id=" + id,
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_covu_bog&func=edit_gift_details" method="POST" enctype="multipart/form-data">
