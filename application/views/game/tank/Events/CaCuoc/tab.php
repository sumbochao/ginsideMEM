...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=trandau#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=quanlyqua#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_covu_tank&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
