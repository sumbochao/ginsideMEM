...
<script>
    ...
    $(function () {
        $('#config').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=config&module=all";
        });
        $('#lottery').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=lottery&module=all";
        });
        $('#point').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=point&module=all";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=item&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=history&module=all";
        });
        $('#history_point').on('click', function (e) {
            window.location.href = "/?control=consomayman_lvl&func=index&view=history_point&module=all";
        });
    });
</script>
<style>
