    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=shopkimbai_koa&func=themgiaidau&module=all#giaidau';
            });
        });

        function getData() {
            $.ajax({
                url: "http://game.mobo.vn/lucgioi/cms/toolshopkimbai/tournament_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=shopkimbai_koa&func=chinhsuagiaidau&id=" + data + "&module=all#giaidau'>Chỉnh Sửa</a>";
                                    }
