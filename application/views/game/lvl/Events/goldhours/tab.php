...
<script>
    ...
    $(function () {        
       $('#item').on('click', function (e) {
            window.location.href = "/?control=gold_hours_lvl&func=index&module=all#item";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=gold_hours_lvl&func=history&module=all#history";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="item" href="#item" aria-controls="item" role="tab" data-toggle="tab">QUÀ</a></li>
