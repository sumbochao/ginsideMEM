    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                //window.location.href = '/?control=toptyvo_mgh2&func=giaidau#giaidau';
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/mgh2/cms/tooltoptyvo/edit_tournament",
        ...
        function load_tournament_detail(id) {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/mgh2/cms/tooltoptyvo/tournament_get_by_id?id=" + id,
