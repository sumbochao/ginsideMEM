    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=chienluc_tank&func=themqua&tournament_id=' + $("#tournament").val() + "&module=all#quanlyqua";
            });
            ...
            $("#tournament").change(function () {
                window.location.href = "/?control=chienluc_tank&func=quanlyqua&tournament_id=" + $(this).val() + "&module=all#quanlyqua";
            });
        });

        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/tank/cms/toolchienluc/gift_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                ...
                success: function (data, textStatus, jqXHR) {
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            {
                                sTitle: "Chiến lực yêu cầu",
                                mData: "gift_required_power"
                            },
                            {
                                sTitle: "Server List",
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a href='/?control=chienluc_tank&func=chinhsuaqua&id=" + data + "&tournament_id=" + $("#tournament").val() + "&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                }
