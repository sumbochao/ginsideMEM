<script>
    $(function () {        
        ...
        $('#topup_by_server').on('click', function (e) {
            window.location.href = "/?control=reports&func=topup_byserver&game=<?php echo $_GET['game'];?>#topup_by_server";
        });
        $('#money').on('click', function (e) {
            window.location.href = "/?control=reports&func=money&game=<?php echo $_GET['game'];?>#money";
        });
        ...
        $('#card_statistics').on('click', function (e) {
            window.location.href = "/?control=reports&func=card_statistics&game=<?php echo $_GET['game'];?>#card_statistics";
        });
		$('#list_vip_byserver').on('click', function (e) {
            window.location.href = "/?control=reports&func=list_vip_byserver&game=<?php echo $_GET['game'];?>#list_vip_byserver";
        });
    });
</script>
