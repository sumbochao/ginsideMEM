...
<script>
    function loadIframecontentServer() {
        ...
        jQuery("#ifmserver").html('<iframe style="width:100%;height:350px;border:0px;" id="ifmservercontent" src="<?php echo APPLICATION_URL;?>?control=promotion_gapi&func=loadserver&iframe=1&game_id='+game_id+'&lid='+lid+'"></iframe>');
    } 
...
<div class="wrapper_list">
     <label for="menu_group_id">Server đã chọn</label>
    <div class="listserver" id="divservercontent">
        ...
        <?php
            $j_arrValue = '';
            if(!empty($items['server_ids'])){
                $content_server = explode(',', $items['server_ids']);
