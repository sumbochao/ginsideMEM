...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=accumulation_bog&func=index&view=event#event";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=accumulation_bog&func=index&view=filters#filters";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=accumulation_bog&func=history#history";
        });
    });
</script>
<style>
