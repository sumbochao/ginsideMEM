...
<script type="text/javascript">
    $(document).ready(function() {
        $('#onSubmitPopup').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/qualv/add_config",
                ...
                beforeSend: function(  ) {
                    ...
                    window.location.href='?control=qualv&func=edit&view=wheel&&ids=<?php echo $_GET['ids'];?>';
                    //enable button
        ...
        $('#onSubmitUpdate').on('click',function(){alert('345');
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/qualv/edit_config",
                data: $(".popupFrmSendChest").serializeArray(),
                beforeSend: function(  ) {
    ...
    function getData(){
        $.ajax({
                url: "<?php echo $url;?>/cms/qualv/index_config?iditems=<?php echo $_GET['ids']; ?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true, 
                bDestroy: true,
                            ...
                            },                            
                           {
                            ...
                            },
                            {
                             ...
                             { 
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='javascript:;' onclick='editConfig("+data+")'>Edit</a> <span style='padding-left:10px'><a href='?control=qualv&func=deleteconfig&view=wheel&ids="+data+"&wheel=<?php echo $_GET['ids'];?>'>Delete</a></span>";
                                }
...
<script>
    function editConfig(ids){
        $.ajax({
            url: "<?php echo $urlConfig;?>?control=qualv&func=edit_config&view=wheel",
            type:"GET",
            data:{ids:ids},
            dataType:"json",
            success:function(f){
