    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=event_bongda_lol&func=themqua&module=all#quanlyqua';
            });
        });

        function getData() {
            $.ajax({
                url: "<?php echo $url_service;?>/cms/toolbongda/gift_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_bongda_lol&func=chinhsuaqua&module=all&id=" + data + "#quanlyqua'>Chỉnh Sửa</a>";
                                    }
