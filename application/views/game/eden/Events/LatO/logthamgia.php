...
<div id="content-t" style="min-height:500px; padding-top:10px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=event_lato_eden&func=logthamgia&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#logthamgia";
            });

            $('#export_excel').on('click', function () {
                window.location.href = "http://service.eden.mobo.vn/cms/promotion_lato/export_excel_logthamgia?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
            });
        ...
        function getData() {
            $(".loading").fadeIn("fast");
            $.ajax({
                url: "http://service.eden.mobo.vn/cms/promotion_lato/logthamgia?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                               ...
                               },
                               {
                                ...
                                {
                                    sTitle: "Tiền Cập Nhật Cuối",
                                    mData: "money"
                                },
                                {
                                    sTitle: "Ngày Tham Gia",
                                    mData: "create_date"

                                },
                                 {
                                     sTitle: "Tham Gia Lần Cuối",
                                     mData: "update_date",
                                 }
                        ],
                        bProcessing: true,
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">                     
            <?php include APPPATH . 'views/game/eden/Events/LatO/tab.php'; ?>
