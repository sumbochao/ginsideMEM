...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#comeback').on('click',function(){
            window.location.href ='/cms/ep/quachienluc/index?view=filter';
        });
        ...
        $('#onSubmit').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/quachienluc/<?php echo ($_GET['ids']>0)?'edit_filter?ids='.$_GET['ids']:'add_filter';?>",
...
<div id="content">
    <!-- Content wrapper -->
    <div class="wrapper">
        <?php include APPPATH . 'views/game/pt/Events/quachienluc/tab.php'; ?>
