        ...
        <div id="adminfieldset" class="groupsignios">
            ...
            <div class="group_left">
                ...
                <div class="rows">
                    ...
                    <input type="text" name="sdkversion" id="sdkversion" class="textinput" value="<?php echo $itemview['sdkversion']; ?>"/>
...
<script type="text/javascript">
	...
	function calljavascript(i){
		switch(i){
			 case 0:
			 	checknull('appForm','<?=base_url()."?control=".$_GET['control']."&func=".$_GET['func']."&id=".intval($_GET['id'])."&act=action"; ?>');
			 break;
			 case 1:
			 ...
			 break;
			 case 5://copy
			 	window.location.href='<?php echo base_url()."?control=".$_GET['control']."&func=copyedit&id=".intval($_GET['id']); ?>';
			 break;
			 case 6://xuất excel 1 record
			 	exportExcelOne('<?php echo base_url()."?control=libsdk&func=exportexcel&idrows=".intval($_GET['id'])."&type=one"; ?>');
			 break;
			 case 7:
			 	//back to home;
					var gm=$('#cbo_game').val().split('|');
