...
<script type="text/javascript">
    $(document).ready(function() {
        $('#onSubmitPopup').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/buyheros_sub/add_config",
                ...
                beforeSend: function(  ) {
                    ...
                    window.location.href='?control=buyheros_sub&func=edit&view=wheel&&ids=<?php echo $_GET['ids'];?>';
                    //enable button
        ...
        $('#onSubmitUpdate').on('click',function(){alert('345');
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/buyheros_sub/edit_config",
                data: $(".popupFrmSendChest").serializeArray(),
                beforeSend: function(  ) {
    ...
    function getData(){
        $.ajax({
                url: "<?php echo $url;?>/cms/buyheros_sub/index_config?iditems=<?php echo $_GET['ids']; ?>",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true, 
                bDestroy: true,
                            ...
                            },                            
                           {
                            ...
                            },
                            {
                             ...
                             { 
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='javascript:;' onclick='editConfig("+data+")'>Edit</a> <span style='padding-left:10px'><a href='?control=buyheros_sub&func=deleteconfig&view=wheel&ids="+data+"&wheel=<?php echo $_GET['ids'];?>'>Delete</a></span>";
                                }
...
<script>
    function editConfig(ids){
        $.ajax({
            url: "<?php echo $urlConfig;?>?control=buyheros_sub&func=edit_config&view=wheel",
            type:"GET",
            data:{ids:ids},
            dataType:"json",
            success:function(f){
