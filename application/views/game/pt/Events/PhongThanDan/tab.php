...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=giaithuong#giaithuong";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_phongthandan_pt&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT PHONG THẦN ĐÀN</h4>   
<!-- Nav tabs -->
