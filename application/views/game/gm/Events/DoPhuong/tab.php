...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=dophuong_gm&func=index#home";
        });

        $('#quanlyphong').on('click', function (e) {
            window.location.href = "/?control=dophuong_gm&func=quanlyphong#quanlyphong";
        });

        $('#quanlyphien').on('click', function (e) {
        ...
        $('#quanlyqua').on('click', function (e) {
         ...
         $('#quanlygoiqua').on('click', function (e) {
            window.location.href = "/?control=dophuong_gm&func=quanlygoiqua#quanlygoiqua";
        });

        $('#thongketopdiem').on('click', function (e) {
            window.location.href = "/?control=dophuong_gm&func=thongketopdiem#thongketopdiem";
        });       

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=dophuong_gm&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐỖ PHƯỜNG</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="quanlyphong" href="#quanlyphong" aria-controls="quanlyphong" role="tab" data-toggle="tab">QUẢN LÝ PHÒNG</a></li>    
    <li role="presentation"><a id="quanlyphien" href="#quanlyphien" aria-controls="quanlyphien" role="tab" data-toggle="tab">QUẢN LÝ PHIÊN</a></li>
<!--    <li role="presentation"><a id="quanlyqua" href="#quanlyqua" aria-controls="quanlyqua" role="tab" data-toggle="tab">QUẢN LÝ QUÀ</a></li>
    ...
    <li role="presentation"><a id="thongketopdiem" href="#thongketopdiem" aria-controls="thongketopdiem" role="tab" data-toggle="tab">THỐNG KÊ TOP ĐIỂM</a></li>
