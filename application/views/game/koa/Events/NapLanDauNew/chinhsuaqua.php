    ...
    <script type="text/javascript">
        ...
        function load_gift_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/lucgioi/cms/toolnaplandau_new/load_gift_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#id").val(data[0]["id"]);
...
<?php include APPPATH . 'views/game/koa/Events/NapLanDauNew/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=naplandau_new_koa&func=edit_gift&module=all" method="POST" enctype="multipart/form-data">
