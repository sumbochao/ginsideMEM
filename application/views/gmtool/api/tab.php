...
<script>
    ...
    $(function () {
        $('#gmtoolapi').on('click', function (e) {
            window.location.href = "/?control=gmtoolapi&func=index&module=all";
        });
        $('#index_icon_mobo').on('click', function (e) {
            window.location.href = "/?control=gmtoolapi&func=index_icon_mobo&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php echo $_GET['func'] == 'index' ? 'active' : ''; ?>"><a id="gmtoolapi" href="#gmtoolapi" aria-controls="gmtoolapi" role="tab" data-toggle="tab">GM SUPPORT</a></li>
    <li role="presentation" class="<?php echo $_GET['func'] == 'index_icon_mobo' ? 'active' : ''; ?>"><a id="index_icon_mobo" href="#" aria-controls="index_icon_mobo" role="tab" data-toggle="tab">ICON MOBO </a></li>
</ul>
