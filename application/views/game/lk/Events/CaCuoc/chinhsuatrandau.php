    ...
    <script type="text/javascript">
        ...
        function load_match_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/hiepkhach/cms/toolcacuoc/load_match_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_covu&func=edit_match_details" method="POST" enctype="multipart/form-data">
