                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="dacbiet" id="dacbiet" value="<?php echo $items['dacbiet'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tất cả:</label>
                            <div class="controls">
                                <textarea name="tatca" style="width:80%;height: 150px;"><?php echo $items['tatca'];?></textarea>
                                <div style="color:#999;font-style: italic">Ví dụ : 25,00,01,02,03</div>
                            </div>
                        </div>
                        <div class="control-group">
