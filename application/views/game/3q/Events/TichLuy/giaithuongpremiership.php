    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#update_reward').on('click', function () {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/3q/cms/tooltichluy/edit_reward_name_premiership/?id=" + $('#reward').val() + "&reward_name=" + $('#reward_name_edit').val() + "&reward_rank_min=" + $('#reward_rank_min_edit').val() + "&reward_rank_max=" + $('#reward_rank_max_edit').val(),
            ...
            $('#add_new_reward').on('click', function () {
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/3q/cms/tooltichluy/add_reward_premiership",
        ...
        function load_reward(tournament_id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/3q/cms/tooltichluy/load_reward_premiership?tournament_id=" + tournament_id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    var obj = data;
                    var rewardlist = "";
        ...
        function load_reward_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/3q/cms/tooltichluy/load_reward_details_premiership?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    if (data.length > 0) {
                        $("#id").val(data[0]["id"]);
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tichluy_3q&module=all&func=edit_reward_details_premiership" method="POST" enctype="multipart/form-data">
