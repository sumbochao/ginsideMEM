    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=choinapmhknhanknb_gok&module=all&func=themgiaidau#giaidau';
            });
        });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function (data) {
                                    return "<a class='btn btn-success btn-xs' href='/?control=choinapmhknhanknb_gok&module=all&func=chinhsuagiaidau&id=" + data + "#giaidau'>Chỉnh Sửa</a>";
                                }
