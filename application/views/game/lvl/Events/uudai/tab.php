...
<script>
    ...
    $(function () {        
        $('#items').on('click', function (e) {
            window.location.href = "/?control=uudai_lvl&module=all&func=index#home";
        });

        $('#historygamer').on('click', function (e) {
            window.location.href = "/?control=uudai_lvl&module=all&func=historygamer#historygamer";
        });       

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=uudai_lvl&module=all&func=history#history";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT GÓI QUÀ Ưu Đãi</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation"><a id="items" href="#items" aria-controls="items" role="tab" data-toggle="tab">ITEMS</a></li>
	<li role="presentation"><a id="historygamer" href="#historygamer" aria-controls="historygamer" role="tab" data-toggle="tab">GAMER</a></li>
