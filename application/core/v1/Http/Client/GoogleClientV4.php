 ...
 */
class GoogleClientV4 extends Client implements ClientInterface
{
    const LIBVER = "2.2.0";
    ...
    static $DOMAIN_MAP = array(
        ...
        OAUTH2_TOKEN_URI => 'https://accounts.google.com/oauth2/v4/token',
    ...
    protected function createDefaultHttpClient()
    {
        ...
        return new GoogleClientV4($options);
    }
