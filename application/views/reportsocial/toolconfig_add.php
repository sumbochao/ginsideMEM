...
<form action="" method="post" name="frmadd" enctype="multipart/form-data">
	...
	<fieldset>
        <label for="id_app">Fanpage</label>
		<input type="text" name="fanpage" id="fanpage" value="<?php echo $configid['fanpage'];?>" class="textinput">
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        <label for="id_app">Description</label>
		<input type="text" name="desc" id="desc" value="<?php echo $configid['description'];?>" class="textinput">
        <br/>
		<br>
...
<script>
    function onCancel(){
        ...
        theform.action = "<?php echo base_url()?>?control=reportsocial&func=index";
        theform.submit();
        return true;
    }		
</script>