...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vip_lvl&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vip_lvl&module=all&func=giaidau#giaidau";
        });
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=vip_lvl&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#quanlygoiqua').on('click', function (e) {
            window.location.href = "/?control=vip_lvl&module=all&func=quanlygoiqua#quanlygoiqua";
        });       

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vip_lvl&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
