    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" name="frmSendChest" action="/?control=uocnguyen_koa&func=post_event" method="POST" enctype="multipart/form-data">
                        <div class="well form-horizontal">
                            ...
                            <?php
                                ...
                                if($_GET['id']>0){
                                    ...
                                    if(!empty($items['start_date'])){
                                        $start = date_format(date_create($items['start_date']),"d-m-Y G:i:s");
                                    }
                                    if(!empty($items['end_date'])){
                                        $end = date_format(date_create($items['end_date']),"d-m-Y G:i:s");
                                    }
                                }
                            ?>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="event_name" id="event_name" value="<?php echo $items['event_name'];?>" type="text" class="span3 validate[required]" style="width: 80%"/>
                                </div>
                            </div>
                            <div class="control-group">
                                    ...
                                    <div id="load-content" style="margin-top:10px;">
                                        <?php
                                            if(!empty($items['image'])){
                                                $removeLink = $url_service.'/cms/uocnguyen/remove_image?id='.$items['event_id'];
                                        ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" name="start_date" value="<?php echo $start;?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" name="end_date" value="<?php echo $end;?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="free" value="<?php echo $items['free'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
