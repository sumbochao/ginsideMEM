...
function createHtml(){
    ...
    '<div class="controls">'+
        '<div class="span3">'+
            '<div>SERVER</div>'+
            '<input type="text" name="service_trustserver[]" id="service_trustserver" value="" class="textinput">'+
        '</div>'+
        '<div class="span3">'+
            '<div>STATDATE</div>'+
...
<form action="" method="post" name="frmadd" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<div class="control-group">
            <div class="controls">
                <?php
					$service_lang = explode(",",$items['service_language']);
                    foreach($lang as $val){
						
                ?>
					<div class="span2">
						<div><?php echo strtoupper($val);?></div>
						<input type="checkbox" name="service_lang[]" class="span12" <?php echo in_array($val,$service_lang)?"checked":"";?> id="service_lang" value="<?php echo $val; ?>" />
					</div>
				<?php }?>
            </div>
        </div>
        ...
        <div class="control-group">
            <div class="form-group">
                <button id="addgroup" class="base_button base_green base-small-border-radius"><span>ADD</span></button>
            </div>
        </div>
