...
<script>
    ...
    $(function () {
        $('#gamer').on('click', function (e) {
            window.location.href = "/?control=uocnguyen_3q&func=index&view=gamer&module=all";
        });        
        $('#history').on('click', function (e) {
            window.location.href = "/?control=uocnguyen_3q&func=index&view=history&module=all";
        });
        $('#hero').on('click', function (e) {
            window.location.href = "/?control=uocnguyen_3q&func=index&view=hero&module=all";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=uocnguyen_3q&func=index&view=item&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php echo $_GET['view'] == 'gamer' ? 'active' : ''; ?>"><a id="gamer" href="" aria-controls="gamer" role="tab" data-toggle="tab">LƯỢT QUAY</a></li>
    <li role="presentation" class="<?php echo $_GET['view'] == 'history' ? 'active' : ''; ?>"><a id="history" href="" aria-controls="history" role="tab" data-toggle="tab">LỊCH SỬ</a></li>
    <li role="presentation" class="<?php echo $_GET['view'] == 'hero' ? 'active' : ''; ?>"><a id="hero" href="" aria-controls="hero" role="tab" data-toggle="tab">TƯỚNG</a></li>
    <li role="presentation" class="<?php echo $_GET['view'] == 'item' ? 'active' : ''; ?>"><a id="item" href="" aria-controls="item" role="tab" data-toggle="tab">QUÀ</a></li>
</ul>
