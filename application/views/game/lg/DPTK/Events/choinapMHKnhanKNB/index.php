    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=choinapmhknhanknb_dptk&module=all&func=themgiaidau#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "https://sev-dptk.addgold.net/ToolchoinapMHKnhanKNB/edit_tournament",
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                dataType: 'jsonp',
                url: "https://sev-dptk.addgold.net/ToolchoinapMHKnhanKNB/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
