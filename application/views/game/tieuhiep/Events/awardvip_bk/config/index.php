    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                window.location.href = '/?control=award_vip&func=add_config#config';
            });
        });
        function getData() {
            $.ajax({
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                               ...
                               mData: "id",
                               mRender: function (data) {
                                   return "<a class='btn btn-success btn-xs' href='/?control=award_vip&func=edit_config&id=" + data + "#config'>Sửa</a>\n\
                                           <a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=award_vip&func=delete_config&id=" + data + "#config'>Xóa</a>";
                               }
                            }
                        ],
                        bProcessing: true,
