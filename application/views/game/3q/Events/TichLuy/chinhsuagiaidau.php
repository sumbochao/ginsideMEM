...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                //window.location.href = '/?control=tichluy_hero&func=giaidau#giaidau';
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/_3q/cms/tooltichluy/edit_tournament",
        ...
        function load_tournament_detail(id) {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/_3q/cms/tooltichluy/tournament_get_by_id?id=" + id,
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/_3q/Events/TichLuy/tab.php'; ?>
