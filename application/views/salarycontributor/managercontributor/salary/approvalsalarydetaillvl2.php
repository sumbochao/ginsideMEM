        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://mem.net.vn/cms/toolsalarycollaborator/editsalarylvl2",
                    data: data_post,
                    beforeSend: function () {
                        $(".loading").fadeIn("fast");
                    }
        ...
        function load_approval_history_detail(id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#last_approved_salary").val(data["last_approved_salary"]);
                    $("#update_date").val(data["update_date"]);
                    $("#info_approved").val(data["info_approved"]);
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            <label class="control-label">Người Duyệt Cấp 1:</label>
                            <div class="controls">
                                <input name="last_approved_salary" id="last_approved_salary" type="text" class="span3 validate[required]]" readonly style="background: cornsilk;"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label">Ngày Duyệt Cấp 1:</label>
                            <div class="controls">
                                <input name="update_date" id="update_date" type="text" class="span3 validate[required]" readonly style="background: cornsilk;"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label">Thông tin duyệt cấp 1:</label>
                            <div class="controls">
                                <textarea readonly name="info_approved" id="info_approved" type="text" class="span3" style="margin: 0px; width: 295px; height: 60px;" style="background: cornsilk;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                Duyệt lần 2:<input type="radio" name="approval_salary_status" id="approval_salary_status" value="1" checked="">
                                &nbsp;&nbsp;
