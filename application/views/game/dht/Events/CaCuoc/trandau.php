    ...
    <script type="text/javascript">
        $(function () {
            $('#add_tournament').on('click', function () {
                window.location.href = '/?control=event_covu_dht&module=all&func=themtrandau#trandau';
            });

            $("#tournament_id").change(function () {
                //getData($(this).val());
                window.location.href = "/?control=event_covu_dht&module=all&func=trandau&tournament_id=" + $(this).val() + "#trandau";
            });
        });
        ...
        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/onepiece/cms/toolcacuoc/match_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_covu_dht&module=all&func=chinhsuatrandau&id=" + data + "#trandau'>Chỉnh Sửa</a> <a class='btn btn-success btn-xs' href='/?control=event_covu_dht&module=all&func=ketquatrandau&id=" + data + "#trandau'>Cập nhật kết quả</a>";
                                    }
