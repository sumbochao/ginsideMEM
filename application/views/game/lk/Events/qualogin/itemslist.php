    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href ='/cms/ep/accumulation_weekly/add?view=item';
            });
        });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='edit/?view=item&ids="+data+"'>Edit</a> <span style='padding-left:10px'><a href='delete/?view=item&ids="+data+"'>Delete</a></span>";
                                }
