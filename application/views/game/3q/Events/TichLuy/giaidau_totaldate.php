    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=tichluy_3q&func=themgiaidau_totaldate&module=all#giaidau_totaldate';
            });
        });

        function getData() {
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/tooltichluy/tournament_totaldate_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=tichluy_3q&func=chinhsuagiaidau_totaldate&id=" + data + "&module=all#giaidau_totaldate'>Chỉnh Sửa</a>";
                                    }
