        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/banpick_v1/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="team" id="team" value="<?php echo $items['team'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
