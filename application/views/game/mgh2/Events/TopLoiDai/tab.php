...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=giaidau&module=all#giaidau";
        });        

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=giaithuong&module=all#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=giaithuongtop&module=all#giaithuongtop";
        });

        $('#giaithuongpremiership').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=giaithuongpremiership&module=all#giaithuongpremiership";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=toploidai_mgh2&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT TOP LÔI ĐÀI</h4>   
<!-- Nav tabs -->
