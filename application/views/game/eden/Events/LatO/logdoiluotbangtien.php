    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=event_lato_eden&func=logdoiluotbangtien&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#logdoiluotbangtien";
            });

            $('#export_excel').on('click', function () {
                window.location.href = "http://service.eden.mobo.vn/cms/promotion_lato/export_excel_logdoiluotbangtien?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
            });
        ...
        function getData() {
            $(".loading").fadeIn("fast");
            $.ajax({
                url: "http://service.eden.mobo.vn/cms/promotion_lato/logdoiluotbangtien?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
