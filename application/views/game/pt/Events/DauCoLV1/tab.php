...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv_1&func=index#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv_1&func=quanlyqua#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv_1&func=lichsu#lichsu";
        });
		
		 $('#packages').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv_1&func=packages#packages";
        });
    });
</script>
<style>
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation"><a id="packages" href="#packages" aria-controls="packages" role="tab" data-toggle="tab">LOG MUA GÓI ĐẦU CƠ</a></li>
  </ul>
