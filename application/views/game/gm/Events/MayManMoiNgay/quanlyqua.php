        ...
        function getData() {
            $('#data_table').DataTable({
                ...
                aoColumns: [
                    ...
                    {
                        sTitle: "Item ID",
                        mData: "reward_item_code"
                    },
                    {
                        sTitle: "Number",
                        mData: "reward_item_number"
                    },
                    {
                        sTitle: "Type",
                        mData: "reward_item_type"
                    },
                    {
                        sTitle: "Image",
                        mData: "reward_img"
                    ...
                    },
                    {
                        ...
                        mRender: function (data, arg1, arg2) {
                            return "<a class='btn btn-success btn-xs' href=' /?control=maymanmoingay&func=themqua&module=all&id=" + data +"#quanlyqua '>Chỉnh Sửa</a>";
                        }
                ...
                <div class="well form-horizontal">
                    <div class="table-overflow">
                        <div style="margin-top: 10px; margin-bottom: 10px;">
							<a href="/?control=maymanmoingay&func=themqua&module=all#quanlyqua" class="btn btn-primary"><span>THÊM QUÀ</span></a>
                        </div>
