...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=phongthan_event&func=index_event#event";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=phongthan_filters&func=index_filters#filters";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=phongthan_event&func=history#history";
        });
    });
</script>
<style>
...
<h4 class="widget-name">LỊCH SỬ</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="event" href="#event" aria-controls="event" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
    <li role="presentation"><a id="filters" href="#filters" aria-controls="filters" role="tab" data-toggle="tab">BỘ LỌC</a></li>
