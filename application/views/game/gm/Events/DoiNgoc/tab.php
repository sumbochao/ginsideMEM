...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=doingoc_gm&func=index#home";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=doingoc_gm&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐỔI NGỌC IFISH</h4>   
<!-- Nav tabs -->
