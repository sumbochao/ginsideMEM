...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=index&module=all#home";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=thongke&module=all#thongke";
        });

        $('#logdoiqua').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=logdoiqua&module=all#logdoiqua";
        });

        $('#logthamgia').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=logthamgia&module=all#logthamgia";
        });

        $('#logdoiluotbangtien').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=logdoiluotbangtien&module=all#logdoiluotbangtien";
        });

        $('#clearcached').on('click', function (e) {
            window.location.href = "/?control=event_lato_mayman&func=clearcached&module=all#clearcached";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT LẬT Ô</h4>   
<!-- Nav tabs -->
