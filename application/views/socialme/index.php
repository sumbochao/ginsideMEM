...
<script>
    $(document).ready(function(){
        $('#menu_group_id').change(function(){
            typeevent = $(this).val();
            $.ajax({
                url:"/?control=socialme&func=loadtypeeventcontent",
                type: "POST",
...
<form action="" method="post" name="frmindex">
    <div class="rows">
        ...
        <select name="app" id="menu_group_id" class="textinput">
            ...
            if(empty($slbApp) !== TRUE){
				...
				?>
                        <option value="<?php echo $v['alias'];?>" ><?php echo $v['game'];?></option>
                    <?php
					}
                }
            }
        ...
        <a href="/?control=socialme&func=addmenu" class="game-button">THÊM EVENT</a>
        <?php echo $error; ?>
    </div>
<table width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover">
 <!--<table width="100%" border="0" class="table table-hover table-striped table-vcenter">-->
	...
	<tr>
        ...
        <th width="7%" align="center">Author</th>
        <th width="7%" align="center">Status</th>
        <th width="7%" align="center">Promition</th>
        <th width="7%" align="center">Langs</th>
	...
	?>
        ...
        <?php
            $edit = "<a href='".base_url()."?control=socialme&func=addmenu&id=".$val['id']."'><img src='".base_url()."assets/img/icon/icon_edit.png'></a>";
        ?>
        <tr>
            <td><?php echo $key + 1?></td>
            <td><?php echo $val['id']?></td>
            <td><?php echo $val['type_event']?></td>
