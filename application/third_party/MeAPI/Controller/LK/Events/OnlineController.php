...
class MeAPI_Controller_LK_Events_OnlineController implements MeAPI_Controller_LK_Events_OnlineInterface {
    ...
    public $url_link = "http://game.mobo.vn/hiepkhach";
    ...
    public function index(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'game/lk/Events/quaonline/'.$layout.'/index', $this->data);
    ...
    public function add(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'game/lk/Events/quaonline/'.$layout.'/add', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
	...
	function deleteconfig(MeAPI_RequestInterface $request){
        ...
        $infoDetail = file_get_contents($linkinfo);
        $datainfojson = json_decode($infoDetail,true);
        header('location: /?control=quaonline&func=edit&view=wheel&ids='.$request->input_get('wheel') );
    }
    ...
    public function clearcached(MeAPI_RequestInterface $request) {
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/lk/Events/quaonline/clearcached', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }    
