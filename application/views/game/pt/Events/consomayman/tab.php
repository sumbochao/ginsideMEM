...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=consomayman&func=index";
        });

        $('#updateresult').on('click', function (e) {
            window.location.href = "/?control=consomayman&func=importlotteryresult";
        });

        $('#listresult').on('click', function (e) {
            window.location.href = "/?control=consomayman&func=displayLotteryResult";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=consomayman&func=history";
        });
...
<!--
  ...
  -->
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">ĐÓNG MỞ EVENT</a></li>
    <li role="presentation"><a id="updateresult" href="#" aria-controls="giaidau" role="tab" data-toggle="tab">CẬP NHẬT KẾT QUẢ</a></li>
    <li role="presentation"><a id="listresult" href="#" aria-controls="trandau" role="tab" data-toggle="tab">DANH SÁCH KẾT QUẢ</a></li>
    <li role="presentation"><a id="history" href="#" aria-controls="quanlyqua" role="tab" data-toggle="tab">LỊCH SỬ</a></li>
  </ul>
