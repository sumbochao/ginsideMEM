    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create').on('click', function () {
                ...
                window.location.href = '/?control=onlinenhanqua_dptk_lg&func=excel&module=<?php echo $_GET['module']; ?>&start=' + start + '&end=' + end;
            });
        });
        function getData() {
            $.ajax({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function (data) {
                                    return "<a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=onlinenhanqua_dptk_lg&func=delete&view=history&module=all&id=" + data + "'>Xóa</a>";
                                }
                            }
                        ],
                        bProcessing: true,
