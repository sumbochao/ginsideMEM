    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() { 
            $('#comeback').on('click', function () {
                if (type != null && type != "") {
                   window.location.href = '/?control=shopkimbai_hero&func=quanlyqua&type=' + type + "&module=all#quanlyqua"; 
                }
                else{
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">               
                    <form id="frmSendChest" action="/?control=shopkimbai_hero&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
