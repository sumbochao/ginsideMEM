    ...
    $(document).ready(function () {
        ...
        $(document).ready(function() {
            ...
            function createHtml(){
                ...
                '<input id="item_id'+i+'" name="item_id'+i+'" type="text" value="1" class="span4 validate[required,custom[onlyNumberSp]]">'+
                '</div>'+
                '<div class="form-group span4">'+
                ...
                <div class="control-group frmedit totalchest">
                    <div class="group1">
                        <div class="form-group span4">
                            ...
                            <input id="item_id1" name="item_id1" type="text" value="1" class="span4 validate[required,custom[onlyNumberSp]]">
                            </div>
                        <div class="form-group span4">
