...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=gmtoolgopet&func=updatebossinfo_bossid";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php  echo $_GET['func']=='updatebossinfo_bossid'?'active':'';?>">
		<a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">BOSSINFO</a>
	</li>
  </ul>
