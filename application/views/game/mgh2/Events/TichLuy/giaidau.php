    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=tichluy_mgh2&func=themgiaidau&module=all#giaidau';
            });
        });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                {
                                    sTitle: "Phần trăm thưởng",
                                    mData: "reward_percent",
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=tichluy_mgh2&func=chinhsuagiaidau&id=" + data + "&module=all#giaidau'>Chỉnh Sửa</a>";
                                    }
