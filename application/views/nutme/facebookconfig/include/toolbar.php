<div class="header_toolbar">
    ...
    <div class="toolbar">
        <?php
            ...
            $lnkActive = "javascript:onSubmitForm('appForm','".base_url()."?control=".$_GET['control']."&func=status&type=multi&s=1".$game.$page."')";
            ...
            $lnkInActive = "javascript:onSubmitForm('appForm','".base_url()."?control=".$_GET['control']."&func=status&type=multi&s=0".$game.$page."')";
            ...
            if(!empty($_GET['idgame'])){
                $lnkAdd = base_url()."?control=".$_GET['control']."&func=add".$game;
            ...
            $lnkSave = "javascript:onSubmitForm('appForm','".base_url()."?control=".$_GET['control']."&func=".$_GET['func'].$id.$game.$page."&types=1')";
            ...
            $lnkSaveClose = "javascript:onSubmitForm('appForm','".base_url()."?control=".$_GET['control']."&func=".$_GET['func'].$id.$game.$page."')";
            ...
            $lnkCancel = base_url()."?control=".$_GET['control']."&func=index".$game.$page;
