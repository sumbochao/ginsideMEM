    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#update_reward').on('click', function () {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/edit_reward_name/?id=" + $('#reward').val() + "&reward_name=" + $('#reward_name_edit').val(),
            ...
            $('#add_new_reward').on('click', function () {
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/add_reward",
        ...
        function load_reward(tournament_id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/load_reward?tournament_id=" + tournament_id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    var obj = data;
                    var rewardlist = "";
        ...
        function load_reward_details(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/load_reward_details?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    //Load Reward Details  
                    if (data.length > 0) {
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=tulinhdan_dht&module=all&func=edit_reward_details" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Type: <input name="reward_item1_type" id="reward_item1_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Type: <input name="reward_item2_type" id="reward_item2_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Type: <input name="reward_item3_type" id="reward_item3_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Type: <input name="reward_item4_type" id="reward_item4_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            Type: <input name="reward_item5_type" id="reward_item5_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            Item ID: <input name="reward_item6_code"   id="reward_item6_code" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Số Lượng:   <input name="reward_item6_number" id="reward_item6_number" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Type: <input name="reward_item6_type"   id="reward_item6_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            Item ID: <input name="reward_item7_code"   id="reward_item7_code" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Số Lượng:   <input name="reward_item7_number" id="reward_item7_number" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Type: <input name="reward_item7_type"   id="reward_item7_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            Item ID: <input name="reward_item8_code"   id="reward_item8_code" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Số Lượng:   <input name="reward_item8_number" id="reward_item8_number" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Type: <input name="reward_item8_type"   id="reward_item8_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            Item ID: <input name="reward_item9_code"   id="reward_item9_code" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Số Lượng:   <input name="reward_item9_number" id="reward_item9_number" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Type: <input name="reward_item9_type"   id="reward_item9_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
                                ...
                                <div class="control-group frmedit">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            Item ID: <input name="reward_item10_code"   id="reward_item10_code" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Số Lượng:   <input name="reward_item10_number" id="reward_item10_number" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                            Type: <input name="reward_item10_type"   id="reward_item10_type" type="text" class="span3 validate[required,custom[onlyNumberSp]]" />
                                        </div>
                                    </div>                            
                                </div>
