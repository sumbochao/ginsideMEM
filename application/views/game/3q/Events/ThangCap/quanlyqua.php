    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=thangcap_3q&func=themqua&tournament_id=' + $("#tournament").val() + "&module=all#quanlyqua" ;
            });
            ...
            $.ajax({
             ...
             $("#tournament").change(function () {             
                window.location.href = "/?control=thangcap_3q&func=quanlyqua&tournament_id=" + $(this).val() + "&module=all#quanlyqua";
            });
        });
        
        function getData(tournament_id) {
            $.ajax({
                url: "http://game.mobo.vn/3q/cms/toolthangcap/gift_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               }, 
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=thangcap_3q&func=chinhsuaqua&id=" + data + "&tournament_id="+ $("#tournament").val() +"&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                    }
