    ...
    <script type="text/javascript">
        $(function () {
            $('#add_tournament').on('click', function () {
                window.location.href = '/?control=event_bongda_bog&func=themtrandau&module=all#trandau';
            });

            $("#tournament_id").change(function () {
                //getData($(this).val());
                window.location.href = "/?control=event_bongda_bog&func=trandau&module=all&tournament_id=" + $(this).val() + "#trandau";
            });
        });
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_bongda_bog&func=chinhsuatrandau&module=all&id=" + data + "#trandau'>Chỉnh Sửa</a> <a class='btn btn-success btn-xs' href='/?control=event_bongda_bog&func=ketquatrandau&module=all&id=" + data + "#trandau'>Cập nhật kết quả</a>";
                                    }
