...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=giaithuong#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=giaithuongtop#giaithuongtop";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vongquayhuyenao_pt&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT VÒNG QUAY HUYỀN ẢO</h4>   
<!-- Nav tabs -->
