    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$('#create_boxitem').on('click', function () {
                window.location.href ='?control=banca_buygem&func=add&view=item&module=all';
            });
        ...
        function getData() {
            $.ajax({
                url: "<?php echo $url;?>/event/buygem/getlistitem?type=item",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
							...
							?>
                            {
                                ...
                                mData: "idx",
                                mRender: function(data){
                                    return "<a href='?control=banca_buygem&func=edit&view=item&module=all&ids="+data+"'>Edit</a> <span style='padding-left:10px'></span>";
                                }
                            }
							<?php
								}
