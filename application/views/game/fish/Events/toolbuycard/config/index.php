    ...
    <script type="text/javascript">
        $(document).ready(function () {
           ...
           $('#create_boxitem').on('click', function () {
                window.location.href ='?control=fish_buycard&func=add&view=config';
            });
        ...
        function getData() {
            $.ajax({
                url: "<?php echo $url;?>/event/buycard/getlistitem?type=config",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
							...
							?>
                            {
                                ...
                                mRender: function(data){
                                    return "<a href='?control=fish_buycard&func=edit&view=config&ids="+data+"'>Edit</a></span>";
                                }
