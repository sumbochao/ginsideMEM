        ...
        <div id="adminfieldset">
            ...
            <div class="group_left">
            	<div class="rows">	
                    ...
                    <input type="text" name="partner" id="partner" class="textinput" value="<?php echo $items['partner'];?>"/>
                </div>
                <div class="rows">
                    <label for="menu_group_id">Url</label>
                    <input type="text" name="link_url" id="link_url" class="textinput" value="<?php echo $items['link_url'];?>"/>
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Ghi chú</label>
                    <textarea name="notes" maxlength="1000" id="notes" cols="30" rows="5" style="width:310px;height:150px;resize:none;"></textarea>
                </div>
