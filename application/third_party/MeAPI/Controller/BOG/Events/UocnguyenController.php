<?php
class MeAPI_Controller_BOG_Events_UocnguyenController implements MeAPI_Controller_BOG_Events_UocnguyenInterface {
    protected $_response;
    private $CI;
    private $url_service;
    ...
    public function __construct() {
        ...
        if($_SERVER['SERVER_ADDR']=='127.0.0.1'){
            ...
            $this->url_picture = 'http://localhost.service.bog.mobo.vn/bog/assets/uocnguyen';
        }else{
    ...
    public function index(MeAPI_RequestInterface $request){
        ...
        $this->data['slbServer'] = $this->CI->ServerModel->slbServerByGame('bog');
        $this->CI->template->write_view('content', 'game/bog/Events/uocnguyen/'.$_GET['view'].'/index', $this->data);
    ...
    public function add(MeAPI_RequestInterface $request){
        ...
        $this->data['url_service'] = $this->url_service;
        $this->data['url_picture'] = $this->url_picture;
        $this->CI->template->write_view('content', 'game/bog/Events/uocnguyen/'.$_GET['view'].'/add', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function history(MeAPI_RequestInterface $request){
        ...
        $this->CI->template->write_view('content', 'game/bog/Events/uocnguyen/history', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
	...
	public function history_item(MeAPI_RequestInterface $request){
        $this->authorize->validateAuthorizeRequest($request, 0); 
        $this->data['slbServer'] = $this->CI->ServerModel->slbServerByGame('bog');
        $this->CI->template->write_view('content', 'game/bog/Events/uocnguyen/history_item', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
