...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=gmtool&func=index";
        });

        $('#updateresult').on('click', function (e) {
            window.location.href = "/?control=gmtool&func=event";
        });
...
<h4 class="widget-name">QUẢN LÝ GMTOOL</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#" aria-controls="home" role="tab" data-toggle="tab">HISTORY SENDITEMS</a></li>
    <li role="presentation"><a id="updateresult" href="#" aria-controls="giaidau" role="tab" data-toggle="tab">EVENT SENDITEMS</a></li>
  </ul>
