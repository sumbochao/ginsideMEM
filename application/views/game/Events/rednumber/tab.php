...
<script>
    ...
    $(function () {
        $('#groups').on('click', function (e) {
            window.location.href = "/?control=rednumber&func=index&view=groups&module=all#groups";
        });
        $('#turns').on('click', function (e) {
            window.location.href = "/?control=rednumber&func=index&view=turns&module=all#turns";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=rednumber&func=history&module=all#history";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" <?php echo ($_GET['view'] == 'groups') ? 'class="active"' : ''; ?>><a id="groups" href="#groups" aria-controls="groups" role="tab" data-toggle="tab">NHÓM</a></li>
    <li role="presentation" <?php echo ($_GET['view'] == 'turns') ? 'class="active"' : ''; ?>><a id="turns" href="#turns" aria-controls="turns" role="tab" data-toggle="tab">LƯỢT</a></li>
