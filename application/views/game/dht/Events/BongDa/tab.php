...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=giaidau&module=all#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=trandau&module=all#trandau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=quanlyqua&module=all#quanlyqua";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=quanlycode&module=all#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=lichsu&module=all#lichsu";
        });
        
        $('#lichsudoiqua').on('click', function (e) {
            window.location.href = "/?control=event_bongda_dht&func=lichsudoiqua&module=all#lichsudoiqua";
        });
    });
</script>
<style>
