    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#comeback').on('click', function () {
                //window.location.href = '/?control=shopkimbai_dht&func=giaidau#giaidau';
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/giangma/cms/toolmoibannhanqua/edit_tournament",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            <h5 class="widget-name">
                                <i class=" ico-th-large"></i>CHỈNH SỬA EVENT</h5>
                            <div class="control-group">
                                <label class="control-label">Tên event:</label>
                                <div class="controls">
