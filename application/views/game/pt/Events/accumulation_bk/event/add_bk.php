                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="content_id" id="content_id" type="text" class="span3 validate[required]" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    Enable:<input type="radio" name="status" id="status" value="1" checked="">
                                    &nbsp;&nbsp;
                                    Disable:<input type="radio" name="status" id="status" value="0">
                                </div>
                            </div>
                            <div class="control-group">
