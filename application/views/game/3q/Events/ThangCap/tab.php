...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=thangcap_3q&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=thangcap_3q&func=giaidau&module=all#giaidau";
        });        
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=thangcap_3q&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT THĂNG CẤP NHẬN QUÀ</h4>   
<!-- Nav tabs -->
