...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_gio_vang&func=display&view=index&module=all&game=<?php echo $game;?>#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_gio_vang&func=display&view=quanlyqua&module=all&game=<?php echo $game;?>#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_gio_vang&func=display&view=lichsu&module=all&game=<?php echo $game;?>#lichsu";
        });
...
<h4 class="widget-name">QUẢN LÝ EVENT GIỜ VÀNG</h4>
<!-- Nav tabs -->
