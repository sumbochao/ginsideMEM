        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/baodanh/<?php echo $_GET['id']>0?'edit?id='.$_GET['id']:'add';?>",
                        ...
                        <div class="well form-horizontal">
                            ...
                            <?php
                                ...
                                if($_GET['id']>0){
                                    ...
                                    if(!empty($items['end'])){
                                        $start = date_format(date_create($items['end']),"d-m-Y G:i:s");
                                    }
                                }
                            ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <div style="font-style:italic;color: #999">Ví dụ : 169001,169002</div>
                                </div>
                            </div>
                            <div class="control-group">
