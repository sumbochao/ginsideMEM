    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=event_lato_eden&func=logdoiqua&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#logdoiqua";
            });

            $('#export_excel').on('click', function () {
                window.location.href = "http://service.eden.mobo.vn/cms/promotion_lato/export_excel_logdoiqua?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
            });
        ...
        function getData() {
            $(".loading").fadeIn("fast");
            $.ajax({
                url: "http://service.eden.mobo.vn/cms/promotion_lato/logdoiqua?startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
