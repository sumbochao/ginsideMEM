...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //cap 3
        $(".createdSubSub").on('click',function () {
            var idSub = $(this).attr('dataID');
                        ...
                        if (count($vrule) > 0) {
                            ...
                            foreach ($vrule as $kcon => $vcon) {
                                ...
                                <div class="sub_item_rule" id="sub_item_rule">
                                    ...
                                    <div class="btn btn-warning btncoppy" id="btncoppy" dataID="<?php echo $i; ?>" dataSubSub="<?php echo $j; ?>">Coppy List</div>
                                    ...
                                    <div class="subsublist countSubSublist_<?php echo $j; ?> coppygroup_<?php echo $i . $j; ?>">
                                        <?php
                                        if (count($vcon) > 0) {
                                            $z = 0;
                                            foreach ($vcon as $k => $v) {
                                                ...
                                                <div class="sub_item_rule" id="subsub_item_rule">
                                                    ...
                                                    <div class="rows">
                                                        ...
                                                        <div class="input"><input type="text" placeholder="Nhập Type" value="<?php echo $v['type']; ?>" name="type[<?php echo $i; ?>][<?php echo $j; ?>][<?php echo $z; ?>]" size="20" id="p_scnt"></div>
                                                    </div>
