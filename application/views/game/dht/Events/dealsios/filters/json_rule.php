    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            <div class="rows">
                ...
                <div class="input"><input type="text" placeholder="Số đợt" value="<?php echo $vrule['key']; ?>" name="key[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
                <div class="title">Tên:</div>
                <div class="input"><input type="text" placeholder="Tên" value="<?php echo $vrule['name']; ?>" name="keyname[<?php echo $i; ?>]" size="20"></div>
            </div>
            <div class="rows">
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Nhập Tên:</div>';
            html += '   <div class="input"><input type="text" size="20" name="keyname[' + x + ']" value="a" placeholder="Nhập Tên" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Bắt đầu:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="keystart[' + x + ']" value="<?php echo date('d-m-Y H:i:s');?>" placeholder="Ngày bắt đầu" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Kết thúc:</div>';
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="keyend[' + x + ']" value="<?php echo date('d-m-Y H:i:s');?>" placeholder="Ngày kết thúc" /></div>';
            html += '</div>';
