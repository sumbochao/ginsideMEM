...
<form action="" method="post" name="frmadd">
	<fieldset>
        ...
        <label for="alias">Link API GENARAL</label>
        <input type="text" name="apilink" id="apilink" value="<?php echo $apilink?>" class="textinput">
        <br><br>

        <label for="alias">Link API CHECK</label>
        <input type="text" name="apicheck" id="apicheck" value="<?php echo $apicheck?>" class="textinput">
        <br><br>
