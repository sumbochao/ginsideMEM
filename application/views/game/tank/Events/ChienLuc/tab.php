...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=chienluc_tank&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=chienluc_tank&func=giaidau&module=all#giaidau";
        });        
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=chienluc_tank&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT QUÀ CHIẾN LỰC</h4>   
<!-- Nav tabs -->
