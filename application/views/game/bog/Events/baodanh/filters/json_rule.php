    ...
    <div id="p_scents">
        ...
        <div class="item_rule" id="item_rule_<?php echo $i; ?>">
            <div class="rows">
                ...
                <div class="input"><input type="text" placeholder="Nhập Key" value="<?php echo $vrule['key']; ?>" name="keyrule[<?php echo $i; ?>]" size="20" id="p_scnt"></div>
            </div>
            <div class="rows">
                <div class="title">Nhập Date:</div>
                <div class="input"><input type="text" placeholder="Nhập Date" value="<?php echo $vrule['keydate']; ?>" name="keydate[<?php echo $i; ?>]" size="20" class="date"></div>
            </div>
            <div class="rows">
...
<script>
    $(function () {
        ...
        $('.rule_item').on('click','#addScnt', function () {
            ...
            html += '   <div class="input"><input type="text" id="p_scnt" size="20" name="keyrule[' + x + ']" value="1" placeholder="Nhập Key" /></div>';
            html += '</div>';
            html += '<div class="rows">';
            html += '   <div class="title">Nhập Date:</div>';
            html += '   <div class="input"><input type="text" class="date" size="20" name="keydate[' + x + ']" value="<?php echo date('d-m-Y');?>" placeholder="Nhập Date" /></div>';
            html += '</div>';
            html += '<div class="rows">';
