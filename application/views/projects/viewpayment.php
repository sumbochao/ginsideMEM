         ...
         <form id="frmapp" name="frmapp" enctype="multipart/form-data" method="post" action="<?php echo base_url()."?control=projects&func=viewpayment&id_projects=".$_GET['id_projects']; ?>">
 		 <div id="adminfieldset" class="groupsignios" style="width:100%;margin-bottom:0;margin-top:10px;">
            ...
            <div class="group_left">
            	<div class="rows">
                <table class="table" style="width:700px;margin-bottom:0;">
                	<th>MCOIN</th>
                    <th>KNB</th>
                    <th>ĐƠN VỊ</th>
                    <th></th>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="units" id="units" class="textinput" style="width:100px;text-align:center;" placeholder="Đơn vị" value="<?php echo $getrate['units']==""?"KNB":$getrate['units']; ?>" /></td>
                        <td style="vertical-align:top;"><input type="submit" name="btn_update_rate" id="btn_update_rate" value="Cập nhật" class="btnB btn-primary" onclick="updaterate();"/>
                        </td>
						<td>Nếu Game không có tỷ lệ. Vui lòng nhập 0:0</td>
                    </tr>
                    <!--<tr>
            ...
            <div class="group_left">
            	<div class="rows">
               			...
               			<select name="cbo_type" id="cbo_type" style="width:80px;">
                            ...
                            <option value="ibanking">Banking</option>
                        ...
                        <input type="text" name="gem" id="gem" class="textinput" style="width:120px;" placeholder="knb" onkeypress="return checkInp('gem');" onkeydown="return checkInp('gem');"/>         				<input type="text" name="promotion_gem" id="promotion_gem" class="textinput" style="width:120px;" placeholder="Promotion knb" onkeypress="runScript(event);" onkeydown="return checkInp('promotion_gem');" />
      ...
      <div id="adminfieldset" class="groupsignios" style="width:100%;">
            ...
            <div class="group_left">
            	<div class="rows">
                        ...
                        <select name="cbo_package" id="cbo_package" style="width:100px;" onchange="setvaluestotext(this.value);">
                        ...
                        <input type="text" name="code_inapp" id="code_inapp" class="textinput" style="width:200px;" placeholder="Names" onkeypress="runScriptplus(event);"  />
       ...
       <!--End Add stype:inapp item-->
         ...
         <form name="frmlist" id="frmlist" enctype="multipart/form-data" method="post" action="<?php echo base_url()."?control=projects&func=viewpayment&id_projects=".$_GET['id_projects']; ?>" >
			<?php if($_SESSION['account']['id']=='56'){ ?>
		 <input class="btnB btn-primary" type="submit" value="Đồng bộ dữ liệu sang hệ thống Payment" name="btn_update_system_payment" id="btn_update_system_payment" />
<input type="hidden" name="btn_json" id="btn_json" />
			<?php } ?>
<table style="float:left;" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            <thead>
                <tr>
                     ...
                     <select name="cbofp" id="cbofp" onchange="setrowsplatform(this.value);" style="width:80px">
            ...
            <tbody>
                ...
                <tr id="row_<?php echo $v['id'];?>" class="row_tab">
                    ...
                    <input type="text" name="cbo_type_e_<?php echo $v['id'];?>" id="cbo_type_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['type'];?>" style="width:85px;" readonly="readonly" />
                   </td>
                    ...
                    <td id="td_control_<?php echo $v['id']  ?>" class="cControll">
                    <div id="td_text_<?php echo $v['id']  ?>" class="cText"><?php echo $v['vnd']==""?0:number_format(trim(floor($v['vnd'])));?></div>
                 ...
                 <td id="td_control_<?php echo $v['id']  ?>" class="cControll">
                 <div id="td_text_<?php echo $v['id']  ?>" class="cText"><?php echo $v['mcoin']==""?0:number_format(trim(floor($v['mcoin'])));?></div>
                 ...
                 <td id="td_control_<?php echo $v['id']  ?>" class="cControll">
                 <div id="td_text_<?php echo $v['id']  ?>" class="cText"><?php echo $v['gem']==""?0:number_format(trim(floor($v['gem'])));?></div>
                 <input type="text" name="gem_e_<?php echo $v['id'];?>" id="gem_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo floor($v['gem']);?>"style="width:80px;" onkeypress="return checkInp('gem_e_<?php echo $v['id'];?>');" onkeydown="return checkInp('gem_e_<?php echo $v['id'];?>');"  /></td>
		...
		$.ajax({
                ...
                success:function(f){
					if(f.error==0){
						...
						$("ol li").remove();
						//dong bo data
						//callapipayment(<?php echo $_GET['id_projects'];?>);
						//
...
function updaterows(id,code_e,promotion_gem_e,gem_e,mcoin_e,vnd_e,notes_e){
	...
	if(c){
		...
		$.ajax({
                ...
                type:"GET",
				data:{id:id,code_e:code_e,promotion_gem_e:promotion_gem_e,gem_e:gem_e,mcoin_e:mcoin_e,vnd_e:vnd_e,notes_e:notes_e,id_projects:<?php echo $_GET['id_projects'];?>},
                async:false,
				dataType:"html",
                beforeSend:function(){
                    $('.loading_warning').show();
...
//send data payment
function callapipayment(id_projects){
	$.ajax({
		url:baseUrl+'?control=projects&func=callapipayment',
		type:"GET",
...
function setvaluestotext(val){
	var str=val.split(';');
	$('#code_inapp').val(str[0]);
