                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="content_id" id="content_id" value="<?php echo $items['content_id'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Email title:</label>
                            <div class="controls">
                                <input name="email_title" id="email_title" value="<?php echo $items['email_title'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Email message:</label>
                            <div class="controls">
                                <input name="email_message" id="email_message" value="<?php echo $items['email_message'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
