    ...
    <script type="text/javascript">
        $(document).ready(function () {
			...
			$('#create_boxitem').on('click', function () {
                window.location.href ='?control=fish_buygem&func=add&view=item&module=all';
            });
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
							...
							?>
                            {
                                ...
                                mData: "idx",
                                mRender: function(data){
                                    return "<a href='?control=fish_buygem&func=edit&view=item&module=all&ids="+data+"'>Edit</a> <span style='padding-left:10px'></span>";
                                }
                            }
							<?php
								}
