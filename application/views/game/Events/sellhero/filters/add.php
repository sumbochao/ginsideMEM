                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="price" id="price" value="<?php echo $items['price'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Selltimes:</label>
                            <div class="controls">
                                <input name="selltimes" id="selltimes" value="<?php echo $items['selltimes'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="createday" id="createday" value="<?php echo $items['createday'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
