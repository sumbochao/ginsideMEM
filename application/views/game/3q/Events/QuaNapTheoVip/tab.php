...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=quanaptheovip_3q&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=quanaptheovip_3q&func=giaidau&module=all#giaidau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=quanaptheovip_3q&func=quanlyqua&module=all#quanlyqua";
        });

        $('#yeucaunap').on('click', function (e) {
            window.location.href = "/?control=quanaptheovip_3q&func=yeucaunap&module=all#yeucaunap";
        });
        
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=quanaptheovip_3q&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT QUÀ NẠP THEO VIP</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="yeucaunap" href="#yeucaunap" aria-controls="yeucaunap" role="tab" data-toggle="tab">YÊU CẦU NẠP</a></li>   
