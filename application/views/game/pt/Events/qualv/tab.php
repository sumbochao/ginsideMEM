...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "?control=qualv&func=index&view=item";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "?control=qualv&func=index&view=wheel";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "?control=qualv&func=index&view=filter";
        });
		$('#history').on('click', function (e) {
            window.location.href = "?control=qualv&func=history&view=history";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT LEVEL</h4>
<!-- Nav tabs -->
