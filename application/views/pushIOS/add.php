        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "<?php echo $url_service;?>/api/pushChrome",
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <input type="hidden" name="domain_name" class="domain_name" value=""/>
                        <script>
                            $(function() {
                                var element = $(this).find('option:selected').attr("itemname"); 
                                $(".domain_name").val(element);
                                $(".domain").change(function(){ 
                                    element = $(this).find('option:selected').attr("itemname");
                                    $(".domain_name").val(element);
                                });                                
                            }); 
                        </script>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="title" id="title" value="" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Notification icon:</label>
                            <div class="controls">
                                <input name="icon" placeholder="https://mu.gate.vn/assets/templates/muvietnam.mobo.vn/master/uyRLnB/assets/images/age-limit.png" id="icon" value="" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Notification Image:</label>
                            <div class="controls">
                                <input name="image" id="image" value="" placeholder="https://mu.gate.vn/assets/templates/muvietnam.mobo.vn/pages/nbEZOU/assets/images/page2-c2.png" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Notification body:</label>
                            <div class="controls">
                                <input name="body" id="body" value="" type="text" placeholder="Insert here a body" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Notification URL:</label>
                            <div class="controls">
                                <input name="url" id="url" value="" type="text" placeholder="Insert here an URL" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Notification delay:</label>
                            <div class="controls">
                                <input name="delay" id="delay" value="5" type="number" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Time To Live:</label>
                            <div class="controls">
                                <input name="ttl" id="ttl" value="0" type="number" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
