                ...
                aoColumns: [
                    ...
                    },
                    {
                        ...
                        mRender: function (id, arg1, arg2) {
                            return "<a class='btn btn-success btn-xs' href=' /?control=<?php echo $control;?>&func=showAddConfig&game=<?php echo $game;?>&id=" + id + "&name="+arg2.name + "&server_list="+arg2.server_list + "&status="+arg2.status + "&article_id="+arg2.article_id + "&date_start="+arg2.date_start + "&date_end="+arg2.date_end + "&is_tester="+arg2.is_tester + "&is_tester="+arg2.is_tester +"#home '>Chỉnh Sửa</a>";
                        }
