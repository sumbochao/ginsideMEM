    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=shopkimbai_bog&func=themgiaidau&module=all#giaidau';
            });
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "http://game.mobo.vn/bog/cms/toolshopkimbai/edit_tournament_details",
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/bog/cms/toolshopkimbai/tournament_list",
        ...
        function load_tournament_detail(id) {
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/bog/cms/toolshopkimbai/tournament_get_by_id?id=" + id,
                contentType: 'application/json; charset=utf-8',
                success: function (data) {
                    $("#id").val(data[0]["id"]);
