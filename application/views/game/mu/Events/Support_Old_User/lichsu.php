    ...
    <script type="text/javascript">
        $(function () {
            $("#tournament_id").change(function () {
                //getData($(this).val());
                window.location.href = "/?control=support_old_user_mu&module=all&func=lichsu&tournament_id=" + $(this).val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#lichsu";
            });
        });
        ...
        $(document).ready(function () {
            ...
            $('#create_boxitem').on('click', function () {
                window.location.href = "/?control=support_old_user_mu&module=all&func=lichsu&tournament_id=" + $("#tournament_id").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "#lichsu";
            });

//            $('#export_excel').on('click', function () {
//                window.location.href = "http://game.mobo.vn/mu/cms/toolsupport_old_user/get_exchange_history_excel?tournament_id=" + $("#tournament_id").val() + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val();
//            });
        ...
        function getData(tournament_id) {
            $("#loading_img").show();
            $.ajax({
                url: "http://game.mobo.vn/mu/cms/toolsupport_old_user/get_exchange_history?tournament_id=" + tournament_id + "&startdate=" + $("#startdate").val() + "&enddate=" + $("#enddate").val() + "&pagesize=10000",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                                ...
                                {
                                    sTitle: "Ngày tạo nhân vật",
                                    mData: "create_time_char",
                                },
                                {
                                    sTitle: "Trạng Thái",
                                    mData: "status",
