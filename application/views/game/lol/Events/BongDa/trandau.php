    ...
    <script type="text/javascript">
        $(function () {
            $('#add_tournament').on('click', function () {
                window.location.href = '/?control=event_bongda_lol&func=themtrandau&module=all#trandau';
            });

            $("#tournament_id").change(function () {
                //getData($(this).val());
                window.location.href = "/?control=event_bongda_lol&func=trandau&module=all&tournament_id=" + $(this).val() + "#trandau";
            });
        });
        ...
        function getData(tournament_id) {
            $.ajax({
                url: "<?php echo $url_service;?>/cms/toolbongda/match_list?tournament_id=" + tournament_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=event_bongda_lol&func=chinhsuatrandau&module=all&id=" + data + "#trandau'>Chỉnh Sửa</a> <a class='btn btn-success btn-xs' href='/?control=event_bongda_lol&func=ketquatrandau&module=all&id=" + data + "#trandau'>Cập nhật kết quả</a>";
                                    }
