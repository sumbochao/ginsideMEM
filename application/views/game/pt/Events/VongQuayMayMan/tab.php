...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=giaithuong#giaithuong";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=vongquaymayman_pt&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT VÒNG QUAY MAY MẮN</h4>   
<!-- Nav tabs -->
