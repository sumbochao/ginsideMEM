    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=tulinhdan_dht&func=themqua&type=' + $("#gifttype").val() + "&module=all#quanlyqua" ;
            });
            ...
            $.ajax({
             ...
             $("#gifttype").change(function () {             
                window.location.href = "/?control=tulinhdan_dht&func=quanlyqua&type=" + $(this).val() + "&module=all#quanlyqua";
            });
        });
        
        function getData(type_id) {
            $.ajax({
                url: "http://game.mobo.vn/onepiece/cms/tooltulinhdan/gift_list?id=" + type_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=tulinhdan_dht&func=chinhsuaqua&id=" + data + "&type="+ $("#gifttype").val() +"&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                    }
