    ...
    <div id="addScnt" class="btn btn-success">Thêm rule</div>
        ...
        <div class="item_rule" id="item_rule_<?php echo $i;?>">
            <div class="rows">
                ...
                <div class="input"><input type="text" id="p_scnt" size="20" value="<?php echo $vrule['name'];?>" name="keyname[<?php echo $i;?>]"  placeholder="Nhập tên"></div>
            </div>
            <div class="rows">
                <div class="title">Vip:</div>
                <div class="input"><input type="text" id="p_scnt" size="20" value="<?php echo $vrule['vip'];?>" name="keyvip[<?php echo $i;?>]"  placeholder="Nhập vip"></div>
            </div>
            <div class="rows">
                <div class="title">Số tiền:</div>
                <div class="input"><input type="text" id="p_scnt" size="20" value="<?php echo $vrule['money'];?>" name="keymoney[<?php echo $i;?>]"  placeholder="Nhập số tiền"></div>
            </div>
   ...
   $(function() {
        ...
        $('#addScnt').live('click', function() {
            ...
            var html = '<div class="item_rule">';
                ...
                html +='</div>';
                html +='<div class="rows">';
                    html +='<div class="title">Vip:</div>';
                    html +='<div class="input"><input type="text" id="p_scnt" size="20" name="keyvip['+x+']" value="1" placeholder="Nhập vip" /></div>';
                html +='</div>';
                html +='<div class="rows">';
                    html +='<div class="title">Số tiền:</div>';
                    html +='<div class="input"><input type="text" id="p_scnt" size="20" name="keymoney['+x+']" value="0" placeholder="Nhập số tiền" /></div>';
                html +='</div>';
