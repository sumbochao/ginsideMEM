...
<form action="" method="post" name="frmadd" enctype="multipart/form-data">
	...
	<fieldset>
		...
		<input type="text" name="name" id="name" value="<?php echo $configid['game'];?>" class="textinput">
        <br/>
        <br/>
        ...
        <br/>
		<br>
        <label for="alias">Link Domain</label>
        <input type="text" name="linkdomain" id="linkdomain" value="<?php echo $configid['domain'];?>" class="textinput">
        <br><br>
