    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=shopnganluong_mgh2&func=themgiaidau&module=all#giaidau';
            });
        });

        function getData() {
            $.ajax({
                url: "http://game.mobo.vn/mgh2/cms/toolshopnganluong/tournament_list",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                                 ...
                                 },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a class='btn btn-success btn-xs' href='/?control=shopnganluong_mgh2&func=chinhsuagiaidau&id=" + data + "&module=all#giaidau'>Chỉnh Sửa</a>";
                                    }
