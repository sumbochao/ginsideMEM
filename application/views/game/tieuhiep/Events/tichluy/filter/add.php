...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#comeback').on('click',function(){
            window.location.href ='/cms/ep/accumulation_weekly/index?view=filter';
        });
        ...
        $('#onSubmit').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/accumulation_weekly/<?php echo ($_GET['ids']>0)?'edit_filter?ids='.$_GET['ids']:'add_filter';?>",
                    ...
                    <div class="widget row-fluid">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="start" type="datetime" value="<?php echo $start;?>" class="start timepicker2 span3 validate[required]" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">End datetime:</label>
                                <div class="controls">
                                    <input name="end" type="datetime" value="<?php echo $end;?>" class="end span3 timepicker2 validate[required]" />
                                </div>
                            </div>
                            <div class="control-group">
