...
class MeAPI_Controller_PT_Events_GoiquavipController implements MeAPI_Controller_PT_Events_GoiquavipInterface {
    ...
    private $url_process = "http://game.mobo.vn/phongthan/cms/toolgoiquavip/";
...
//        $this->data['config'] = json_decode($config) ;
        ...
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/index', $this->data);
    ...
    public function quanlyqua(MeAPI_RequestInterface $request) {
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/quanlyqua', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function themqua(MeAPI_RequestInterface $request) {
        ...
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/themqua', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function showAddConfig(MeAPI_RequestInterface $request) {
        ...
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/addConfig', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function lichsu(MeAPI_RequestInterface $request){
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/lichsu', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function log_nap_tien(MeAPI_RequestInterface $request){
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/pt/Events/GoiQuaVip/log_nap_tien', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
