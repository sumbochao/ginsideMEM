...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_minigame_bog&func=index&module=all#home";
        });
        
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_minigame_bog&func=lichsu&module=all#lichsu";
        });
        
        $('#lichsupay').on('click', function (e) {
            window.location.href = "/?control=event_minigame_bog&func=lichsupay&module=all#lichsupay";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT MINIGAME</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">ĐÓNG MỞ EVENT</a></li>
        <li role="presentation"><a id="lichsu" href="#lichsu" aria-controls="lichsu" role="tab" data-toggle="tab">LỊCH SỬ QUÀ ĐỀN BÙ</a></li>
    <li role="presentation"><a id="lichsupay" href="#lichsupay" aria-controls="lichsupay" role="tab" data-toggle="tab">LỊCH SỬ QUÀ VIP</a></li>
  </ul>
