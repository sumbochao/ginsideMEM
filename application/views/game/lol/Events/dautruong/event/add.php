        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/dautruong/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        <?php
                            ...
                            $open_start = date('d-m-Y G:i:s',time());
                            $open_end = date('d-m-Y G:i:s',time());
                            if($_GET['id']>0){
                                ...
                                if(!empty($items['open_start'])){
                                    $open_start = date_format(date_create($items['open_start']),"d-m-Y G:i:s");
                                }
                                if(!empty($items['open_end'])){
                                    $open_end = date_format(date_create($items['open_end']),"d-m-Y G:i:s");
                                }
                            }
                        ?>
                        ...
                        <div class="control-group">
                            <label class="control-label">Bắt đầu đấu trường:</label>
                            <div class="controls">
                                <input type="text" class="datetime" name="open_start" value="<?php echo $open_start;?>"/>
                            </div>
                        </div>

                        <div class="control-group">
                            <label class="control-label">Kết thúc đấu trường:</label>
                            <div class="controls">
                                <input type="text" class="datetime" name="open_end" value="<?php echo $open_end;?>"/>
                            </div>
                        </div>
                        <div class="control-group">
