...
<script>
    ...
    $(function () {        
       $('#giftcodemobo').on('click', function (e) {
            window.location.href = "/?control=giftcodemobo_koa&func=index&module=all";
        });
		$('#history').on('click', function (e) {
            window.location.href = "/?control=giftcodemobo_koa&func=history&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="<?php  echo $_GET['func']=='index'?'active':'';?>"><a id="giftcodemobo" href="#giftcodemobo" aria-controls="giftcodemobo" role="tab" data-toggle="tab">CẤU HÌNH</a></li>
	<li role="presentation" class="<?php  echo $_GET['func']=='history'?'active':'';?>"><a id="history" href="#" aria-controls="history" role="tab" data-toggle="tab">HISTORY</a></li>
</ul>
