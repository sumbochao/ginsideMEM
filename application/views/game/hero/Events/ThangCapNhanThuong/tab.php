...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=thangcapnhanthuong_hero&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=thangcapnhanthuong_hero&func=giaidau&module=all#giaidau";
        });

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=thangcapnhanthuong_hero&func=quanlyqua&module=all#quanlyqua";
        });

        $('#quanlyquaattach').on('click', function (e) {
        ...
        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=thangcapnhanthuong_hero&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT THĂNG CẤP NHẬN THƯỞNG</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="quanlyquaattach" href="#quanlyquaattach" aria-controls="quanlyquaattach" role="tab" data-toggle="tab">QUẢN LÝ QUÀ ĐI KÈM</a></li>
