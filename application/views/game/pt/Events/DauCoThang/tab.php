...
<script>
    ...
    $(function () {        
        /*$('#home').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_thang&func=index#home";
        });*/

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_thang&func=lichsu#lichsu";
        });
		$('#lichsu_package').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_thang&func=lichsu_package#lichsu_package";
        });
		 $('#log_nap_tien').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_thang&func=log_nap_tien#log_nap_tien";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT ĐẦU CƠ LV</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation"><a id="lichsu_package" href="#lichsu_package" aria-controls="lichsu_package" role="tab" data-toggle="tab">LỊCH SỬ Package</a></li>
	<li role="presentation"><a id="log_nap_tien" href="#log_nap_tien" aria-controls="log_nap_tien" role="tab" data-toggle="tab">LOG NẠP TIỀN</a></li>
  </ul>
