...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=doden_luckyuser&module=all&func=index#home";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=doden_luckyuser&module=all&func=lichsu#lichsu";
        });
        $('#tylekhuyenmai').on('click', function (e) {
            window.location.href = "/?control=doden_luckyuser&module=all&func=tylekhuyenmai#tylekhuyenmai";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT LUCKY USER</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
    <!--<li role="presentation"><a id="lichsu" href="#lichsu" aria-controls="lichsu" role="tab" data-toggle="tab">LỊCH SỬ NHẬN QUÀ</a></li>-->
    <li role="presentation"><a id="tylekhuyenmai" href="#tylekhuyenmai" aria-controls="lichsu" role="tab" data-toggle="tab">CHỈNH SỬA TỶ LỆ KHUYẾN MÃI</a></li>
  </ul>
