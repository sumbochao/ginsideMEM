        ...
        <div id="adminfieldset">
            ...
            <div class="group_left">
            	<div class="rows">	
                    ...
                    <input type="text" name="txt_sdk_version" id="txt_sdk_version" class="textinput" value="<?php echo $items['txt_sdk_version'];?>"/>
                </div>
                <div class="rows">	
                ...
                <div class="rows">	
                    ...
                    <textarea name="notes" maxlength="125" id="notes" cols="30" rows="5" style="width:310px;height:150px;resize:none;"></textarea>
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Duyệt</label>
                    <input type="radio" name="status" id="status_off" value="0" /> Tắt 
                    <input type="radio" name="status" id="status_on" value="1" checked /> Bật
                </div>
