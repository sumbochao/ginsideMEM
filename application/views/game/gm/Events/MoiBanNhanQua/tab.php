...
<script>
    ...
    $(function () {
        $('#home').on('click', function (e) {
            window.location.href = "/?control=moibannhanqua_gm&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=moibannhanqua_gm&func=giaidau&module=all#giaidau";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=moibannhanqua_gm&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT MỜI BẠN NHẬN QUÀ</h4>   
<!-- Nav tabs -->
