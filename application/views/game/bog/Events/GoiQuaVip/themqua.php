...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/bog/Events/GoiQuaVip/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=bog_event_goi_qua_vip&func=add_gift" method="POST" enctype="multipart/form-data">
