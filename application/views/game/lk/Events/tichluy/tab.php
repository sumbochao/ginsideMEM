...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "?control=accumulation_weekly&func=index&view=item";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "?control=accumulation_weekly&func=index&view=wheel";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "?control=accumulation_weekly&func=index&view=filter";
        });
    });
</script>
<style>
...
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">ITEMS MANAGER</a></li>
    <li role="presentation"><a id="giaidau" href="#giaidau" aria-controls="giaidau" role="tab" data-toggle="tab">WHEEL MANAGER</a></li>
    <li role="presentation"><a id="trandau" href="#trandau" aria-controls="trandau" role="tab" data-toggle="tab">FILTER MANAGER</a></li>
  </ul>
