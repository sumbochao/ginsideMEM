...
<script>
    ...
    $(function () {        
        $('#history').on('click', function (e) {
            window.location.href = "/?control=crosssale_bog&func=history&module=all#history";
        });
		$('#report').on('click', function (e) {
            window.location.href = "/?control=crosssale_bog&func=report&module=all#report";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="history" href="#history" aria-controls="history" role="tab" data-toggle="tab">Lịch sử</a></li>
	<li role="presentation" class=""><a id="report" href="#report" aria-controls="report" role="tab" data-toggle="tab">Thống Kê</a></li>
</ul>
