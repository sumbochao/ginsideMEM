    ...
    <div id="addScnt" class="btn btn-success">Thêm rule</div>
        ...
        <div class="item_rule" id="item_rule_<?php echo $i;?>">
            ...
            <script>
                $(function() {
                    //cap 2
                    var y=<?php echo count($vrule);?>;
                    $('#addVar_<?php echo $i;?>').live('click', function() { 
                        y++;
                        var keyrule_<?php echo $i;?> = $(this).attr('keyrule_<?php echo $i;?>');
                         var subhtml = '<div id="sub_item_rule" class="sub_item_rule">';
                                subhtml += '<div class="rows" style="display:none">'; 
                                    ...
                                    subhtml += '<div class="input">';
                                        subhtml += '<input type="text" id="p_scnt" size="20" name="from['+keyrule_<?php echo $i;?>+']['+y+']" value="1" placeholder="Nhập from" />';
                                    subhtml += '</div>';
                                subhtml += '</div>';
                                subhtml += '<div class="rows" style="display:none">'; 
                                    subhtml += '<div class="title">To</div>'; 
                                    subhtml += '<div class="input">';
                                        subhtml += '<input type="text" id="p_scnt" size="20" name="to['+keyrule_<?php echo $i;?>+']['+y+']" value="1" placeholder="Nhập to" />';
                                    subhtml += '</div>';
                                subhtml += '</div>';
                             subhtml += '<div id="remVar" class="btn btn-danger">Remove</div>';
                             subhtml +='<div class="clr" style="display:none"></div>';
                             subhtml +='<div id="addVarSub_<?php echo $i;?>" rulecondition_'+y+'="'+y+'" condition_add="'+y+'" condition_'+y+'="'+y+'"  class="btn_addsubsub btn btn-info">Thêm items add</div><div class="subsublist"></div>';
                         subhtml += '</div>';
            ...
            <div class="btn_addsub btn btn-warning" keyrule_<?php echo $i;?>="<?php echo $i;?>" id="addVar_<?php echo $i;?>">Thêm loại</div>
            <div class="sublist">
                <?php
                    if(count($vrule)>0){
                        $j=0;
                ...
                <div class="sub_item_rule" id="sub_item_rule">
                    ...
                    <script>
                        $(function() {
                            //cap 3
                            var z=<?php echo count($vcon);?>;
                            $('#item_rule_<?php echo $i;?> #addVarSub_<?php echo $j;?>').live('click', function() {
                                if($(this).attr('condition_<?php echo $j;?>')==undefined){
                                    var condition_<?php echo $j;?> = $(this).attr('condition_add');
                                }else{
                                    var condition_<?php echo $j;?> = $(this).attr('condition_<?php echo $j;?>');
                                }
                                z++;
                                 var subhtml = '<div id="subsub_item_rule" class="sub_item_rule">';
                                        subhtml += '<div class="rows">'; 
                                            ...
                                            subhtml += '<div class="input">';
                                                subhtml += '<input type="text" id="p_scnt" size="20" name="item_id['+<?php echo $i;?>+']['+condition_<?php echo $j;?>+']['+z+']" value="1" placeholder="Nhập Item ID" />';
                                            subhtml += '</div>';
                                        subhtml += '</div>';
                                        subhtml += '<div class="rows">'; 
                                            subhtml += '<div class="title">Name</div>'; 
                                            subhtml += '<div class="input">';
                                                subhtml += '<input type="text" id="p_scnt" size="20" name="name['+<?php echo $i;?>+']['+condition_<?php echo $j;?>+']['+z+']" value="1" placeholder="Nhập Item Name" />';
                                            subhtml += '</div>';
                                        subhtml += '</div>';
                                        subhtml += '<div class="rows">'; 
                                            subhtml += '<div class="title">Count</div>'; 
                                            subhtml += '<div class="input">';
                                                subhtml += '<input type="text" id="p_scnt" size="20" name="count['+<?php echo $i;?>+']['+condition_<?php echo $j;?>+']['+z+']" value="1" placeholder="Nhập Count" />';
                                            subhtml += '</div>';
                                        subhtml += '</div>';
                                        subhtml += '<div class="rows">'; 
                                            subhtml += '<div class="title">Rate</div>'; 
                                            subhtml += '<div class="input">';
                                                subhtml += '<input type="text" id="p_scnt" size="20" name="rate['+<?php echo $i;?>+']['+condition_<?php echo $j;?>+']['+z+']" value="1" placeholder="Nhập Rate" />';
                                            subhtml += '</div>';
                                        subhtml += '</div>';
                    ...
                    <div class="btn_addsubsub btn btn-info" condition_<?php echo $j;?>="<?php echo $j;?>" rulecondition_<?php echo $j;?>="<?php echo $j;?>" id="addVarSub_<?php echo $j;?>">Thêm items</div>
