...
<script>
    ...
    $(function () {
        ...
        $('#home').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_dptk&module=all&func=giaidau#giaidau";
        });
        ...
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_dptk&module=all&func=quanlyqua#quanlyqua";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=choinapmhknhanknb_dptk&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT CHƠI VÀ NẠP MHK NHẬN KNB</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="giaidau" href="#giaidau" aria-controls="giaidau" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
