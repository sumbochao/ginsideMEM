...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=bog_event_goi_qua_vip&func=index&module=all#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=bog_event_goi_qua_vip&func=quanlyqua&module=all#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=bog_event_goi_qua_vip&func=lichsu&module=all#lichsu";
        });
