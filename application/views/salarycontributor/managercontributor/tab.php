...
<script>
    ...
    $(function () {
        ...
        $('#home').on('click', function (e) {
            ...
            window.location.href = "/?control=managercontributor&func=index#home";
        });
        ...
        $('#lichsu').on('click', function (e) {
            ...
            window.location.href = "/?control=managercontributor&func=historyuser#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ CỘNG TÁC VIÊN</h4>   
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">QUẢN LÝ</a></li>
    <li role="presentation"><a id="lichsu" href="#lichsu" aria-controls="lichsu" role="tab" data-toggle="tab">LỊCH SỬ ĐỀ XUẤT - CHỈNH SỬA</a></li>
</ul>
