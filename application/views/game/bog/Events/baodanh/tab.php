...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=baodanh_bog&func=index&view=event&module=all";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=baodanh_bog&func=index&view=filters&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=baodanh_bog&func=index&view=history&module=all";
        });
        $('#user').on('click', function (e) {
            window.location.href = "/?control=baodanh_bog&func=index&view=user&module=all";
        });
        $('#baodanh').on('click', function (e) {
            window.location.href = "/?control=baodanh_bog&func=index&view=baodanh&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo $_GET['view']=='filters'?'class="active"':'';?>><a id="filters" href="#filters" aria-controls="filters" role="tab" data-toggle="tab">XEM QUÀ</a></li>
    ...
    <li role="presentation" <?php echo $_GET['view']=='user'?'class="active"':'';?>><a id="user" href="#user" aria-controls="user" role="tab" data-toggle="tab">BÁO DANH NHẬN QUÀ</a></li>
    <li role="presentation" <?php echo $_GET['view']=='baodanh'?'class="active"':'';?>><a id="baodanh" href="#baodanh" aria-controls="baodanh" role="tab" data-toggle="tab">BÁO DANH THAM GIA</a></li>
</ul>
