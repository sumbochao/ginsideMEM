...
<table style="float:left;" width="100%" border="0" class="table table-striped table-bordered table-condensed table-hover" id="tblsort">
            <thead>
                <tr>
                    ...
                    <th align="center" width="80px" class="store_id">Store ID</th>
                    <th align="center" width="80px" class="park_id">Park ID</th>
                    <th align="center" width="100px">In-App Items</th>
                     <th align="center" width="100px" class="android">Public Key</th>
					 <th align="center" width="100px" class="wp">Wp(Protocol)</th>
                    ...
                    <th align="center" width="100px" class="wp">Wp(Properties)</th>
                     ...
                     <th align="center" width="100px" style="background-color:#E66B6B">ReportWithConversionID</th>
                     <th align="center" width="100px" style="background-color:#E66B6B">Label</th>
                     <th align="center" width="50px" style="background-color:#E66B6B">Value</th>
                     <th align="center" width="50px" style="background-color:#E66B6B">IsRepeatable</th>
                     <th align="center" width="70px" style="background-color:#3b5998">Facebook AppID</th>
                     <th align="center" width="70px" style="background-color:#3b5998">Facebook AppSecret</th>
                     <th align="center" width="70px" style="background-color:#3b5998">Facebook Schemes</th>
					 <th align="center" width="70px" style="background-color:#3b5998">Link CDN Client</th>
				...
				$i=0;
                    if(count($list)>0){
                        foreach($list as $i=>$v){
							$i++;
							//googleproductapi
							$googleadword=explode(";",$v['googleproductapi']);
                ?>
                <tr id="row_<?php echo $v['id'];?>" class="row_tab" title='BundleID/PackageName/PackageIdentity:[<?php echo $v['package_name'];?>]
 Loại: <?php echo $v['cert_name'];?>
 Apple ID: <?php echo $v['app_id'];?>
 Store ID: <?php echo $v['store_id'];?>
 Park ID: <?php echo $v['park_id'];?>
 Public Key: <?php echo $v['public_key'];?>
 Wp(Protocol): <?php echo $v['protocol'];?>
 Wp(Publisher): <?php echo $v['wp_p1'];?>
 Wp(Properties): <?php echo $v['wp_p2'];?>
 APN Certificates: <?php echo $v['files_certificates'];?>
 APN Password: <?php echo $v['pass_certificates'];?>
 API Key G+: <?php echo $v['api_key'];?>
 Client ID G+: <?php echo $v['client_key'];?>
 Client Secret G+: <?php echo $v['client_secret'];?>
 Url Scheme G+: <?php echo $v['url_scheme'];?>
 Facebook AppID: <?php echo $v['fb_appid'];?>
 Facebook AppSecret: <?php echo $v['fb_appsecret'];?>
 Facebook Schemes: <?php echo $v['fb_schemes'];?>
 Link Cnd Client: <?php echo $v['link_cnd_client'];?>
 Notes: <?php echo $v['notes'];?>
 User: <?php echo $slbUser[$v['userlog']]['username'];?>'>
                	<td>
                    ...
                    <a href="javascript:void(0);" onclick="updaterows(<?php echo $v['id_projects'];?>,<?php echo $v['id'];?>,$('#cbo_platform_e_<?php echo $v['id'];?>').val(),$('#package_name_e_<?php echo $v['id'];?>').val(),$('#public_key_e_<?php echo $v['id'];?>').val(),$('#inapp_items_e_<?php echo $v['id'];?>').val(),$('#wp_p1_e_<?php echo $v['id'];?>').val(),$('#wp_p2_e_<?php echo $v['id'];?>').val(),$('#notes_p_e_<?php echo $v['id'];?>').val(),$('#pass_certificates_e_<?php echo $v['id'];?>').val(),$('#api_key_e_<?php echo $v['id'];?>').val(),$('#client_key_e_<?php echo $v['id'];?>').val(),$('#url_scheme_e_<?php echo $v['id'];?>').val(),$('#client_secret_e_<?php echo $v['id'];?>').val(),$('#app_id_e_<?php echo $v['id'];?>').val(),$('#store_id_e_<?php echo $v['id'];?>').val(),$('#park_id_e_<?php echo $v['id'];?>').val(),$('#cbo_cert_name_e_<?php echo $v['id'];?>').val(),$('#fb_appid_e_<?php echo $v['id'];?>').val(),$('#fb_appsecret_e_<?php echo $v['id'];?>').val(),$('#fb_schemes_e_<?php echo $v['id'];?>').val(),$('#link_cnd_client_e_<?php echo $v['id'];?>').val(),$('#ReportWithConversionID_e_<?php echo $v['id'];?>').val(),$('#Label_e_<?php echo $v['id'];?>').val(),$('#Value_e_<?php echo $v['id'];?>').val(),$('#IsRepeatable_e_<?php echo $v['id'];?>').val(),$('#wp_protocol_e_<?php echo $v['id'];?>').val())" title="Sửa" id="save_row_<?php echo $v['id'];?>" style="display:none;"><img border="0" width="16" height="16" title="Lưu" src="<?php echo base_url()?>assets/img/icon/save.png"></a>
                    ...
                    <td class="store_id"><input type="text" name="store_id_e_<?php echo $v['id'];?>" id="store_id_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['store_id'];?>" maxlength="1000" /></td>
                    <td class="park_id"><input type="text" name="park_id_e_<?php echo $v['id'];?>" id="park_id_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['park_id'];?>" maxlength="1000" /></td>
                   <td>
                   ...
                   <input type="hidden" name="inapp_items_e_<?php echo $v['id'];?>" id="inapp_items_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['inapp_items'];?>" />
                    ...
                    <td class="wp"><input type="text" name="wp_protocol_e_<?php echo $v['id'];?>" id="wp_protocol_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['protocol'];?>" /></td>
                    ...
                    <!--Google AdWord-->
                    <td><input type="text" name="ReportWithConversionID_e_<?php echo $v['id'];?>" id="ReportWithConversionID_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $googleadword[0];?>" /></td>
                    <td><input type="text" name="Label_e_<?php echo $v['id'];?>" id="Label_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $googleadword[1];?>" /></td>
                    <td><input type="text" name="Value_e_<?php echo $v['id'];?>" id="Value_e_<?php echo $v['id'];?>" class="textinputplus" value="0.00" style="width:40px;" /></td>
                    <td><input type="text" name="IsRepeatable_e_<?php echo $v['id'];?>" id="IsRepeatable_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['platform']=="ios"?"NO":"false";?>" style="width:50px;" /></td>
                    <!--End Google AdWord-->
                    ...
                    <td><input type="text" name="link_cnd_client_e_<?php echo $v['id'];?>" id="link_cnd_client_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['link_cnd_client'];?>" /></td>
					<td><input maxlength="100000" type="text" name="notes_p_e_<?php echo $v['id'];?>" id="notes_p_e_<?php echo $v['id'];?>" class="textinputplus" value="<?php echo $v['notes'];?>" /></td>
...
function updaterows(id_projects,id,cbo_platform_e,package_name_e,public_key_e,inapp_items_e,wp_p1_e,wp_p2_e,notes_p_e,pass_certificates_e,api_key_e,client_key_e,url_scheme_e,client_secret_e,app_id,store_id,park_id,cert_name,fb_appid,fb_appsecret,fb_schemes,link_cnd_client,ReportWithConversionID,Label,Value,IsRepeatable,protocol){
	if(package_name_e==''){
		alert('Không bỏ trống giá trị Bundle/Package');
		return false;
	}
	var _googleproductapi=ReportWithConversionID + ';' + Label + ';' + Value + ';' + IsRepeatable;
	c=confirm('Bạn có muốn lưu không ?');
	if(c){
		$.ajax({
                url:baseUrl+'?control=projects&func=updaterowsitem',
                type:"GET",
				data:{id:id,cbo_platform_e:cbo_platform_e,package_name_e:package_name_e,public_key_e:encodeURIComponent(public_key_e),inapp_items_e:inapp_items_e,wp_p1_e:wp_p1_e,wp_p2_e:wp_p2_e,notes_p_e:notes_p_e,pass_certificates_e:pass_certificates_e,api_key_e:api_key_e,client_key_e:client_key_e,url_scheme_e:url_scheme_e,client_secret_e:client_secret_e,app_id_e:app_id,store_id_e:store_id,park_id_e:park_id,cert_name:cert_name,id_projects:id_projects,fb_appid:fb_appid,fb_appsecret:fb_appsecret,fb_schemes:fb_schemes,link_cnd_client:link_cnd_client,googleproductapi:_googleproductapi,protocol:protocol},
                async:false,
				dataType:"html",
                beforeSend:function(){
