...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv&func=index#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv&func=quanlyqua#quanlyqua";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv&func=lichsu#lichsu";
        });
		
		 $('#log_nap_tien').on('click', function (e) {
            window.location.href = "/?control=event_dau_co_lv&func=log_nap_tien#log_nap_tien";
        });
