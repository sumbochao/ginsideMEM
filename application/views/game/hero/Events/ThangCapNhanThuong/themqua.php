        ...
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                if (tournament_id != null && tournament_id != "") {
                    window.location.href = '/?control=thangcapnhanthuong_hero&func=quanlyqua&tournament_id=' + tournament_id + "&module=all#quanlyqua";
                } else {
...
<?php include APPPATH . 'views/game/hero/Events/ThangCapNhanThuong/tab.php'; ?>
            ...
            <div class="widget" id="viewport">               
                <form id="frmSendChest" action="/?control=thangcapnhanthuong_hero&func=add_gift&module=all" method="POST" enctype="multipart/form-data">
