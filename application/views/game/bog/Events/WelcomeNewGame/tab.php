...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_welcome_newgame&func=index#home";
        });


        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=event_welcome_newgame&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT CHÀO MỪNG GAME MỚI</h4>
<!-- Nav tabs -->
