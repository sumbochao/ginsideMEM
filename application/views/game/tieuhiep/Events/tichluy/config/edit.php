    ...
    $(document).ready(function() {
        $('#onSubmitUpdate').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/accumulation_weekly_weekly/edit_config",
                ...
                beforeSend: function(  ) {
                    ...
                    window.location.href='<?php echo $urlConfig; ?>/cms/ep/accumulation_weekly_weekly/edit?view=wheel&ids=<?php echo $wheel;?>';
                    //enable button
