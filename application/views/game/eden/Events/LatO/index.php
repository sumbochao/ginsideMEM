    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#create_boxitem').on('click', function () {
                window.location.href = '/?control=event_lato_eden&func=productbox';
            });
            $('.clearcached').on('click', function () {
                window.location.href = 'http://service.eden.mobo.vn/cms/promotion_lato/clearMemcacheBox';
            });
        });
        getData();
        function getData() {
            $(".loading").fadeIn("fast");
            $.ajax({
                url: "http://service.eden.mobo.vn/cms/promotion_lato/boxitembinding",
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                               {
                                ...
                                ,
                                 ...
                                 },
                                 {
                                     ...
                                     mData: "id",
                                     mRender: function (data) {
                                         return "<a class='btn btn-success btn-xs' href='/?control=event_lato_eden&func=productboxediting&ids=" + data + "#home'>Chỉnh Sửa</a>";
                                     }
