...
//            $("#enddate_reward").jqxDateTimeInput({ width: '150px', height: '28px', formatString: 'yyyy-MM-dd HH:mm:ss' });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <?php include APPPATH . 'views/game/pt/Events/DauCoThang/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=event_dau_co_thang&func=config_event" method="POST" enctype="multipart/form-data">
...
<!--                        </div>-->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                Enable:<input type="radio" <?php if($dcth_config[0]->status == 1): ?> checked <?php endif?> name="status"  value="1" >
                                &nbsp;&nbsp;
                                Disable:<input type="radio" <?php if($dcth_config[0]->status == 0): ?> checked <?php endif?>  name="status" value="0" >
                            </div>
                        </div>
