...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                window.location.href = '/?control=event_lato_eden&func=index';
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <form id="frmSendChest" action="/?control=event_lato_eden&func=add_new_item" method="POST" enctype="multipart/form-data">
                <div class="widget row-fluid">
                    <div class="well form-horizontal">
                        <h5 class="widget-name">
                            <i class=" ico-th-large"></i>THÊM MỚI ITEM VÒNG QUAY
                        </h5>
                        ...
                        <div class="control-group">
                         ...
                         <div class="control-group">
                            ...
                            <div class="controls">                                
                                <input id="play_count_open" name="play_count_open" type="text" value="" class="span3 validate[required]"> (Số lượt lật sẽ mở)
                            </div>
                        </div>
