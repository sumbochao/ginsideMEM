            ...
            if (id != null && id != "") {
                $.ajax({
                    ...
                    success: function (data) {
                        $("#gift_activity").val(data[0]["gift_activity"]);
                        $("#item_id").val(data[0]["item_id"]);
                        $("#item_count").val(data[0]["item_count"]);
                        $("#id").val(data[0]["id"]);

                        $("#gift_name").val(data[0]["gift_name"]);
                        $("#gift_price").val(data[0]["gift_price"]);
                        $("#gift_position").val(data[0]["gift_position"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_bongda_lol&func=edit_gift_details&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group frmedit">
                            <label class="control-label">Posotion:</label>
                            <div class="controls">
