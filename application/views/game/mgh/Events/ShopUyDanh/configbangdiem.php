                ...
                aoColumns: [
...

                    {
                        ...
                        mRender: function (data, arg1, arg2) {
                            return "<a class='btn btn-success btn-xs' href='/?control=shopuydanh&func=showAddConfigBangDiem&module=all&id=" + data +"#quanlybangdiem '>Chỉnh Sửa</a>";
                        }
                ...
                <div class="well form-horizontal">
                    <div class="table-overflow">
                        <div style="margin-top: 10px; margin-bottom: 10px;">
                            <a href="/?control=shopuydanh&func=showAddConfigBangDiem&module=all#configdoidiem" class="btn btn-primary"><span>THÊM MỚI</span></a>
                        </div>
