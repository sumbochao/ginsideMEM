...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=event_login_7ngay&func=index&module=all#home";
        });


        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=event_login_7ngay&func=quanlyqua&module=all#quanlyqua";
        });


        $('#lognhanqua').on('click', function (e) {
            window.location.href = "/?control=event_login_7ngay&func=get_log_nhanqua&module=all#lognhanqua";
        });
