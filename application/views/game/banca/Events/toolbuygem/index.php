...
<?php
$url = 'http://local.service.eden.mobo.vn';
?>
    <style>
        #loading {
            width: 100%;
    ...
    <script type="text/javascript">
        $(function () {
            $('#create_tournament').on('click', function () {
                window.location.href = '/?control=event_covu&func=themgiaidau&module=all#giaidau';
            });
        ...
        $(document).ready(function() {
            ...
            $('#comeback').on('click',function(){
                window.location.href ='/cms/ep/accumulation_weekly/index?view=item';
            });
            ...
            $('#onSubmit').on('click',function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url; ?>/cms/accumulation_weekly/<?php echo ($_GET['ids']>0)?'edit_item?ids='.$_GET['ids']:'add_item';?>",
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/tieuhiep/Events/tichluy/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=event_covu&func=edit_tournament_details&module=all" method="POST" enctype="multipart/form-data">
