            ...
            <div class="group_left">
            	<div class="rows">	
                    ...
                    <select name="cbo_game" id="cbo_game" class="chosen-select" tabindex="2" data-placeholder="Chọn danh mục" onchange="calljavascript(-1);">
                        ...
                        ?>
                        <option value="<?php echo $v['service_id']."|".$v['service'];?>" ><?php echo $v['app_fullname'];?></option>
                        <?php
                                }
                            }
                        ?>
                ...
                <div class="rows">	
                    ...
                    <select name="cbo_platform" id="cbo_platform" onchange="calljavascript(2);">
                        ...
                        ?>
                        <option value="<?php echo $key;?>" <?php echo $_POST['cbo_platform']==$key?"selected":""; ?>><?php echo $value;?></option>
                        <?php
                                }
                            }
                        ?>
                ...
                <div class="rows">	
                    ...
                    <select name="cbo_story_stype" id="cbo_story_stype" onchange="calljavascript(1);">
                        ...
                        <option value="GooglePlay" <?php echo $_POST['cbo_story_stype']=="GooglePlay"?"selected":""; ?>>GooglePlay</option>
                      	<option value="WinStore" <?php echo $_POST['cbo_story_stype']=="WinStore"?"selected":""; ?>>WinStore</option>
                        <option value="Appstore" <?php echo $_POST['cbo_story_stype']=="Appstore"?"selected":""; ?>>Appstore</option>
                        <option value="Inhouse" <?php echo $_POST['cbo_story_stype']=="Inhouse"?"selected":""; ?>>Inhouse</option>
                    </select>
                ...
                <div class="rows">
                    ...
                    <input type="text" name="sdkversion" id="sdkversion" class="textinput" value="<?php echo $_POST['sdkversion']; ?>"/>
            ...
            <div class="group_left">
               <div class="cbo_msv">
                ...
                <div class="rows">	
                    ...
                    <input type="text" name="client_version" id="client_version" class="textinput" onkeyup="calljavascript(4);" value="<?php echo $_POST['client_version']; ?>"/>
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Client Build</label>
                    <input type="text" name="client_build" id="client_build" class="textinput" value="<?php echo $_POST['client_build']; ?>"/>
                </div>
                <div class="rows" id="view_version_code">	
                    <label for="menu_group_id">Version Code</label>
                    <input type="text" name="version_code" id="version_code" class="textinput" value="<?php echo $_POST['version_code']; ?>"/>
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Min SDK Version</label>
                    <input type="text" name="min_sdk_version" id="min_sdk_version" class="textinput"/>
                </div>
                <div class="rows">	
                    <label for="menu_group_id">Target SDK Version</label>
                    <input type="text" name="target_sdk_version" id="target_sdk_version" class="textinput"/>
                </div>
        ...
        <div id="adminfieldset" class="groupsignios" style="width:100%;margin-top:0">
            ...
            <div class="group_left">
            	 <div class="rows">	
                    ...
                    <input type="text" name="file_name" id="file_name" class="textinput" placeholder="File name" style="width:1000px;color:#900;font-weight:bold" value="<?php echo $_POST['file_name']; ?>"/>
                </div>
                <div class="rows">
                    <textarea name="notes" id="notes" cols="30" rows="5" style="width:1000px;height:80px;resize:none;"><?php echo $_POST['notes']; ?></textarea>
                </div>
...
<script type="text/javascript">
	function calljavascript(i){
		switch(i){
			 case 0:
			 	checknull('appForm','<?=base_url()."?control=".$_GET['control']."&func=".$_GET['func'].""; ?>');
			 break;
			 case 1:
			 	getBundle(-1,'cbo_game','cbo_platform',$('#cbo_story_stype').val(),'cbo_package_name');
				//claer msv
				showMsv(-1,'',0,'','');
			 break;
			 case 2:
			 ...
			 case 3:
			 	...
			 	showMsv(-1,$('#cbo_platform').val(),service_id[0],$('#cbo_story_stype').val(),$('#cbo_package_name').val());
			 break;
			 case 4:
			 ...
			 case 5:
			 		//back to home;
					var gm=$('#cbo_game').val().split('|');
					browserlink('<?=base_url()."?control=".$_GET['control']."&func=index&cbo_game="; ?>'+ gm[1]);
			 break;
			 default:
			 	//claer msv
