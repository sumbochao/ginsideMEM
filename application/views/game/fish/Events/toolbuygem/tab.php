...
<script>
    ...
    $(function () {        
        $('#config').on('click', function (e) {
            window.location.href = "?control=fish_buygem&func=index&view=config&module=all";
        });

        $('#item').on('click', function (e) {
            window.location.href = "?control=fish_buygem&func=index&view=item&module=all";
        });
		$('#history').on('click', function (e) {
            window.location.href = "?control=fish_buygem&func=history&module=all";
        });
		$('#historygroup').on('click', function (e) {
            window.location.href = "?control=fish_buygem&func=historygroup&module=all";
        });
...
<h4 class="widget-name">QUẢN LÝ EVENT buygem</h4>
<!-- Nav tabs -->
