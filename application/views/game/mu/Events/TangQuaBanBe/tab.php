...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=tangquabanbe_mu&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=tangquabanbe_mu&module=all&func=giaidau#giaidau";
        });
        
        $('#quanlyquagui').on('click', function (e) {
            window.location.href = "/?control=tangquabanbe_mu&module=all&func=quanlyquagui#quanlyquagui";
        }); 
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=tangquabanbe_mu&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=tangquabanbe_mu&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT TẶNG QUÀ BẰNG HỮU</h4>   
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a id="giaidau" href="#giaidau" aria-controls="giaidau" role="tab" data-toggle="tab">SỰ KIỆN</a></li>
    <li role="presentation"><a id="quanlyquagui" href="#quanlyquagui" aria-controls="quanlyquagui" role="tab" data-toggle="tab">QUÀ TẶNG BẰNG HỮU</a></li>
    <li role="presentation"><a id="quanlyqua" href="#quanlyqua" aria-controls="quanlyqua" role="tab" data-toggle="tab">QUÀ USER NHẬN</a></li>
