...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=trainghiemalpha_hkgh&func=index&view=event&module=all";
        });
        $('#item').on('click', function (e) {
            window.location.href = "/?control=trainghiemalpha_hkgh&func=index&view=item&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=trainghiemalpha_hkgh&func=history&module=all";
        });
        $('#user').on('click', function (e) {
            window.location.href = "/?control=trainghiemalpha_hkgh&func=index&view=user&module=all";
        });
    });
</script>
<style>
