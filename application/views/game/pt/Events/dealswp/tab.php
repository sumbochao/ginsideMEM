...
<script>
    ...
    $(function () {        
        $('#event').on('click', function (e) {
            window.location.href = "/?control=dealswp_pt&func=index&view=event#event";
        });
        $('#filters').on('click', function (e) {
            window.location.href = "/?control=dealswp_pt&func=index&view=filters#filters";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=dealswp_pt&func=history#history";
        });
    });
</script>
<style>
