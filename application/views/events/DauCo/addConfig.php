        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=<?php echo $control;?>&func=addConfig&game=<?php echo $game;?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="article_id" value="<?php echo $article_id; ?>" />
                            </div>
                        </div>
						...
						<div class="control-group">
                            ...
                            <div class="controls">
                                <input name="day_number" value="<?php echo $day_number; ?>" />
                                (Khoảng thời gian được mua quà tính từ ngày tạo nhân vật)
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input <?php if($is_tester == 1) echo 'checked';?> onchange="this.value = (Number(this.checked));" type="checkbox" name="is_tester" value="<?php echo $is_tester; ?>" />
                            </div>
                        </div>
