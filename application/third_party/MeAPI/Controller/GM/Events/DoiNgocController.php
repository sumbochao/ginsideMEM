...
class MeAPI_Controller_GM_Events_DoiNgocController implements MeAPI_Controller_GM_Events_DoiNgocInterface {
    ...
    private $url_process = "http://game.mobo.vn/giangma/cms/tooldoingoc/";
    ...
    public function index(MeAPI_RequestInterface $request) {
        ...
        $this->CI->template->write_view('content', 'game/gm/Events/DoiNgoc/index', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }  
    
    public function lichsu(MeAPI_RequestInterface $request) {
        $this->authorize->validateAuthorizeRequest($request, 0);
        $this->CI->template->write_view('content', 'game/gm/Events/DoiNgoc/lichsu', $this->data);
        $this->_response = new MeAPI_Response_HTMLResponse($request, $this->CI->template->getHTML());
    }
    ...
    public function edit_config(MeAPI_RequestInterface $request) {
        $array = array(
            'id' => $_POST["id"],
            'gem_transfer_status' => $_POST["gem_transfer_status"]);
        
        $result = $this->curlPostAPI($array, $this->url_process . "edit_config");
