...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                window.location.href = '/?control=event_lato&func=index&module=all';
            });
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <form id="frmSendChest" action="/?control=event_lato&func=add_new_item&module=all" method="POST" enctype="multipart/form-data">
