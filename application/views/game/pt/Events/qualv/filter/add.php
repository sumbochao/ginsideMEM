...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#comeback').on('click',function(){
            window.location.href ='/cms/ep/qualv/index?view=filter';
        });
        ...
        $('#onSubmit').on('click',function(){
            ...
            $.ajax({
                type: "POST",
                dataType: 'jsonp',
                url: "<?php echo $url; ?>/cms/qualv/<?php echo ($_GET['ids']>0)?'edit_filter?ids='.$_GET['ids']:'add_filter';?>",
...
<div id="content">
    <!-- Content wrapper -->
    <div class="wrapper">
        <?php include APPPATH . 'views/game/pt/Events/qualv/tab.php'; ?>
