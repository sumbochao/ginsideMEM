...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_bog&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_bog&func=giaidau&module=all#giaidau";
        });        

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_bog&func=quanlyqua&module=all#quanlyqua";
        });
        ...
        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_bog&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=shopkimbai_bog&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT SHOP THỦY TINH</h4>   
<!-- Nav tabs -->
