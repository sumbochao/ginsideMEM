...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#comeback').on('click',function(){
                window.location.href ='?control=toolgettop&func=index&view=item';
            });
            ...
            $('#onSubmit').on('click',function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url; ?>/cms/toolgettop/<?php echo ($_GET['ids']>0)?'edit_item?ids='.$_GET['ids']:'add_item';?>",
        ...
        $(document).ready(function() {
            ...
            $(add_button).click(function(e){ //on add input button click
                ...
                if(x < max_fields){ //max input box allowed
                    ...
                    xhtml += '<div class="group1 w25 group1 clearfix">';
                    xhtml +='<div class="control-group form-group">';
                    ...
                    xhtml +='<div class="controls">';
                    xhtml +='<input id="url" name="url[]" type="text" value="1" class="span3 validate[required]">';
                    xhtml +='</div>';
                    xhtml +='</div>';
                    xhtml +='<div class="control-group remove form-group">';
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/bog/Events/toolgettop/tab.php'; ?>
                                ...
                                if(count($listItems)>0){
                                    ...
                                    foreach($listItems as $v){
                                        ...
                                        <div class="control-group frmedit totalchest">
                                            <div class="group1 w25 sublistItem clearfix">
                                                ...
                                                if($i!=1){
                                                    ?>
                                                    <div class="control-group form-group remove">
                                ...
                                <div class="control-group frmedit totalchest">
                                    <div class="group1 w25 sublistItem clearfix">
                                        ...
                                        <div class="control-group form-group">
                                            <label class="control-label">URL:</label>
                                            <div class="controls">
                                                <input id="url" name="url[]" type="text" value="1" class="span3 validate[required]">
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
