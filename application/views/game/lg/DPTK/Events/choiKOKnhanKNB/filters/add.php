        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "<?php echo $url_service;?>/ToolchoiKOKnhanKNB/<?php echo $_GET['id']>0?'edit_filters?id='.$_GET['id']:'add_filters';?>",
                    data:{
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="type" class="validate[required,custom[onlyNumberSp]]">
                                    <option value="0" <?php echo $items['type']==0?'selected="selected"':'';?>>Không liên tục</option>
