    ...
    <script type="text/javascript">
        ...
        function load_gift_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/bog/cms/toolshopkimbai/load_gift_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
...
<?php include APPPATH . 'views/game/bog/Events/ShopKimBai/tab.php'; ?>
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=shopkimbai_bog&func=edit_gift&module=all" method="POST" enctype="multipart/form-data">
