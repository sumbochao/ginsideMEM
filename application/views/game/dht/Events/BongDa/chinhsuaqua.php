    ...
    <script type="text/javascript">
        ...
        function load_gift_details(){
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "<?php echo $url_service;?>/cms/toolbongda/load_gift_details?id=" + id,
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_bongda_dht&func=edit_gift_details&module=all" method="POST" enctype="multipart/form-data">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group frmedit">
                            ...
                            <div class="controls">
                                <select id="gift_type" name="gift_type" class="span3 validate[required,custom[onlyNumberSp]]">
                                    <option value="">Chọn loại</option>
                                    <option value="1">Tiền trong game (Beries)</option>
                                    <option value="2">Xu (Kim Cương)</option>
                                    <option value="3">Common Item (xem cột bên trái)</option>
                                    <option value="4">Nhân vật</option>
                                    <option value="5">Trang bị</option>
                                    <option value="6">Mảnh Nhân Vật, Trang Bị</option>
                                    <option value="7">Bảo vật</option>
                                    <option value="8">Mảnh bảo vật</option>
                                    <option value="9">Cờ Hải Tặc (Trong Đấu Trường Hải Tặc)</option>
                                    <option value="10">Điểm kinh nghiệm</option>
                                    <option value="11">Thể lực(PVE) THỊT</option>
                                    <option value="12">Tinh lực(PVP) RƯỢU</option>
                                    <option value="13"> Kim Cương Trắng</option>
                                    <option value="14">Không biết là cái gì</option>
                                    <option value="15">Điểm Chiến Công (Săn Hải Tặc )</option>
                                    <option value="16">Sừng Trâu (điểm Impel down đổi trang bị)</option>
                                    <option value="17">Lượt đánh boss Hải Tặc (Săn Hải Tặc)</option>
                                    <option value="18">Không biết là cái gì(Có thể là quà cross platform)</option>
                                    <option value="19">Điểm Exp tăng VIP</option>
                                    <option value="20">Điểm cống hiến Hạm Đội</option>
                                    <option value="21">Ngoại trang</option>
                                    <option value="22">Vật Phẩm Thức Tỉnh</option>
                                    <option value="23">Bọ Hung Chúa đổi Vật Phẩm Thức Tỉnh</option>
                                    <option value="24">Điểm quay luân bàn(Tính năng quay số)</option>
                                    <option value="25">Điểm đánh liên đấu</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
