                    ...
                    $('#data_table').dataTable({
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                               sTitle: "Tùy Chọn",
                               mData: "id",
                               mRender: function (data,data1,data2) {
                                   return "<a class='btn btn-danger btn-xs' onclick=\"if(!window.confirm('Bạn có muốn xóa không ?')) return false;\" href='/?control=dautruong_lol&func=delete&view=<?php echo $_GET['view'];?>&module=<?php echo $_GET['module'];?>&id=" + data2.id + "&mobo_id="+data2.mobo_id+"&id_event="+data2.id_event+"'>Xóa</a>";
                               }
                            }
                        ],
                        bProcessing: true,
