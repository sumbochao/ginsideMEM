<table width="100%" border="0" id="table2excel" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo ($v['Apple']>0)?number_format($v['Apple']):'0';?></td>
            <td><?php echo ($v['Google']>0)?number_format($v['Google']):'0';?></td>
            <td><?php echo ($v['Card']>0)?number_format($v['Card']):'0';?></td>
            <td><?php echo ($v['Banking']>0)?number_format($v['Banking']):'0';?></td>
            <td><?php echo ($v['SMS']>0)?number_format($v['SMS']):'0';?></td>
            <td><?php echo ($v['Total']>0)?number_format($v['Total']):'0';?></td>
        </tr>
        <?php
                }
            }else{
