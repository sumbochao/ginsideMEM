    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#create_reward').on('click', function () {
                window.location.href = '/?control=bog_event_goi_qua_vip&func=showAddConfig&module=all#addconfig';
            });
        });
                        ...
                        aoColumns: [
                            ...
                            },
                            {
                                ...
                                mRender: function (id, arg1, arg2) {
                                    return "<a class='btn btn-success btn-xs' href=' /?control=bog_event_goi_qua_vip&func=showAddConfig&module=all&id=" + id + "&name="+arg2.name+"&ip_list="+arg2.ip_list + "&server_list="+arg2.server_list + "&status="+arg2.status + "&date_start="+arg2.date_start + "&date_end="+arg2.date_end + "&package_id="+arg2.package_id + "#home '>Chỉnh Sửa</a>";
                                }
