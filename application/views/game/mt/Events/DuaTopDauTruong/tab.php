...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=duatopdautruong_mt&module=all&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=duatopdautruong_mt&module=all&func=giaidau#giaidau";
        });
        
        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=duatopdautruong_mt&module=all&func=quanlyqua#quanlyqua";
        }); 

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=duatopdautruong_mt&module=all&func=lichsu#lichsu";
        });
    });
</script>
<style>
