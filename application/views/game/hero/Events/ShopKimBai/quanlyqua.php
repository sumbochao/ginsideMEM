    ...
    <script type="text/javascript">
        $(document).ready(function() { 
            $('#add_gift').on('click', function () {
                window.location.href = '/?control=shopkimbai_hero&func=themqua&type=' + $("#gifttype").val() + "&module=all#quanlyqua" ;
            });
            
            //Load Gift Type
            $.ajax({
                method: "GET",
                url: "http://game.mobo.vn/hero/cms/toolshopkimbai/gift_type_list",
             ...
             $("#gifttype").change(function () {             
                window.location.href = "/?control=shopkimbai_hero&func=quanlyqua&type=" + $(this).val() + "&module=all#quanlyqua";
            });
        });
        
        function getData(type_id) {
            $.ajax({
                url: "http://game.mobo.vn/hero/cms/toolshopkimbai/gift_list?id=" + type_id,
                dataType: 'jsonp',
                method: "POST",
                bRetrieve: true,
                bDestroy: true,
                        ...
                        aoColumns: [
                            {
                               ...
                               },
                               {
                                ...
                                },
                                {
                                    ...
                                    mData: "id",
                                    mRender: function (data) {
                                        return "<a href='/?control=shopkimbai_hero&func=chinhsuaqua&id=" + data + "&type="+ $("#gifttype").val() +"&module=all#quanlyqua'>Chỉnh Sửa</a>";
                                    }
