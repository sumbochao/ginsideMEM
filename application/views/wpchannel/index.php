    ...
    <form id="appForm" action="" method="post" name="appForm" enctype="multipart/form-data">
        ...
        <div id="adminfieldset" class="groupsignios" style="height:225px;">
            ...
            <div class="group_left">
                ...
                <div class="rows">	
                    ...
                    <span class="loadapp">
                        ...
                        <option value="0">Chọn App</option>
                            <option value='1'>WinStore</option>
                ...
                <div class="rows">	
                    <label for="menu_group_id">PackageIdentity</label>
...
<script type="text/javascript" language="javascript">
	...
	function setBunlderId(_value){
		...
		// value chính là PackageIdentity
	...
	function getBunlderid(_cert_id){
		...
		var _platform='wp';
			$.ajax({
				url:baseUrl+'?control=wpchannel&func=getpackageidentity',
				type:"GET",
	 ...
	 function showMsv(id_game,type_app,package_identity,cert_id){
		 
        $.ajax({
            url:baseUrl+'?control=wpchannel&func=showmsv',
            type:"GET",
            data:{id_game:id_game,type_app:type_app,package_identity:package_identity,cert_id:cert_id},
            async:false,
            dataType:"json",
            beforeSend:function(){
                $('.loading_warning').show();
