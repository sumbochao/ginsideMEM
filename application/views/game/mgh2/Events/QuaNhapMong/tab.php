...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=index&module=all#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=giaidau&module=all#giaidau";
        });        

        $('#quanlyqua').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=quanlyqua&module=all#quanlyqua";
        });
        
         $('#quanlygoiqua').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=quanlygoiqua&module=all#quanlygoiqua";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=thongke&module=all#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=quanhapmong_mgh2&func=lichsu&module=all#lichsu";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ EVENT QUÀ NHẬP MỘNG</h4>   
<!-- Nav tabs -->
...
<!--    <li role="presentation"><a id="quanlyqua" href="#quanlyqua" aria-controls="quanlyqua" role="tab" data-toggle="tab">QUẢN LÝ QUÀ</a></li>-->
    ...
    <li role="presentation"><a id="thongke" href="#thongke" aria-controls="thongke" role="tab" data-toggle="tab">THỐNG KÊ TOP ĐIỂM</a></li>
