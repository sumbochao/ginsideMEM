        ...
        $(document).ready(function () {
            ...
            $('#onSubmit').on('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url_service;?>/cms/banpick/<?php echo $_GET['id']>0?'edit_'.$_GET['view'].'?id='.$_GET['id']:'add_'.$_GET['view'];?>",
                ...
                <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                    <div class="well form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="picture" id="picture" value="<?php echo $items['picture'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
						<div class="control-group">
                            <label class="control-label">Lượt:</label>
                            <div class="controls">
                                <input name="num_banpick" id="num_banpick" value="<?php echo $items['num_banpick'];?>" type="text" style="width: 80%"/>
                            </div>
                        </div>
                        <div class="control-group">
