...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=giaithuong#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=giaithuongtop#giaithuongtop";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=tulinhdan_pt&func=lichsu#lichsu";
        });
    });
</script>
<style>
