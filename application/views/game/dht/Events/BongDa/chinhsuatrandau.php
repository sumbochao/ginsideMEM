    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#comeback').on('click', function () {
                window.location.href = '/cms/ep/toolbongda/trandau';
            });
        ...
        function load_match_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "<?php echo $url_service;?>/cms/toolbongda/load_match_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#tournament_id").val(data[0]["tournament_id"]);
                        $("#id").val(data[0]["id"]);

                        $("#match_start_date").val(data[0]["match_start_date"]);
                        $("#match_end_date").val(data[0]["match_end_date"]);
                        $("#match_end_pet_date").val(data[0]["match_end_pet_date"]);
                        ...
                        $("#match_team_hoa").val(data[0]["match_team_hoa"]);
                        $("#match_team_rate").val(data[0]["match_team_rate"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=event_bongda_dht&func=edit_match_details&module=all" method="POST" enctype="multipart/form-data">
                    <div class="widget row-fluid">
                        <div class="well form-horizontal">
                            ...
                            <div class="control-group" style="display:none">
                                ...
                                <div class="controls">
                                    <input name="match_team_chap_a" id="match_team_chap_a" type="text"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group" style="display:none">
                                <label class="control-label">Chấp:</label>
                                <div class="controls">
                                    <input name="match_team_chap_b" id="match_team_chap_b" type="text" />
                                </div>
                            </div>
                            ...
                            <div class="control-group" style="display:none">
                                <label class="control-label">Chấp (hòa):</label>
                                <div class="controls">
                                    <input name="match_team_hoa" id="match_team_hoa" type="text"/>
                                </div>
                            </div>

                            <div class="control-group">
                                <label class="control-label">Tỷ lệ hòa:</label>
                                <div class="controls">
                                    <input name="match_team_rate" id="match_team_rate" type="text" class="span3 validate[required,custom[number]]" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" id="match_start_date" name="match_start_date" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" id="match_end_date" class="datetime" name="match_end_date" value=""/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datetime" id="match_end_pet_date" class="datetime" name="match_end_pet_date" value=""/>
                                </div>
                            </div>
