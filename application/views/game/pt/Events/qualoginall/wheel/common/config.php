        ...
        $('#onSubmitPopup').on('click',function(){
            ...
            $.ajax({
                ...
                beforeSend: function(  ) {
                    ...
                    window.location.href='?control=logindayall&func=edit&view=wheel&&ids=<?php echo $_GET['ids'];?>';
                    //enable button
                            ...
                            },                            
                           {
                            ...
                            },
							{
                             ...
                             { 
                                ...
                                mData: "id",
                                mRender: function(data){
                                    return "<a href='javascript:;' onclick='editConfig("+data+")'>Edit</a> <span style='padding-left:10px'><a href='?control=logindayall&func=deleteconfig&view=wheel&ids="+data+"&wheel=<?php echo $_GET['ids'];?>'>Delete</a></span>";
                                }
                                ...
                                <div class="form-group">
									<div class="col-xs-12">
										...
										<div class="col-xs-4" style="padding:0">
											...
											<input id="gold" name="gold" type="text" value="" class="span3 validate[required]">
										</div>
...
<script>
    function editConfig(ids){
        $.ajax({
            url: "<?php echo $urlConfig;?>?control=logindayall&func=edit_config&view=wheel",
            type:"GET",
            data:{ids:ids},
            dataType:"json",
            success:function(f){
