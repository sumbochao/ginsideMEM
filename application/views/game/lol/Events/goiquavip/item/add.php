...
<div id="content-t" style="min-height: 500px; padding-top: 10px">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#comeback').on('click',function(){
                window.location.href ='?control=lol_event_goi_qua_vip&func=index&view=item&module=all';
            });
            ...
            $('#onSubmit').on('click',function(){
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'jsonp',
                    url: "<?php echo $url; ?><?php echo ($_GET['ids']>0)?'edit_item?ids='.$_GET['ids']:'add_item';?>",
        ...
        $(document).ready(function() {
            ...
            $(add_button).click(function(e){ //on add input button click
                ...
                if(x < max_fields){ //max input box allowed
                    ...
                    xhtml +='</div>';
                    xhtml +='<div class="control-group">';
                    xhtml +='<label class="control-label">Activity:</label>';
                    xhtml +='<input id="count" name="activity[]" type="text" value="1" class="span3 validate[required]">';
                    xhtml +='</div>';
                    xhtml +='<div class="control-group">';
                    xhtml +='<label class="control-label">Position:</label>';
                    xhtml +='<input id="rate" name="position[]" type="text" value="1" class="span3 validate[required]">';
                    xhtml +='</div>';
    ...
    <div id="content">
        <!-- Content wrapper -->
        <div class="wrapper">
            <?php include APPPATH . 'views/game/lol/Events/goiquavip/tab.php'; ?>
                ...
                <div class="well form-horizontal">
                    <form id="frmSendChest" name="frmSendChest" action="" method="POST" onsubmit="return false;" autocomplete="off">
                                        ...
                                        <div class="control-group frmedit totalchest">
                                            <div class="group1 w25 clearfix">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <input id="count" name="activity[]" type="text" value="<?php echo $v['activity'];?>" class="span3 validate[required]">
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label">Position:</label>
                                                    <input id="rate" name="position[]" type="text" value="<?php echo $v['position'];?>" class="span3 validate[required]">
                                                </div>
                                                <?php
                                                if($i!=1){
                                                    ?>
						...
						<!--<div class="control-group">
                            ...
                            <input id="start" name="start" type="text" value="<?php echo $start;?>" class="timepicker2 start span3 validate[required]" style="max-width:300px">
                        </div>
						-->
