        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <div class="well form-horizontal">
                    <form id="frmSendChest" action="/?control=khongdoitroichung_mt&module=all&func=add_khongdoitroichung_gift" method="POST" enctype="multipart/form-data">
                        <div class="widget row-fluid">
                            <div class="well form-horizontal">
                                ...
                                <div class="control-group">
                                    <label class="control-label">Số Kẻ Thù (điều kiện nhận quà):</label>
                                    <div class="controls">
