...
<script>
    function loadIframecontentServer() {
        ...
        jQuery("#ifmserver").html('<iframe style="width:100%;height:350px;border:0px;" id="ifmservercontent" src="<?php echo APPLICATION_URL;?>?control=tambao_tank&func=listserver&iframe=1&game_id=158&lid='+lid+'"></iframe>');
    } 
