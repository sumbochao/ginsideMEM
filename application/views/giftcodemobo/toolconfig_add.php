...
<form action="" method="post" name="frmadd" enctype="multipart/form-data">
	...
	<fieldset>
        <label for="id_app">Event</label>
		<input type="text" name="event" id="event" value="<?php echo $configid['event'];?>" class="textinput">
        <br/>
        <br/>
        <label for="id_app">Note</label>
		<input type="text" name="note" id="note" value="<?php echo $configid['note'];?>" class="textinput">
        <br/>
		<br>
        ...
        <div class="content_load">
            <label for="alias">Type</label>
            <input type="text" name="type" id="type" value="<?php echo $configid['type']?>" class="textinput">
            <br><br>
        </div>

		<label for="isactive">IsActive</label>
		<input type="checkbox" name="isactive" id="isactive" <?php echo ($configid['isactive'] == 1 )?'checked':'';?> class="textinput">
		<br><br>
