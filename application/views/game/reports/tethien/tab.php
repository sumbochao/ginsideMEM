...
<script>
    $(function () {        
        ...
        $('#level_active_by_server').on('click', function (e) {
            window.location.href = "/?control=reports&func=level_active_byserver&game=<?php echo $_GET['game'];?>#level_active_by_server";
        });
        $('#level_active_by_date').on('click', function (e) {
            window.location.href = "/?control=reports&func=level_active_bydate&game=<?php echo $_GET['game'];?>#level_active_by_date";
        });
        $('#level_statistics_by_date').on('click', function (e) {
            window.location.href = "/?control=reports&func=level_statistics_bydate&game=<?php echo $_GET['game'];?>#level_statistics_by_date";
        });
        ...
        $('#vip_statistics_bydate').on('click', function (e) {
            window.location.href = "/?control=reports&func=vip_statistics_bydate&game=<?php echo $_GET['game'];?>#vip_statistics_bydate";
        });
        $('#vip_statistics_byserver').on('click', function (e) {
            window.location.href = "/?control=reports&func=vip_statistics_byserver&game=<?php echo $_GET['game'];?>#vip_statistics_byserver";
        });
        $('#card_statistics_bydate').on('click', function (e) {
            window.location.href = "/?control=reports&func=card_statistics_bydate&game=<?php echo $_GET['game'];?>#card_statistics_bydate";
        });
        $('#card_statistics_byserver').on('click', function (e) {
            window.location.href = "/?control=reports&func=card_statistics_byserver&game=<?php echo $_GET['game'];?>#card_statistics_byserver";
        });
    });
</script>
