...
<div id="content-t" style="min-height:500px; padding-top:10px">
    <form id="appForm" action="" method="post" name="appForm">
        <div class="filter">
            ...
            <input type="button" onclick="onSubmitFormAjax('appForm','<?php echo base_url().'?control=payment_promo_lol&func=index&module=all&type=filter';?>')" value="Tìm" class="btn btn-primary"/>
        </div>
...
<script type="text/javascript">
    ...
    jQuery('input[name=keyword]').keypress(function(event) {
        if (event.keyCode == '13') {
            onSubmitFormAjax('appForm','<?php echo base_url().'?control=payment_promo_lol&func=index&module=all&type=filter';?>');
            return false;
        }
        return true;
    });
	function onSubmitFormAjax(formName,url){
        ...
        $.ajax({
            url:baseUrl+'?control=payment_promo_lol&func=getvalidate',
            type:"POST",
