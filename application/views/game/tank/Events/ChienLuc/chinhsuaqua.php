    ...
    <script type="text/javascript">
        ...
        function load_gift_details() {
            ...
            if (id != null && id != "") {
                $.ajax({
                    method: "GET",
                    url: "http://game.mobo.vn/tank/cms/toolchienluc/load_gift_details?id=" + id,
                    contentType: 'application/json; charset=utf-8',
                    success: function (data) {
                        $("#id").val(data[0]["id"]);
                        ...
                        $("#gift_required_power").val(data[0]["gift_required_power"]);
    ...
    <div id="content">
        ...
        <div class="wrapper">
            ...
            <div class="widget" id="viewport">
                <form id="frmSendChest" action="/?control=chienluc_tank&func=edit_gift&module=all" method="POST" enctype="multipart/form-data">
