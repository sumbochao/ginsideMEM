...
<script>
    ...
    $(function () {
        $('#event').on('click', function (e) {
            window.location.href = "/?control=map_mu&func=index&view=event&module=all";
        });
        $('#history').on('click', function (e) {
            window.location.href = "/?control=map_mu&func=history&module=all";
        });
        $('#user').on('click', function (e) {
            window.location.href = "/?control=map_mu&func=index&view=user&module=all";
        });
    });
</script>
<style>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" <?php echo $_GET['view']=='user'?'class="active"':'';?>><a id="user" href="#user" aria-controls="user" role="tab" data-toggle="tab">GAMER</a></li>
</ul>
