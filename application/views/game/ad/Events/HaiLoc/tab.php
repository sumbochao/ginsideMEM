...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=index#home";
        });

        $('#giaidau').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=giaidau#giaidau";
        });

        $('#trandau').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=trandau#trandau";
        });

        $('#giaithuong').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=giaithuong#giaithuong";
        });
        
         $('#giaithuongtop').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=giaithuongtop#giaithuongtop";
        });

        $('#quanlycode').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=quanlycode#quanlycode";
        });

        $('#thongke').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=thongke#thongke";
        });

        $('#lichsu').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=lichsu#lichsu";
        });
        
        $('#lichsutop').on('click', function (e) {
            window.location.href = "/?control=hailoc_ad&func=lichsutop#lichsutop";
        });
    });
</script>
<style>
