...
<script>
    ...
    $(function () {        
        $('#home').on('click', function (e) {
            window.location.href = "/?control=build_hothan&func=index#home";
        });
    });
</script>
<style>
...
<h4 class="widget-name">QUẢN LÝ XÂY DỰNG HỘ THẦN VÀ TRẬN HÌNH</h4>
<!-- Nav tabs -->
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a id="home" href="#home" aria-controls="home" role="tab" data-toggle="tab">QUẢN LÝ HỘ THẦN</a></li>
  </ul>
